...
public class FtpTaskImportTemplate extends BriteObject
{
	// === Properties ===

	public String s_task_id = null;
	public String s_recip_import_template_id = null;
	public String s_entity_import_template_id = null;
	private static Logger logger = Logger.getLogger(FtpTaskImportTemplate.class.getName());

	// === Parents ===

//	public FtpTask m_FtpTask = null;
//	public ImportTemplate m_ImportTemplate = null;	
//	public EntityImportTemplate m_EntityImportTemplate = null;
	...
	public FtpTaskImportTemplate()
	{
	}
	
	public FtpTaskImportTemplate(String sTaskId) throws Exception
	{
		s_task_id = sTaskId;
		retrieve();
	}

	public FtpTaskImportTemplate(Element e) throws Exception
	{
		fromXml(e);
	}
	...
	public String m_sRetrieveSql =
		" SELECT" +
		"	task_id," +
		"	recip_import_template_id," +
		"	entity_import_template_id" +
		" FROM cftp_ftp_task_import_template" +
		" WHERE" +
		"	(task_id=?)";
	...
	public void getPropsFromResultSetRow(ResultSet rs) throws Exception
	{
		...
		s_recip_import_template_id = rs.getString(2);
		s_entity_import_template_id = rs.getString(3);
	}

	// === DB Method save()===

	public String m_sSaveSql =
		" EXECUTE usp_cftp_ftp_task_import_template_save" +
		"	@task_id=?," +
		"	@recip_import_template_id=?," +
		"	@entity_import_template_id=?";
	...
	public int saveProps(PreparedStatement pstmt) throws Exception
	{
		...
		pstmt.setString(1, s_task_id);
		pstmt.setString(2, s_recip_import_template_id);
		pstmt.setString(3, s_entity_import_template_id);
	...
	public String m_sDeleteSql =
		" DELETE FROM cftp_ftp_task_import_template" +
		" WHERE" +
		"	(task_id=?)";
	...
	public String m_sMainElementName = "ftp_task_import_template";
	...
	public void appendPropsToXml(Element e)
	{
		...
		if( s_recip_import_template_id != null ) XmlUtil.appendTextChild(e, "recip_import_template_id", s_recip_import_template_id);
		if( s_entity_import_template_id != null ) XmlUtil.appendTextChild(e, "entity_import_template_id", s_entity_import_template_id);
	}
	...
	public void getPropsFromXml(Element e)
	{
		...
		s_recip_import_template_id = XmlUtil.getChildTextValue(e, "recip_import_template_id");
		s_entity_import_template_id = XmlUtil.getChildTextValue(e, "entity_import_template_id");
	}

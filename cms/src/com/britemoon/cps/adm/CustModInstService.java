...
public class CustModInstService extends BriteObject
{
	// === Properties ===
	...
	private static Logger logger = Logger.getLogger(CustModInstService.class.getName());
	...
	public CustModInstService()
	{
	}
	
	public CustModInstService(String sCustId, String sModInstId, String sServiceTypeId) throws Exception
	{
		s_cust_id = sCustId;
	...
	public CustModInstService(Element e) throws Exception
	{
		fromXml(e);
	}
	...
	public String m_sRetrieveSql =
		...
		"	port," +
		"	path" +
		" FROM cadm_cust_mod_inst_service" +
		" WHERE" +
		"	(cust_id=?) AND" +
		"	(mod_inst_id=?) AND" +
		"	(service_type_id=?)";
	...
	public int retrieveProps(PreparedStatement pstmt) throws Exception
	{
		...
		pstmt.setString(3, s_service_type_id);
	...
	public void getPropsFromResultSetRow(ResultSet rs) throws Exception
	{
		...
		s_service_type_id = rs.getString(3);
		b = rs.getBytes(4);
		s_protocol = (b == null)?null:new String(b,"UTF-8");
		s_port = rs.getString(5);
		b = rs.getBytes(6);
	...
	public String m_sSaveSql =
		" EXECUTE usp_cadm_cust_mod_inst_service_save" +
		"	@cust_id=?," +
		"	@mod_inst_id=?," +
		"	@service_type_id=?," +
		"	@protocol=?," +
	...
	public int saveProps(PreparedStatement pstmt) throws Exception
	{
		...
		pstmt.setString(2, s_mod_inst_id);
		pstmt.setString(3, s_service_type_id);
		if(s_protocol == null) pstmt.setString(4, s_protocol);
		else pstmt.setBytes(4, s_protocol.getBytes("UTF-8"));
		pstmt.setString(5, s_port);
		if(s_path == null) pstmt.setString(6, s_path);
		else pstmt.setBytes(6, s_path.getBytes("UTF-8"));
	...
	public String m_sDeleteSql =
		" DELETE FROM cadm_cust_mod_inst_service" +
		" WHERE" +
		"	(cust_id=?) AND" +
		"	(mod_inst_id=?) AND" +
		"	(service_type_id=?)";
	...
	public String m_sMainElementName = "cust_mod_inst_service";

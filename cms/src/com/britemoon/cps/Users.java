...
public class Users extends BriteList
{
	...
	public void setParams(PreparedStatement pstmt) throws Exception
	{
		...
		if(s_pass_exp_date != null) { pstmt.setString(i, s_pass_exp_date); i++; }
		if(s_pass_notify_date != null) { pstmt.setString(i, s_pass_notify_date); i++; }

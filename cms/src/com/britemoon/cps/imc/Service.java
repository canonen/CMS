...
public class Service
{
	...
	public static String communicatePV(int nServiceTypeId, String sCustId, String sRequest) 
	throws Exception
	{

		Service service = getFirstServicePV(nServiceTypeId, sCustId,sRequest);
		return communicate(service, "");
	}
	...
	private static Service getFirstServicePV(int nServiceTypeId, String sCustId, String sRequest)
	throws Exception
{
	Service service = null;
	try
	{
		Vector services = Services.getByCustPV(nServiceTypeId, sCustId, sRequest);		
		service = (Service) services.get(0);
	}
	catch(Exception ex)
	{
		String sErrMsg =
			"Service.getFirstServicePV() FAILED to obtain "+
...
//		huc.setRequestProperty("Connection", "close");		
	...
	public void send(String s) throws IOException
	{
		...
		if ((huc != null) && (huc.getResponseCode()!= HttpServletResponse.SC_OK))
		{
			...
			logger.info("huc.getResponseCode()" + huc.getResponseCode());
			logger.info("huc.getResponseMessage()" + huc.getResponseMessage());
			System.out.flush();
...
/*
	public String receive_old() throws IOException
	{

...
public class EmailList extends BriteObject
{
	...
	public String m_sSaveSql =
		" EXECUTE usp_cque_email_list_save" +
		"	@list_id=?," +
		"	@cust_id=?," +
		"	@list_name=?," +
		"	@type_id=?," +
	...
	public int saveParents(Connection conn) throws Exception
	{
		...
		{
			String sSql = "DELETE cque_email_list_item WHERE list_id = " + s_list_id;
			BriteUpdate.executeUpdate(sSql,conn);
		}
                
                if (m_EmailListPVInfo != null) {
                    String sSql = "DELETE cque_email_list_pv_info WHERE list_id = " + s_list_id;
                    BriteUpdate.executeUpdate(sSql, conn);
                }
	...
	public String m_sDeleteSql =
		" UPDATE cque_email_list SET status_id = " + EmailListStatus.DELETED +
		" WHERE" +
		"	(list_id=?)";
	...
	public void getChildrenFromXml(Element e) throws Exception
	{
		...
		if(eEmailListItems != null) {
                    m_EmailListItems = new EmailListItems(eEmailListItems);
                }

...
public class CampEditInfo extends BriteObject
{
	// === Properties ===
	...
	private static Logger logger = Logger.getLogger(CampEditInfo.class.getName());
	...
	public CampEditInfo(String sCampId) throws Exception
	{
		s_camp_id = sCampId;
		retrieve();
	}

	public CampEditInfo(Element e) throws Exception
	{
		fromXml(e);
	}
	...
	public String m_sSaveSql =
		" EXECUTE usp_cque_camp_edit_info_save" +
		"	@camp_id=?," +
		"	@creator_id=?," +
		"	@create_date=?," +
		"	@modifier_id=?," +
	...
	public String m_sDeleteSql =
		" DELETE FROM cque_camp_edit_info" +
		" WHERE" +
		"	(camp_id=?)";
	...
	public String m_sMainElementName = "camp_edit_info";

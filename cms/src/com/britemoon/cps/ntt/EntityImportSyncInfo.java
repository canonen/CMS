...
public class EntityImportSyncInfo extends BriteObject
{
	// === Properties ===

	public String s_entity_import_id = null;
	public String s_recip_import_id = null;
	private static Logger logger = Logger.getLogger(EntityImportSyncInfo.class.getName());	
	...
	public EntityImportSyncInfo()
	{
	}
	
	public EntityImportSyncInfo(String sEntityImportId, String sRecipImportId) throws Exception
	{
		s_entity_import_id = sEntityImportId;
		s_recip_import_id = sRecipImportId;
		retrieve();
	}

	public EntityImportSyncInfo(Element e) throws Exception
	{
		fromXml(e);
	}
	...
	public String m_sRetrieveSql =
		...
		"	entity_import_id," +
		"	recip_import_id" +
		" FROM cntt_entity_import_sync_info" +
		" WHERE" +
		"	(entity_import_id=?) AND" +
		"	(recip_import_id=?)";
	...
	public int retrieveProps(PreparedStatement pstmt) throws Exception
	{
		...
		pstmt.setString(1, s_entity_import_id);
	...
	{
		byte[] b = null;
		s_entity_import_id = rs.getString(1);
	...
	public String m_sSaveSql =
		" EXECUTE usp_cntt_entity_import_sync_info_save" +
		"	@entity_import_id=?," +
		"	@recip_import_id=?";
	...
	public String m_sDeleteSql =
		" DELETE FROM cntt_entity_import_sync_info" +
		" WHERE" +
		"	(entity_import_id=?) AND" +
		"	(recip_import_id=?)";
	...
	public String m_sMainElementName = "entity_import_sync_info";

                                    ...
                                    <div class="force-overflow">
                                        <div class="table-responsive">
                                            <table id="popular_queries_table" class="table no-margin">
                                                <thead>
                                                <tr>
                                                    <th onclick="sortTableString(0, 'popular_queries_table')" style="cursor:pointer">Query</th>
                                                    <th onclick="sortTableInt(1, 'popular_queries_table')" style="cursor:pointer">Count</th>
                                                    <th onclick="sortTableInt(2, 'popular_queries_table')" style="cursor:pointer">Conversion</th>
                                                </tr>
                                                </thead>
                                    ...
                                    <div class="force-overflow">
                                        <div class="table-responsive">
                                            <table id="failed_queries_table" class="table no-margin">
                                                <thead>
                                                <tr>
                                                    <th onclick="sortTableString(0, 'failed_queries_table')" style="cursor:pointer">Query</th>
                                                    <th onclick="sortTableInt(1, 'failed_queries_table')" style="cursor:pointer">Count</th>
                                                    <th>Synonym</th>
                                                </tr>
                                                </thead>
                                    ...
                                    <div class="force-overflow">
                                        <div class="table-responsive">
                                            <table id="top_performing_queries_table" class="table no-margin">
                                                <thead>
                                                <tr>
                                                    <th onclick="sortTableString(0, 'top_performing_queries_table')" style="cursor:pointer">Query</th>
                                                    <th onclick="sortTableInt(1, 'top_performing_queries_table')" style="cursor:pointer">Count</th>
                                                    <th onclick="sortTableCurrency(2, 'top_performing_queries_table')" style="cursor:pointer">Revenue</th>
                                                </tr>
                                                </thead>
                                    ...
                                    <div class="force-overflow">
                                        <div class="table-responsive">
                                            <table id="queries_without_purchase_table" class="table no-margin">
                                                <thead>
                                                <tr>
                                                    <th onclick="sortTableString(0, 'queries_without_purchase_table')" style="cursor:pointer">Query</th>
                                                    <th onclick="sortTableInt(1, 'queries_without_purchase_table')" style="cursor:pointer">Count</th>
                                                </tr>
                                                </thead>

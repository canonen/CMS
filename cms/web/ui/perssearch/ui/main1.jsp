...
<!DOCTYPE html>
    <html lang="en">
        ...
        <body>
                ...
                <div class="card">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            <li class="nav-item">
                                <a class="nav-link <%if(tarih_aralik == null){%>active<%}%>" href="#search" data-toggle="tab">
                                    Search
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#filters" data-toggle="tab">
                                    Filters
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#query" data-toggle="tab">
                                    Query
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#synonyms" data-toggle="tab">
                                    Synonyms
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#redirects" data-toggle="tab">
                                    Redirects
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#csstab" data-toggle="tab">
                                    CSS
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#product_filter" data-toggle="tab">
                                    Product Filtering
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#campaign_code" data-toggle="tab">
                                    Code
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link <%if(tarih_aralik != null){%>active<%}%>" href="#perssearch_report" data-toggle="tab">
                                    Report
                                </a>
                            </li>
                            <button style="margin-left:auto;" id="save_button" type="submit" class="btn btn-primary" onclick="saveConfigurations(<%=cust.s_cust_id%>,this)" >
                                Save
                            </button>
                        </ul>
                    </div>
                    ...
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane <%if(tarih_aralik == null){%>active<%}%>" id="search">
                                <form class="form-horizontal">
                                    ...
                                    <div class="form-group row">
                                        <label for="inputSelector" class="col-md-2 col-form-label">
                                            Input Selector
                                        </label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group row">
                                        <label for="submitSelector" class="col-md-2 col-form-label">
                                            Submit Selector
                                        </label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group row">
                                        <label for="resultLimit" class="col-md-2 col-form-label">
                                            Result Limit
                                        </label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group row">
                                        <label for="lastSearchTitle" class="col-md-2 col-form-label">
                                            Last Search Title
                                        </label>
                                        <div class="col-md-4">
                                    ...
                                    <div class="form-group row">
                                        <label for="recentlyViewedTitle" class="col-md-2 col-form-label">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-4">
                                            <input type="text" class="form-control" id="placeholderItems" placeholder="Jean, Sweat, ...">
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label for="perSearch_image_link" class="col-form-label">
                                                Image Link
                                            </label>
                                            <input type="text" class="form-control no-preview" name="perSearch_image_link" id="perSearch_image_link" placeholder="Image link">
                                            <input class="no-preview" type="file" accept="image/png, image/jpeg, image/jpg, image/gif" id="perSearchImageUpload" name="perSearchImageUpload">
                                            <button id="perSearchSelectImageUpload" style="margin-left:auto;display:none;" class="btn btn-primary" onclick="perSearchImageUpload(this)">Upload</button>
                                            <input type="button" id="deleteImage" name="deleteImage" value="Delete" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label class="col-form-label" for="imageLink">
                                                Link (When click image)
                                            </label>
                                            <input type="text" id="imageLink" name="imageLink" class="form-control no-preview" placeholder="link" />
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <img id="search-image" />
                            ...
                            <div class="tab-pane" id="category">
                                ...
                                <div class="form-group row">
                                    <label for="categoriesLimit" class="col-md-2 col-form-label">
                                        Categories Limit
                                    </label>
                                    <div class="col-md-4">
                            ...
                            <div class="tab-pane" id="query">
                                <div class="form-group row">
                                    <label for="recommendedQueriesTitle" class="col-md-3 col-form-label">
                                        Recommended Queries Title
                                    </label>
                                    <div class="col-md-4">
                            ...
                            <div class="tab-pane <%if(tarih_aralik != null){%>active<%}%>" id="perssearch_report">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="info-box">
                                            <span style="background-color:#f56954 !important" class="info-box-icon bg-info elevation-2">
                                    ...
                                    <div class="col-12 col-sm-6 col-md-4">
                                        <div class="info-box">
                                            <span style="background-color:#faa926 !important" class="info-box-icon bg-info elevation-2">
                                                ...
                                                <div class="scrollbar" id="style-7">
                                                    <div class="force-overflow">
                                                        <div class="table-responsive">
                                                            <table id="popular_queries_table" class="table no-margin">
                                                                <thead>
                                                                    <tr>
                                                                        <th onclick="sortTableString(0, 'popular_queries_table')" style="cursor:pointer">
                                                                            Query
                                                                        </th>
                                                                        <th onclick="sortTableInt(1, 'popular_queries_table')" style="cursor:pointer">
                                                                            Count
                                                                        </th>
                                                                        <th onclick="sortTableInt(2, 'popular_queries_table')" style="cursor:pointer">
                                                                            Conversion
                                                                        </th>
                                                                    </tr>
                                                                </thead>
                                        ...
                                        <div class="box box-info">
                                            ...
                                            <div class="box-body">
                                                <div class="scrollbar" id="style-7">
                                                    <div class="force-overflow">
                                                        <div class="table-responsive">
                                                            <table id="failed_queries_table" class="table no-margin">
                                                                <thead>
                                                                    <tr>
                                                                        <th onclick="sortTableString(0, 'failed_queries_table')" style="cursor:pointer">
                                                                            Query
                                                                        </th>
                                                                        <th onclick="sortTableInt(1, 'failed_queries_table')" style="cursor:pointer">
                                                                            Count
                                                                        </th>
                                                                        <th>Synonym</th>
                                                                    </tr>
                                        ...
                                        <div class="box box-info">
                                            ...
                                            <div class="box-body">
                                                <div class="scrollbar" id="style-7">
                                                    <div class="force-overflow">
                                                        <div class="table-responsive">
                                                            <table id="top_performing_queries_table" class="table no-margin">
                                                                <thead>
                                                                    <tr>
                                                                        <th onclick="sortTableString(0, 'top_performing_queries_table')" style="cursor:pointer">
                                                                            Query
                                                                        </th>
                                                                        <th onclick="sortTableInt(1, 'top_performing_queries_table')" style="cursor:pointer">
                                                                            Count
                                                                        </th>
                                                                        <th onclick="sortTableCurrency(2, 'top_performing_queries_table')" style="cursor:pointer">
                                                                            Revenue
                                                                        </th>
                                                                    </tr>
                                                                </thead>
                                        ...
                                        <div class="box box-info">
                                            ...
                                            <div class="box-body">
                                                <div class="scrollbar" id="style-7">
                                                    <div class="force-overflow">
                                                        <div class="table-responsive">
                                                            <table id="queries_without_purchase_table" class="table no-margin">
                                                                <thead>
                                                                    <tr>
                                                                        <th onclick="sortTableString(0, 'queries_without_purchase_table')" style="cursor:pointer">
                                                                            Query
                                                                        </th>
                                                                        <th onclick="sortTableInt(1, 'queries_without_purchase_table')" style="cursor:pointer">
                                                                            Count
                                                                        </th>
                                                                    </tr>
                                                                </thead>
            ...
            <% String sql="select config_param,status from " + "c_personal_search_config where cust_id = ?" ;
                pstmt=conn.prepareStatement(sql); int x=1; pstmt.setLong(x++,Long.parseLong(cust.s_cust_id));

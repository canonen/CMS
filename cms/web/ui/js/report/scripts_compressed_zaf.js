...
function toggleContentBox(container) {
    ...
    if (doc.style.display != "block") {
        ...
        document.getElementById(container + '_excol').src = 'http://www.revotas.com/sq_minus_icon16.png'
    } else {
        doc.style.display = 'none';
        document.getElementById(container + '_excol').src = 'http://www.revotas.com/sq_plus_icon16.png'
    }
}

...
//Retargeting Parameters
    ...
    String loggedFBUser   = request.getParameter("fbUser");
    String fbStatus       = request.getParameter("fbStatus");
    if(loggedFBUser==null || fbStatus==null)
    	return;
...
while(rtrg_rs.next())
{
	...
	retargetFBUser      =rtrg_rs.getString(8);
}
...
<body>
<% if(retargetFBUser.equals(loggedFBUser)) {%>
...
<FORM  METHOD="POST" NAME="FT" ACTION="retargeting_save.jsp?fbUser=<%=loggedFBUser%>&fbStatus=<%=fbStatus%>" TARGET="_self">
<!-- Changed for Retargeting -->
<%} %>
...
<% if(retargetGroup.equals("40")){  %>				 
				   <option value="-1">--</option>
				   <option value="40" selected >Facebook Retargeting</option>

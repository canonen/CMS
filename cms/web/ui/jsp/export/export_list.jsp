...
<div class="xboxcontent">
	...
	<tr>
		<TD noWrap align=left style="padding-left:10px; width:5%;">
			<% if (can.bWrite) { %>
			<a class="newbutton" href="export_new.jsp<%=(sSelectedCategoryId!=null)?"?category_id="+sSelectedCategoryId:""%>" <%=(isDisable)?"disabled":""%>><fmt:message key="button_export"/></a>&nbsp;&nbsp;&nbsp;
			<% } %>			
		</td>
		<%
		int numCstmExp = 0;
		...
		<td noWrap align=right style="padding-right:10px;">
			...
			<a class="newbutton" href="export_list.jsp"><fmt:message key="button_refresh"/></a>

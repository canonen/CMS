...
<table width=650 class=listTable cellspacing=0 cellpadding=0>
    <tr>
        <th class=sectionheader><b class=sectionheader>Campaign:</b> <%=(MODE.equals("clone")) ? "Cloned" : "Saved"%>
        </th>
    </tr>
            ...
            <table cellspacing=0 cellpadding=0 width="650">
                <tr>
                    <td align="center" valign="middle" style="padding:10px;">
                        <p>The campaign was <%= actionText %>.</p>
                        <p align="center">
                            <%
                                ...
                                if (camp.m_CampSendParam.s_queue_daily_flag != null) {
                            %>
                            <a href="camp_list.jsp?type_id=4&auto_queue_daily_flag=1<%=(sSelectedCategoryId!=null)?"&category_id="+sSelectedCategoryId:""%>">Back
                                to List</a>
                            <%
                            } else {
                            %>
                        ...
                        <p align="center">
                            <a href="camp_edit<%=((bHasSampleSet)?"_with_samples":"")%>.jsp?camp_id=<%=camp.s_camp_id%><%=(sSelectedCategoryId!=null)?"&category_id="+sSelectedCategoryId:""%>">
                                <%=(MODE.equals("clone")) ? "Edit New Copy" : "Back to Edit"%>
                            </a>
                        </p>
                    </td>
                </tr>

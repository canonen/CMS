...
<div class="page_header">Campaign Lists</div>
<div class="page_desc">Create and manage your campaigns.</div>
...
<ul id="tabnav">
	...
	<li><a href='#' <%= (!showCamp2)?" style=\"display:none;\"":"" %> onclick="FT.type_id.value = 3; FT.auto_queue_daily_flag.value = 0; GO(0);" class=" <%=("Send To Friend".equals(sCampTypeLabel))?"active":""%>">Send to friend</a></li>

...
%>
	<table width=650 class=main cellspacing=0 cellpadding=0>
		<tr>
			<th class=sectionheader>&nbsp;<b class=sectionheader>Step 1:</b> General Information</td>
		</tr>
	</table>
	<br>
<%@ include file="camp_edit/with_samples/step_1.jsp"%>
	...
	<table width=650 class=main cellspacing=0 cellpadding=0>
		<tr>
			<th class=sectionheader>&nbsp;<b class=sectionheader>Step 2:</b> Define Campaign</th>
		</tr>
	</table>
	<br>
...
<%@ include file="camp_edit/with_samples/step_2.jsp"%>
	...
	<table width=650 class=main cellspacing=0 cellpadding=0>
		<tr>
			<th width=100% align="left" valign="middle" class=sectionheader>&nbsp;<b class=sectionheader>Step 3:</b> Define <%=(isDynamicCampaign?"Dynamic Campaign":"Sampleset") %> Variables</td>
...
<%  if (isPrintCampaign) { %>
	...
	<table width=650 class=main cellspacing=0 cellpadding=0>
		<tr>
			<th class=sectionheader>&nbsp;<b class=sectionheader>Step 3,&nbsp;Part 2:</b> Define Your Export</th>
		</tr>
		<tr>
			<th>
...
<%  } %>
	...
	<table width=650 class=main cellspacing=0 cellpadding=0>
		<tr>
			<th class=sectionheader>&nbsp;<b class=sectionheader>Step 4:</b> Launch Campaign</th>
		</tr>
	</table>
	<br>
...
<%@ include file="camp_edit/with_samples/step_4.jsp"%>
	...
	<table width=650 class=main cellspacing=0 cellpadding=0>
		<tr>
			<th class=sectionheader>&nbsp;<b class=sectionheader>Logs:</b> Campaign History</td>
		</tr>
	</table>
	<br>

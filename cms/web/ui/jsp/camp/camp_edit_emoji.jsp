...
<HEAD>
   ...
   <link href="/cms/ui/emoji/css/emoji.css" rel="stylesheet">
...
<td align="left" valign="middle">
	<a class="buttons-save" href="camp_change.jsp?camp_id=<%=editCampId%>" TARGET="_self"><span>Edit</span></a>
</td>
<%
}
...
<table class="listTable" cellspacing="0" cellpadding="5" width="660" border="0">
	<thead>
	<tr>
		<th class="Tab_ON" id="tab6_Step1" width="150" onclick="toggleTabs('tab6_Step','block6_Step',1,4,'Tab_ON','Tab_OFF');" valign="center" nowrap align="middle">(1) <fmt:message key="nsc_tab_campaign_info"/></td>
		<th class="Tab_OFF" id="tab6_Step2" width="150" onclick="toggleTabs('tab6_Step','block6_Step',2,4,'Tab_ON','Tab_OFF');" valign="center" nowrap align="middle">(2) <fmt:message key="nsc_tab_testing"/></td>
	...
	<tr>
		<td class="Tab_GREY" valign="top" align="left" width="660" colspan="4" style=padding:0>

 <c:url value="tab_emoji.jsp" var="tab_xx">
  ...
  %>
			...
			<%@ include file="camp_edit/single/tab_emoji.jsp"%>      
...
<%@ include file="camp_edit/single/js_other.jsp"%>
       ...
       <script src="/cms/ui/emoji/jquery.min.js"></script>
	  <!-- Begin emoji-picker JavaScript -->
    <script src="/cms/ui/emoji/js/config.js"></script>
    <script src="/cms/ui/emoji/js/util.js"></script>
    <script src="/cms/ui/emoji/js/jquery.emojiarea.js"></script>
    <script src="/cms/ui/emoji/js/emoji-picker.js"></script>
    <script src="/cms/ui/emoji/js/unicode_emoji.js"></script>

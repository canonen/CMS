...
<table class="listTable" cellspacing="0" cellpadding="5" width="660" border="0">
	...
	<tr>
		<td class="Tab_GREY" valign="top" align="left" width="100%" colspan="4" style=padding:0>
			...
			<%@ include file="camp_edit/single/v3/tab_1.jsp"%>      
	...
	<tr>
		...
		<%@ include file="camp_edit/single/v3/tab_2.jsp"%>  
	...
	<tr>
		...
		<%@ include file="camp_edit/single/v3/tab_3.jsp"%>  
	</tr>
	</tbody>
	...
	<tr>
		<td class="Tab_GREY" valign="top" align="left" width="660" colspan="4">
		<%@ include file="camp_edit/single/v3/tab_4.jsp"%>  
	</tr>
	</tbody>	
...
<table  cellspacing="0" cellpadding="0" width="660" border="0">
	<tr>
		<td>
<%@ include file="camp_edit/single/v3/tab_6.jsp"%>
		</td>
	</tr>
</table>

...
%>
		<td align="left" valign="middle">
			<a class="button2" href="#" onClick="save();" TARGET="_self"><span class="save2">Save</span></a>
		</td>
<%
} 
...
if( camp.s_camp_id != null )
{
	if (can.bWrite)
	{
		%>
		<td align="left" valign="middle">
			<a class="button2" href="#" onClick="clone();" TARGET="_self"><span class="clone2">Copy</span></a>
		</td>
		<%
		if(ui.getUIMode() != ui.SINGLE_CUSTOMER)
		{
			%>
		<td align="left" valign="middle">
			<a class="button2" href="#" onClick="clone2destination();"><span class="clone2">Copy To Destination</span></a>
		</td>
			<%
		}
	}
	...
	if (can.bDelete && !isSending && !isTesting && !isPending && (!isPendingEdits || (isPendingEdits && isApprover)))
	{
		%>
		<td align="left" valign="middle">
			<a class="button2" href="#" onClick="if( confirm('Are you sure?') ) location.href='camp_delete.jsp?camp_id=<%=camp.s_camp_id%>'" TARGET="_self"><span class="delete2">Delete</span></a>
		</td>
		<%
	}
	...
	if( camp.s_type_id.equals("2") && can.bWrite && !isDone && !isSending && !isTesting && !isPending && !isPendingEdits)
	{
		...
		<td align="left" valign="middle">
			<a href="#" class="button2" onClick="create_sampleset()"><span class="save2">Save & Create SampleSet</span></a>
		</td>
		<td align="left" valign="middle">
			<a href="#" class="button2" onClick="create_dynamic()"><span class="save2">Save & Create Dynamic Campaigns</span></a>
		</td>
			<%
		}
	}
...
<table id="Tabs_Table6" cellspacing="0" cellpadding="5" width="660" border="0">
	<tr>
		<td class="Tab_ON" id="tab6_Step1" width="150" onclick="toggleTabs('tab6_Step','block6_Step',1,4,'Tab_ON','Tab_OFF');" valign="center" nowrap align="middle">(1) Campaign Info</td>
		<td class="Tab_OFF" id="tab6_Step2" width="150" onclick="toggleTabs('tab6_Step','block6_Step',2,4,'Tab_ON','Tab_OFF');" valign="center" nowrap align="middle">(2) Testing</td>
		<td class="Tab_OFF" id="tab6_Step3" width="150" onclick="toggleTabs('tab6_Step','block6_Step',3,4,'Tab_ON','Tab_OFF');" valign="center" nowrap align="middle">(3) Schedule</td>
		<td class="Tab_OFF" id="tab6_Step4" width="150" onclick="toggleTabs('tab6_Step','block6_Step',4,4,'Tab_ON','Tab_OFF');" valign="center" nowrap align="middle">(4) Logs</td>
		<td class="Tab_CLEAR" valign="center" nowrap align="middle" width="0"></td>
	</tr>
	<tr>
...
<%@ include file="camp_edit/single/js_camp_save_zaf.jsp"%>
<%@ include file="camp_edit/single/js_date_zaf.jsp"%>

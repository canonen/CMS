...
if( camp.s_camp_id != null )
{
	...
	if( camp.s_type_id.equals("2") && can.bWrite && !isDone && !isSending && !isTesting && !isPending && !isPendingEdits)
	{
		...
		<td align="left" valign="middle">
			<a href="buttons-save" class="buttons-save" onClick="create_sampleset()"><span>Save & Create SampleSet</span></a>
		</td>
		<td align="left" valign="middle">
...
<ul id="tabnav">
	<li><a id="tab6_Step1" class="active" onclick="toggleTabs('tab6_Step','block6_Step',1,4,'active','noClassPassiveTab');" href="javascript:void(0)">Campaign Info</a></li>
	<li><a id="tab6_Step2" class="noClassPassiveTab" href="javascript:void(0)" onclick="toggleTabs('tab6_Step','block6_Step',2,4,'active','noClassPassiveTab');">Testing</a></li>
	<li><a id="tab6_Step3" class="noClassPassiveTab" href="javascript:void(0)" onclick="toggleTabs('tab6_Step','block6_Step',3,4,'active','noClassPassiveTab');">Schedule</a></li>
	<li><a id="tab6_Step4" class="noClassPassiveTab" href="javascript:void(0)" onclick="toggleTabs('tab6_Step','block6_Step',4,4,'active','noClassPassiveTab');">Logs</a></li>
</ul>
...
<%@ include file="camp_edit/single/js_popup_zaf.jsp"%>

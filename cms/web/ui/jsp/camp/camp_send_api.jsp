...
<%
    ...
    jsonObject.put("sNewCampId", (sNewCampId==null)?"":sNewCampId);
    ...
    if ("pv_test".equals(sMode))
        info = " send a deliverability test. <p> The report may take up to a few hours to be available";
    if ("pv_receipt".equals(sMode))
        info = " send a deliverability test. <p> The report may take up to a few hours to be available";

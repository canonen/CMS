...
<table id="Tabs_Table5" cellspacing="0" cellpadding="0" width="650" border="0">
	<tr>
		<td class="EditTabOn" id="tab5_Step1" width="150" onclick="toggleTabs('tab5_Step','block5_Step',1,2,'EditTabOn','EditTabOff');" valign="center" nowrap align="middle">Send Out</td>
	<%
	if (step4_tab2_show)
	{
		%>
		<td class="EditTabOff campaign_header" id="tab5_Step2" width="150" onclick="toggleTabs('tab5_Step','block5_Step',2,2,'EditTabOn','EditTabOff');" valign="center" nowrap align="middle">Advanced Options</td>
		<%
	}
	%>
...
<%	} %>
	...
	<tr>
			...
			{
				%>
				<a class="button_exe" href="javascript:send();">START CAMPAIGN >></a>
				<%
			}
			%>
			</td>

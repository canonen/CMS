...
function addBriteTrack()
{
	...
	//if(cust.s_cust_id.equals("670"))
	//{
	
	//	if (FT.link_append_text.value.indexOf('&utm_campaign=campaign_name&utm_medium=email&utm_source=revotas&BrCs=<%=cust.s_cust_id%>&BrCg=!*CampaignID;*!&BrRc=!*RecipID;*!')>-1) return;
	//	FT.link_append_text.value += '&utm_campaign=campaign_name&utm_medium=email&utm_source=revotas&BrCs=<%=cust.s_cust_id%>&BrCg=!*CampaignID;*!&BrRc=!*RecipID;*!';
	//}else{

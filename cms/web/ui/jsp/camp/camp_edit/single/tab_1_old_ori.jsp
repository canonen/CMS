	<table class="main" cellspacing="1" cellpadding="2" width="100%">
					...
					<td><input TYPE="text" NAME="camp_name" value="<%= camp.s_camp_name %>" SIZE="40" MAXLENGTH="50" <% if (camp.s_type_id.equals("5") || isPrintCampaign ) { %>onChange="if (document.all.export_name.value != null) { document.all.export_name.value = this.value; }" <% } %>></td>
	</tr>
...
<table class="main" cellspacing="1" cellpadding="2" width="88%">
<%
if (!STANDARD_UI && !isPrintCampaign)
{
	%>
	<tr>
		<td width="150" height="25" class="campaign_header">Reply To</td>
		<td width="400" height="25"><input type="text" name="reply_to" value="<%= HtmlUtil.escape(msg_header.s_reply_to) %>" size="40" maxlength="255">
...
if (!camp.s_type_id.equals("3")) //Seed List won't work with S2F since only sends to friend recips
{
	%>
	<tr>
		<td width="150" height="25" class="campaign_header">Seed List (optional)</td>
		<td width="400" height="25">
...
%>
    <% if (!isPrintCampaign) { %>
	<tr>
		<td width="150" height="25" class="campaign_header">Text to append to tracking links</td>
		<td width="400" height="25">
		...
		if (bFeat)
		{
			%>
			<br><br>
			<a href="javascript:addBriteTrack();" class="button_res">Add BriteTrack</a>
			<%
		}
		%>
		</td>
	...
	<tr>
		<td width="150" height="25" class="campaign_header">Campaign Code</td>
		<td width="400" height="25">
...
if (canStep3)
{
	...
	if( camp.s_type_id.equals("2") )
	{
		...
		<tr>
			...
			<td width="400" height="25" class="campaign_header">
				<p>
					How many
					&nbsp;

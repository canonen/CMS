<table class="listTable" cellspacing="1" cellpadding="1" width="100%" border="0">
	<tr>
...
%>
	<tr>
		...
		<td align="left" valign="middle"><%=HtmlUtil.escape(sRecpQueuedQty)%></td>
...
%>
	<tr>
		<td class="CampHeader" colspan="8">Nothing has been sent for this campaign</td>
	</tr>		
<%
		}
	}
...
%>
	<tr>
		<td class="CampHeader" colspan="8">This area will show Send History information once you click the Save button.</td>
	</tr>
<%
	}
%>

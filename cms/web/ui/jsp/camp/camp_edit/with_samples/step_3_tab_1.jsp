	...
	<tr>
		...
		else
		{
		 msg="";	
		    ...
		    %>
	<p id="rvts_emoji_title" class="lead emoji-picker-container"><input type="text" name="subj_html<%=sSampleId%>" value="<%=msg%>" size="40" maxlength="150" data-emojiable="true" data-emoji-input="unicode"></p> 

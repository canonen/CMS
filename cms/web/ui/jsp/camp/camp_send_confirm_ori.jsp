...
<table width=650 class=main cellspacing=0 cellpadding=0>
	<tr>
		<td class=sectionheader>&nbsp;<b class=sectionheader>Campaign:</b> <%=(sMode.equals("test"))?"Test":"Send"%> Confirmation</td>
	</tr>
</table>
<br>
...
<%-- Start Step 2 information --%>
		...
		if (!isPrintCampaign && (!bHasSampleset  || bDisplayingFinal || (bDisplayingSamples && sampleset.s_subject_flag == null) ))
		{
			...
			<table class="main" cellspacing="1" cellpadding="2" width="100%">
				<tr>
					<td width="125" height="25">Subject: </td>
		...
		%>
			...
			<br>
			<% if (canStep2) { %>
			<table  class="main" cellspacing="1" cellpadding="1" border="0" width="100%">
                <% if (!isPrintCampaign) { %>
				<tr>
			...
			if (iCampTypeId != CampaignType.SEND_TO_FRIEND)
			{
				%>
				<tr>
					<td width="125" height="25">Seed List: </td>
					<td width="425" height="25">
						<%
			...
			if (iCampTypeId == CampaignType.STANDARD && !isPrintCampaign)
			{
				%>
				<tr>
					<td width="125" height="25">Linked to Campaign: </td>
					<td width="425" height="25">
						<%
			...
			<table  class="main" cellspacing="1" cellpadding="1" border="0" width="100%">
				<tr>
					<td width="125" height="25">Exclusion List: </td>
					<td width="425" height="25">
						<%
			...
			if (iCampTypeId != CampaignType.SEND_TO_FRIEND)
			{
				...
				else
				{
					%>
				<tr>
					<td width="125" height="25">Frequency Exclusion: </td>
					<td width="425" height="25">
			...
			if (iCampTypeId == CampaignType.STANDARD && !isPrintCampaign)
			{
				%>
				<tr>
					<td width="125" height="25">Subset Sendout: </td>
					<td width="425" height="25">
						<%
			...
			if (!isPrintCampaign && iCampTypeId == CampaignType.STANDARD)
			{
				%>
				<tr>
					<td width="125" height="25">Maximum messages to be sent per hour: </td>
...
<%-- Start Step 3 information --%>
		...
		if (bDisplayingSamples)
		{
			while (iSamples.hasNext())
			{
				...
				%>
				<table  class="main" cellspacing="1" cellpadding="2" border="0" width="100%">
					<tr>
		...
		%>
			...
			if ((s_test_list_name != null) && (!s_test_list_name.equals("null")))
			{
				...
				<table  class="main" cellspacing="1" cellpadding="1" border="0" width="100%">
					<tr>
						<td align="left" valign="middle">Test List: <%= HtmlUtil.escape(s_test_list_name) %></td>
					</tr>
				</table>
				<br>
				<%
...
<%-- Start Step 4 information --%>
		...
		if (!bHasSampleset || bDisplayingFinal || (bDisplayingSamples && sampleset.s_send_date_flag == null) )
		{
			...
			%>
				<tr>
					<td width="125" height="25">Queue Start Date: </td>
					...
					<tr>
						...
						<td align="center" valign="middle" width="50%" style="padding:5px;">
							...
							<% if (!bWorkflow) { %>
								<tr>
									<td align="center" valign="middle">
										<a class="actionbutton" href="javascript:doSend(1);">Confirm >> Send Campaign</a>
									</td>
								</tr>

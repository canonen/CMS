...
<%
    ...
    try {
        ...
        jsonObject.put("stepDesc", stepDesc);

        if (csds.size() == 0) {
            jsonObject.put("campStatDetails", "A detailed break down of the number of queued recipients is unavailable for this campaign.");
        } else {
            String sClassAppend = "";
            int iCount = 0;
            ...
            if (sWsSentCountFlag != null && sWsSentCountFlag.equals("1")) {
                ...
                if (rs.next()) {
                    ...
                    jsonObject.put("sWsCampId", sWsCampId);
                } else {
                ...
                if (rs.next()) {
                    ...
                    jsonObject.put("campStartDate", campStartDate);
                }
                rs.close();
            ...
            jsonObject.put("sValue", sValue);
            jsonObject.put("oldName", oldName);
            jsonObject.put("oldValue", oldValue);
            jsonObject.put("bDomainCount", bDomainCount);
            jsonObject.put("csd.s_detail_name", csd.s_detail_name);
            jsonObject.put("csd.s_integer_value", csd.s_integer_value);

...
if ("true".equals(sWM))
{
	String sRedirectUrl ="/cms/ui/jsp/mini/wizard.jsp?step=5&camp_id=" + sCampId +"&category_id=" + sSelectedCategoryId;
	
	// Setting up customer credit
	// Get campaign target group id to calculate number of recipients
	// Pull down the credit of the customer with this recipient count
	
	String campFilterId = camp.s_filter_id;
	FilterStatistic filter_stat = new FilterStatistic(campFilterId);
	int recipQty = Integer.parseInt(filter_stat.s_recip_qty);
	...
	cc.s_used_credit = Integer.toString(p_used_credit + recipQty);
	cc.s_remaining_credit = Integer.toString(p_remaining_credit - recipQty);
	cc.saveWithSync();
	
	response.sendRedirect("/cms/ui/jsp/mini/campaigns.jsp?a=campaigns");
	return;
}
%>
...
<table width=95% class=listTable cellspacing=0 cellpadding=0>
	<tr>
		<th class=sectionheader>
			&nbsp;
			<b class=sectionheader>Campaign:</b>
			<%=("test".equals(sMode))?" Test":(("calc_only".equals(sMode))?" Recipient Calculation":" Campaign")%>
			<%=(bIsRunning)?" IS ALREADY RUNNING !!!":" Scheduled"%>
		</th>
	</tr>
...
<% String info = "be sent";
   if ("test".equals(sMode)) info = "send a test";
   if ("calc_only".equals(sMode)) info = "calculate recipient statistics";
   if ("pv_test".equals(sMode))info = " send a deliverability test. <p> The report may take up to a few hours to be available";
   if ("pv_receipt".equals(sMode))info = " send a deliverability test. <p> The report may take up to a few hours to be available";
%>					
<b>The campaign was scheduled to <%= info %>.</b>
<br><br>
<%
...
if(("test".equals(sMode)) || ("pv_test".equals(sMode)) ||  ("pv_receipt".equals(sMode)) || ("calc_only".equals(sMode)))
{
	if ("2".equals(TYPE_ID))
	{
		%>
	<p align="center">
		<a href="camp_list.jsp?type_id=2<%=(sSelectedCategoryId!=null)?"&category_id="+sSelectedCategoryId:""%>">
			Back to List
		</a>
	</p>
		<%
	...
	else if ("3".equals(TYPE_ID))
	{
		%>
	<p align="center">
		<a href="camp_list.jsp?type_id=3<%=(sSelectedCategoryId!=null)?"&category_id="+sSelectedCategoryId:""%>">
			Back to List
		</a>
	</p>
		<%
	...
	else if ("4".equals(TYPE_ID))
	{
		%>
	<p align="center">
		<a href="camp_list.jsp?type_id=4<%=(sSelectedCategoryId!=null)?"&category_id="+sSelectedCategoryId:""%>">
			Back to List
		</a>
	</p>
	<!--<p align="center">
		<a href="camp_list.jsp?type_id=2&auto_queue_daily_flag=1&<%=(sSelectedCategoryId!=null)?"&category_id="+sSelectedCategoryId:""%>">
			Back to List
		</a>
	</p>//-->
		<%
	...
	else if ("5".equals(TYPE_ID))
	{
		%>
	<p align="center">
		<a href="camp_list.jsp?type_id=5<%=(sSelectedCategoryId!=null)?"&category_id="+sSelectedCategoryId:""%>">
			Back to List
		</a>
	</p>
		<%
...
else
{
	...
	if(nCampTypeId == CampaignType.STANDARD)
	{
		...
		{
%>
			<p align="center"><a href="camp_list.jsp?type_id=4&auto_queue_daily_flag=1<%=(sSelectedCategoryId!=null)?"&category_id="+sSelectedCategoryId:""%>">Back to List</a></p>
<%
		}
		else
		{
%>
			<p align="center"><a href="<%=sHref%>">Back to List</a></p>
<%
		}
	}
	else
...
%>
	<p align="center">
		<a href="camp_edit.jsp?camp_id=<%=camp.s_camp_id%><%=(sSelectedCategoryId!=null)?"&category_id="+sSelectedCategoryId:""%>">
			Back to Edit
		</a>
	</p>
					</td>
				...
				<tr>
					<td align="center" valign="middle" style="padding:10px;">
						<font color="red"><b>WARNING:</b></font>&nbsp;Do not click the "Back" button of the internet browser.<br><br>
			...
			throws Exception
{
	...
	try
	{
		...
		try
		{
			//if ("2".equals(cust.s_level_id)) sApprovalFlag = "1";
			// trusted customer status for campaign approval is no longer in effect for v 5.2

...
if(origin_camp.retrieve() < 1)
	throw new Exception("Campaign id = " + origin_camp.s_camp_id + "does not exist");
if(!cust.s_cust_id.equals(origin_camp.s_cust_id))
	throw new Exception("Campaign id = " + origin_camp.s_camp_id + "does not belong to customer id = " + cust.s_cust_id);
...
<table width=650 class=main cellspacing=0 cellpadding=0>
	<tr>
		<td class=sectionheader>&nbsp;<b class=sectionheader>Campaign:</b> Updated</td>
	</tr>
</table>
<br>
<!---- Step 1 Info----->
			...
			<table class=main cellspacing=1 cellpadding=2 width="650">
				<tr>
					<td align="center" valign="middle" style="padding:10px;">
						<p>The campaign was updated.</p>
<p align="center">
<%
String sHref = "camp_list.jsp?type_id=" + origin_camp.s_type_id;
if(sSelectedCategoryId!=null) sHref += "&category_id=" + sSelectedCategoryId;
if(ocsp.s_queue_daily_flag != null) sHref += "&auto_queue_daily_flag=1";

if (ocsp.s_queue_daily_flag != null)
{
	%>
	<a href="camp_list.jsp?type_id=4&auto_queue_daily_flag=1<%=(sSelectedCategoryId!=null)?"&category_id="+sSelectedCategoryId:""%>">Back to List</a>
	<%
}
else
{
...
<p align="center">
	<a href="camp_edit_single.jsp?camp_id=<%=origin_camp.s_camp_id%><%=(sSelectedCategoryId!=null)?"&category_id="+sSelectedCategoryId:""%>">
		Back to Edit
	</a>
</p>
					</td>

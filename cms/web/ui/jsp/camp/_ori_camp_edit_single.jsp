...
%>
		<td align="left" valign="middle">
			<a class="savebutton" href="#" onClick="save();" TARGET="_self">Save</a>
		</td>
<%
} 
...
if( camp.s_camp_id != null )
{
	if (can.bWrite)
	{
		%>
		<td align="left" valign="middle">
			<a class="savebutton" href="#" onClick="clone();" TARGET="_self">Clone</a>
		</td>
		<%
	...
	if (can.bDelete && !isSending && !isTesting && !isPending && (!isPendingEdits || (isPendingEdits && isApprover)))
	{
		%>
		<td align="left" valign="middle">
			<a class="deletebutton" href="#" onClick="if( confirm('Are you sure?') ) location.href='camp_delete.jsp?camp_id=<%=camp.s_camp_id%>'" TARGET="_self">Delete</a>
		</td>
		<%
	}
	...
	if( camp.s_type_id.equals("2") && can.bWrite && !isDone && !isSending && !isTesting && !isPending && !isPendingEdits)
	{
		...
		<td align="left" valign="middle">
			<a href="#" class="savebutton" onClick="create_sampleset()">Save & Create SampleSet</a>
		</td>
		<td align="left" valign="middle">
			<a href="#" class="savebutton" onClick="create_dynamic()">Save & Create Dynamic Campaigns</a>
		</td>
			<%
		}
	}
...
<%@ include file="camp_edit/single/step_1.jsp"%>

	<br><br>
	<table width=650 class=main cellspacing=0 cellpadding=0>
		<tr>
			<td class=sectionheader>&nbsp;<b class=sectionheader>Step 2:</b> Define Your Campaign</td>
		</tr>
	</table>
	<br>
	
<%@ include file="camp_edit/single/step_2.jsp"%>

	<br><br>	
	<table width=650 class=main cellspacing=0 cellpadding=0>
		<tr>
			<td class=sectionheader>&nbsp;<b class=sectionheader>Step 3:</b> <%=((isPrintCampaign || camp.s_type_id.equals("5"))?"Define Your Export":"Testing")%></td>
		</tr>
	</table>
	<br>

<%@ include file="camp_edit/single/step_3.jsp"%>
...
<%@ include file="camp_edit/single/step_4.jsp"%>
...
<%@ include file="camp_edit/single/step_5.jsp"%>

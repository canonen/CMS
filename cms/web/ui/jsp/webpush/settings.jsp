...
<fmt:bundle basename="app">
    ...
    <div class="page_header">WebPush Settings</div>
    <div id="info">
        <div id="xsnazzy">
            ...
            <div class="xboxcontent">
                ...
                <textarea id="webpush" cols="66" rows="16" spellcheck="false" readonly>

<!--------- Revotas WebPush ------------>

  <link href='https://<rvts_customer_name>.revotas.com/trc/api/revotas_style.css' rel='stylesheet' type='text/css'>
 <div id='a1'></div>
                     <script type='text/javascript'>
                     var rvts = '<rvts_customer_name>_revotas';
	             (function() {
		      var _rTag = document.getElementsByTagName('script')[0];
	                 var _rcTag = document.createElement('script');
	                    _rcTag.type = 'text/javascript';
		       _rcTag.async = 'true';
		      _rcTag.src = ('https://<rvts_customer_name>.revotas.com/trc/api/revotasapi.js');
...
<!--------- Revotas WebPush ------------>
    ...
    <script>
        ...
        document.getElementById('webpush').value = document.getElementById('webpush').value.replace('<rvts_customer_name>',custName.toLowerCase());
        document.getElementById('webpush').value = document.getElementById('webpush').value.replace('<rvts_customer_name>',custName.toLowerCase());
        document.getElementById('webpush').value = document.getElementById('webpush').value.replace('<rvts_customer_name>',custName.toLowerCase());
    </script>
    </body>

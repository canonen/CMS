...
<table width=650 class=listTable cellspacing=0 cellpadding=0>
	<tr>
		<th colspan=4 width="620" class=sectionheader>&nbsp;<b class=sectionheader>Step 1:</b> <%= ((a.s_attr_id != null))?"Edit":"Create"%> Custom Field <a href="javascript:loadHelp('vl1125-ch1133', '1129');" class="resourcebutton" title="Help on this Section">[?]</a></th>
	</tr>
	<tr>
		<td class=Tab_ON id=tab1_Step1 width=150 onclick="toggleTabs('tab1_Step','block1_Step',1,3,'Tab_ON','Tab_OFF');" valign=center nowrap align=middle><b>Details</b></td>
		<td class=Tab_OFF id=tab1_Step2 width=150 onclick="toggleTabs('tab1_Step','block1_Step',2,3,'Tab_ON','Tab_OFF');" valign=center nowrap align=middle><b>Advanced Settings</b></td>
		<td class=Tab_OFF id=tab1_Step3 width=150 onclick="toggleTabs('tab1_Step','block1_Step',3,3,'Tab_ON','Tab_OFF');" valign=center nowrap align=middle><b>Values</b></td>
		<td class=Tab_OFF valign=center nowrap align=middle width=200><img height=2 src="../../../images/blank.gif" width=1></td>
	</tr>
	...
	<tr>
		<td valign=top align=center width=650 colspan=4 height=200>
			<table class="" cellspacing="1" cellpadding="2" width="100%">
				<tr>

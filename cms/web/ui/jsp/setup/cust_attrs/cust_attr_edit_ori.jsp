...
<table id="Tabs_Table1" cellspacing=0 cellpadding=0 width=650 border=0>
	<tr>
		<td class=EditTabOn id=tab1_Step1 width=150 onclick="toggleTabs('tab1_Step','block1_Step',1,3,'EditTabOn','EditTabOff');" valign=center nowrap align=middle>Details</td>
		<td class=EditTabOff id=tab1_Step2 width=150 onclick="toggleTabs('tab1_Step','block1_Step',2,3,'EditTabOn','EditTabOff');" valign=center nowrap align=middle>Advanced Settings</td>
		<td class=EditTabOff id=tab1_Step3 width=150 onclick="toggleTabs('tab1_Step','block1_Step',3,3,'EditTabOn','EditTabOff');" valign=center nowrap align=middle>Values</td>

...
<table width="100%">
	<tr>
		<td class="page_header">Custom Fields</td>
	</tr>
</table>
<br>	
<%
...
<table cellspacing="0" cellpadding="3" border="0" width="650">
	...
	if (nUIType == UIType.ADVANCED)
	{
		...
		<td align="left" valign="middle" nowrap>
			...
			<img border="0" width="45" src="../../../images/45_45_cust.png" onmouseout="this.src='../../../images/45_45_cust.png'" onmouseover="this.src='../../../images/45_45_custg.png'">			
			<br>&nbsp;&nbsp;&nbsp;New Field</a>&nbsp;&nbsp;&nbsp;
		</td>
		<%
	...
	<tr>
		<td class="listHeading" valign="center" nowrap align="left">
			...
			<table class="listTable" width="100%" cellpadding="2" cellspacing="0">
				...
				<tr>
					<th class="list_name" nowrap>Display Name</th>
					<th class="list_name" nowrap>Attribute Name</th>
					<th class="list_name" nowrap>Field Type</th>
					<th class="list_name" width="5%" nowrap>Multi-value</th>
					<th class="list_name" width="5%">Fingerprint</th>
					<th class="list_name" swidth="5%">Newsletter</th>
				</tr>
			<%

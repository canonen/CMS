...
<table width=475 class=listTable cellspacing=0 cellpadding=0>
	<tr>
		<th class=sectionheader >&nbsp;<b class=sectionheader>Step 1:</b> Name your <%= listType %> List</th>
	</tr>
	<tr>
		<td style="PADDING-RIGHT: 5px; PADDING-LEFT: 5px; PADDING-BOTTOM: 5px; PADDING-TOP: 5px" valign=top align=center width=475>
...
<% } %>
	...
	<tr>
		<th style="border-top:1px solid #D1D1D1"  class=sectionheader >&nbsp;<b class=sectionheader>Step 2:</b> Enter <%= listType %> <%= (!listTypeID.equals("5")?"Email Addresses":"Fingerprints ( "+sFingerSeq+" )") %></th>
	</tr>

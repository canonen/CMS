			...
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle" style="padding:10px;">
						<span style="font-size:14pt;">Status:<%=" " + sStatusName%></span>
					</td>
				</tr>
			</table>
		</td>
...
<table class=listTable cellspacing=0 cellpadding=0 width=650 border=0>
	...
	<tr>
		<td class=fillTab valign=top align=center width=650 colspan=3>
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td class="list_row_other" width="150">Import name</td>
					<td class="list_row" width="475"><%= HtmlUtil.escape(imp.s_import_name) %></td>
				</tr>
				<tr>
					<td class="list_row_other" width="150">Batch</td>
					<td class="list_row" width="475"><%= HtmlUtil.escape(batch.s_batch_name) %></td>
				</tr>
				<tr>
					<td class="list_row_other" width="150">Data begins on</td>
					<td class="list_row" width="475"><%= (imp.s_first_row.equals("1"))?"1st":"2nd" %> row</td>
				</tr>
				<tr>
					<td class="list_row_other" width="150">Delimiter</td>
					<td class="list_row" width="475">
...
<%	if ((imp.s_multi_value_field_separator != null) && (imp.s_multi_value_field_separator.length() > 0)){ %>			
				<tr>
					<td class="list_row_other" width="150">Multi-Value Field Delimiter</td>
					<td class="list_row" width="475">
...
<%	if (!bStandardUI) { %>
				<tr>
					<td class="list_row_other" width="150">Import Rule</td>
					<td class="list_row" width="475"><%= sUpdRuleId %></td>
				</tr>
				<tr>
					<td class="list_row_other" width="150">Full Name Processing</td>
					<td class="list_row" width="475">Recipient full name was <%=(nFullNameFlag == 0)?"not":""%> calculated.</td>
				</tr>
<%	} %>
				<!--<tr><td class="list_row_other" width="150">Email Type Processing</td><td width="425">Recipient email type and confidence was <%=(nEmailTypeFlag==0)?"not":""%> calculated for duplicates.</td></tr>-->
<%	if (sNewsletters.length() > 0) { %>
				<tr>
					<td class="list_row_other" width="150">Newsletters</td>
					<td class="list_row" width="475"><%= sNewsletters %></td>
				</tr>
<%	} %>

				<tr>
					<td class="list_row_other" width="150">Total records in import file</td>
					<td class="list_row" width="475"><%=(imp_stats.s_tot_rows!=null)?imp_stats.s_tot_rows:"N/A"%></td>
				</tr>
				<tr>
					<td class="list_row_other" width="150">Bad Rows in Import File</td>
					<td class="list_row" width="475"><FONT COLOR="RED"><%=(imp_stats.s_bad_rows!=null)?imp_stats.s_bad_rows:"N/A"%></FONT></td>
				</tr>
				<tr>
					<td class="list_row_other" width="150">Warning Recipients</td>
					<td class="list_row" width="475">
						<table BORDER=0>
							<tr>
...
<%	} %>
				...
				<tr>
					<td class="list_row_other" width="150">Invalid Recipients</td>
					<td class="list_row" width="475">
						<table BORDER=0>
							<tr>
...
<%	} %>
				...
				<tr>
					<td class="list_row_other" width="150">Invalid Emails</td>
					<td class="list_row" width="475">
						<table BORDER=0>
							<tr>
...
<%	} %>
				...
				<tr>
					<td class="list_row_other" width="150">Duplicates in the files</td>
					<td class="list_row" width="475">
						<table BORDER=0>
							<tr> 
...
<%	} %>
				...
				<tr>
					<td class="list_row_other" width="150">Total after invalids</td>
					<td class="list_row" width="475"><%=(imp_stats.s_tot_recips!=null)?imp_stats.s_tot_recips:"N/A"%> recipients</td>
				</tr>
				<tr>
					<td class="list_row_other" width="150">Duplicates in the DB</td>
					<td class="list_row" width="475">
						<table BORDER=0>
							<tr>
...
<%	} %>
				...
				<tr>
					<td class="list_row_other" width="150">Committed</td>
					<td class="list_row" width="475"><%=(imp_stats.s_num_committed!=null)?imp_stats.s_num_committed:"N/A"%> recipients</td>
				</tr>
				<tr>
					<td class="list_row_other" width="150">Left to commit</td>
					<td class="list_row" width="475"><%=(imp_stats.s_left_to_commit!=null)?imp_stats.s_left_to_commit:"N/A"%> recipients</td>
				</tr>
<%	if (imp_stats.s_error_message != null) { %>
				<tr>
					<td class="list_row_other" width="150"><FONT COLOR="RED">Error</FONT></td>
					<td class="list_row" width="475"><%=imp_stats.s_error_message%></td>
				</tr>
<% } %>
			</table>
		</td>

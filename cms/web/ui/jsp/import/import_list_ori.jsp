...
<div class="page_header">Import Lists</div>
<div class="page_desc">Import lists to increase the size of your data.</div>
<%
...
<%=(sSelectedCategoryId!=null)?"<INPUT type=\"hidden\" name=\"category_id\" value=\""+sSelectedCategoryId+"\">":""%>
				<TABLE class=listTable cellSpacing=0 cellPadding=2 width="100%" style="padding-top: 4px;">
					<TBODY>
						<TR>
							<TD noWrap valign="top" align=left style="padding-left:10px; width:5%;"><a class="newbutton" href="javascript:submitForm();">New Import</a>&nbsp; </TD>
...
%>
							...
							<TD noWrap valign="top" align=left style="width:5%;"><a class="newbutton" href="../edit/manual_import.jsp">Manual Import</a>&nbsp; </TD>
...
%>								</select>
							...
							<TD noWrap valign="top" ><A class="data_refresh" href="import_list.jsp">Refresh</A>
							</TD>
						</TR>
					</TBODY>
				</TABLE>
...
<table cellspacing="0" cellpadding="0" width="99.8%" border="0">
	<tr>
		<th align="left" nowrap>Current Imports</TH>
	</tr>	
	<tr>
		<td class="listHeading" valign="center" nowrap align="left">
			<table class="list_table" id="example2" cellpadding="2" cellspacing="0" width="100%">
				<THEAD>		
				<tr>
					<th nowrap>Status</th>
...
<table cellspacing="0" cellpadding="0" width="99.8%" border="0">
	<tr>
		<th align="left" nowrap>Completed Imports</TH>
	</tr>	
	<tr>
		<td class="listHeading" valign="center" nowrap align="left">
			<table class="list_table" id="example" cellpadding="2" cellspacing="0" width="100%">
				<THEAD>
				<tr>
					...
					<th nowrap>Status</th>
					<th nowrap width="50">Total&nbsp;&nbsp;</th>
					<th nowrap width="90">Rejected</th>
					<th nowrap width="100">Duplicate in DB</th>
					<th nowrap width="50">New&nbsp;&nbsp;</th>
				</tr>
				</THEAD>
				<TBODY>
<%

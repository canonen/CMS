...
//}
%>
							<TD noWrap valign="top" align=left style="width:5%;"><a class="newbutton" href="javascript:submitFormImport();"><fmt:message key="button_import_manual"/></a>&nbsp; </TD>
...
{   
	location.href = '../edit/manual_import.jsp?batch_id='+FT.batch_id.value;
}

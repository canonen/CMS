...
try	{
	...
	String XSLFile= XSLDir + "ReportListWizard.xsl";
		
	String sXML="<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n";
	sXML+="<CampaignList>\n";
	sXML+="<StyleSheet>default.css</StyleSheet>\n";
...
//	sXML+="<CampaignView>../report/bnet_report_object.jsp</CampaignView>\n";
	sXML+="<CampaignView>../report/bnet_report_redirect.jsp</CampaignView>\n";
	sXML+="<CampaignUpdate>../report/bnet_report_update.jsp</CampaignUpdate>\n";
	...
	if (stmt.execute(sSQL))
	{
		...
		while (rs.next())
		{
			...
			String[] md = rs.getString(5).split(" ");
			String newmd = "";
			...
			swRow.write("<StartDate>"+newmd+"</StartDate>\n");

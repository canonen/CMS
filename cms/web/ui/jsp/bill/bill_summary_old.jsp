...
%>
  <br>
    <center><b>Delivery Summary &nbsp;&nbsp;(from <%=sDateFrom%> to <%=sDateTo%>)</b></center>
  <br>
    ...
    <tr>
      <td align="left" valign="top" style="padding:0px;">
        <table class="listTable" cellpadding="0" cellspacing="0" border="0" width="100%">
	      <tr>
	        <th align="left"  valign="middle" width=40%>&nbsp;&nbsp;Partner Name</th>
            <th align="left"  valign="middle" width=40% nowrap>&nbsp;&nbsp;Client Name</th>
            <th align="right" valign="middle" width=20% nowrap>&nbsp;&nbsp;Emails Sent&nbsp;&nbsp;</th>
            <th align="right" valign="middle" width=20% nowrap>&nbsp;&nbsp;Prints Sent&nbsp;&nbsp;</th>
          </tr>
<%		
...
%>
	      <tr>
		    <td class="listItem_Data" align="left"  valign="middle" width=40%>&nbsp;&nbsp;<%=sPartnerName%></a></td>
		    <td class="listItem_Data" align="left"  valign="middle" width=40% nowrap>&nbsp;&nbsp;<%=sCustName%></td>
		    <td class="listItem_Data" align="right" valign="middle" width=20% nowrap>&nbsp;&nbsp;RCP Timeout Error:<%=saved_ex.getMessage()%>&nbsp;&nbsp;</td>
		    <td class="listItem_Data" align="right" valign="middle" width=20% nowrap>&nbsp;&nbsp;--&nbsp;&nbsp;</td>
	      </tr>
<%
				if (doExport) {
...
%>
	      <tr>
		    <td class="listItem_Data" align="left"  valign="middle" width=40%>&nbsp;&nbsp;<%=sPartnerName%></a></td>
		    <td class="listItem_Data" align="left"  valign="middle" width=40% nowrap>&nbsp;&nbsp;<%=sCustName%></td>
		    <td class="listItem_Data" align="right" valign="middle" width=20% nowrap>&nbsp;&nbsp;RCP Error:<%=saved_ex.getMessage()%>&nbsp;&nbsp;</td>
   		    <td class="listItem_Data" align="right" valign="middle" width=20% nowrap>&nbsp;&nbsp;--&nbsp;&nbsp;</td>
	      </tr>
<%
				if (doExport) {
...
%>
	      <tr>
		    <td class="listItem_Data" align="left"  valign="middle" width=40%>&nbsp;&nbsp;<%=sPartnerName%></a></td>
		    <td class="listItem_Data" align="left"  valign="middle" width=40% nowrap>&nbsp;&nbsp;<%=sCustName%></td>
		    <td class="listItem_Data" align="right" valign="middle" width=20% nowrap>&nbsp;&nbsp;<%=sSent%>&nbsp;&nbsp;</td>
   		    <td class="listItem_Data" align="right" valign="middle" width=20% nowrap>&nbsp;&nbsp;<%=sPrintSent%>&nbsp;&nbsp;</td>
	      </tr>
<%
       }
%>

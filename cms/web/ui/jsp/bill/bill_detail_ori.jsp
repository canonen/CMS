...
%>
  ...
  <br>
    <h1>Campaign Summary&nbsp;&nbsp;(from <%=sDateFrom%> to <%=sDateTo%>)</h1>
  <br>
...
%>
    ...
    <tr>
      <td>
          ...
          &nbsp;&nbsp; <a class="buttons" href="javascript:ExportWin('<%=s_file_url%>');">Preview</a>
      </td>
    </tr>
<%
		}
...
%>
	      <tr style='background-color:<%=bgcolor%>'>
		    ...
		    <td class="listItem_Data" align="left" valign="middle" width=10% nowrap><%=sSent%></td>
		    <td class="listItem_Data" align="left" valign="middle" width=10% nowrap><%=clientSubtotal%></td>
		    <td class="listItem_Data" align="left" valign="middle" width=10% nowrap><%=subtotal%></td>
	      </tr>
<%
		  }

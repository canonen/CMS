...
<div class="page_header"><fmt:message key="header_template"/></div>
<div class="page_desc"><fmt:message key="header_template_desc"/></div>

<table cellpadding="3" cellspacing="0" border="0" width="100%">
	<tr>
		<td nowrap align="left" valign="middle"><a class="newbutton" href="selecttemplate.jsp"><fmt:message key="buttontemplate"/></a>&nbsp;&nbsp;&nbsp;</td>
	...
	<tr>
		<td class="listHeading" width="100%" valign="center" nowrap align="left">
			...
			<table class="listTable" width="100%" cellspacing="0" cellpadding="2">
				<tr>
					<th align="left" nowrap><fmt:message key="tmp_column_image"/></th>
					<th align="left" nowrap><fmt:message key="tmp_column_name"/></th>
					<th align="left" nowrap><fmt:message key="tmp_column_template"/></th>
					<th align="left" nowrap><fmt:message key="tmp_column_status"/></th>
					<th align="left" nowrap><fmt:message key="tmp_column_last_modified"/></th>
					<% if ("0".equals(isWizard)) { %>
					<th align="left" nowrap colspan="4"><fmt:message key="tmp_column_action"/></th>
					<% } %>
				</tr>
		<%
		...
		while (rs.next())
		{
			...
			<tr>
				...
				<img width="100" height="100" border="0" src="/cctm/ui/images/templates/<%= t_image %>"></a></td>
				...
				<% if ("0".equals(isWizard)) { %>
				<td class="listItem_Data<%=sClassAppend%>" align=center><a class="resourcebutton" href="pageedit.jsp?isEdit=false&contentID=<%= contentID %>&templateID=<%= templateID %>"><fmt:message key="tmp_column_action_btn_preview"/></a></td>
				<td class="listItem_Data<%=sClassAppend%>" align=center>
				...
				<%	if (!status.equals("locked")) {
					...
					<a class="subactionbutton" href="commit.jsp?contentID=<%= contentID %>&templateID=<%= templateID %>"><fmt:message key="tmp_column_action_btn_commit"/></a>
				<% 	} else { %>
					<a class="subactionbutton" href="uncommit.jsp?contentID=<%= contentID %>&templateID=<%= templateID %>"><fmt:message key="tmp_column_action_btn_uncommit"/></a>
				<% 	}
					} else { %>
				&nbsp;
				<%	} %>
				...
				<% } %>
				<td class="listItem_Data<%=sClassAppend%>" align=center><a class="subactionbutton" href="pageedit.jsp?clone=true&contentID=<%= contentID %>&templateID=<%= templateID %>"><fmt:message key="tmp_column_action_btn_clone"/></a></td>
				<% } %>
			</tr>
			<%
		}

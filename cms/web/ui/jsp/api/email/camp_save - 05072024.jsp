...
System.out.println("SeedListStr : " + camp.m_SeedList.s_filter_name);
...
<%!
    private static Campaign saveCamp(Customer cust, User user, HttpServletRequest request, boolean bDoClone) throws Exception {
        ...
        System.out.println("camp.seed_list_id : " + camp.s_seed_list_id);
        ...
        camp.m_SeedList = seed_list;
        System.out.println("campm_SeedList aaaa: " + camp.m_SeedList.s_filter_name);

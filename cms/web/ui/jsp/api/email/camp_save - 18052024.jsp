...
<%
    ...
    System.out.println("0 - camp.s_camp_id : " + camp.s_camp_id);
    ...
    if (MODE.equals("send_pv_receipt")) {
        ...
        System.out.println("1 - camp.s_camp_id : " + camp.s_camp_id);
        ...
        if (camp.s_type_id.equals("5")) {  // non-email campaign
            ...
            System.out.println("2 - camp.s_camp_id : " + camp.s_camp_id);

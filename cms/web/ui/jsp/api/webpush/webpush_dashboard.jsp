...
<%
    ...
    try {
        ...
        List<Map.Entry<String, Integer>> countryList = new ArrayList<Map.Entry<String, Integer>>(countryData.entrySet());


// 2. count (value) değerine göre sıralama (büyükten küçüğe)
        Collections.sort(countryList, new Comparator<Map.Entry<String, Integer>>() {
            public int compare(Map.Entry<String, Integer> a, Map.Entry<String, Integer> b) {
                return b.getValue().compareTo(a.getValue());
            }
        });

// 3. Sıralı şekilde JsonArray'e ekle
        for (Map.Entry<String, Integer> entry : countryList) {
            JsonObject countryObject = new JsonObject();
            countryObject.put("country", entry.getKey());
            countryObject.put("count", entry.getValue());

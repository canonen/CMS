...
<%@ page import="com.britemoon.cps.que.Campaign" %>
<%@ page import="com.britemoon.cps.UIType" %>
...
<%
    ...
    try
    {
        cp_w = ConnectionPool.getInstance();
    ...
    {
        //logger.error(this, ex, "Error in " + this.getClass().getName(), out, 1);
        logger.error("Error in " + this.getClass().getName(), ex);
    }
    finally
    {
        try

...
<%
		...
		try {
            ...
            if(category != null){
                sSql = "EXEC usp_ccnt_list_get @type_id = 25, @CustomerId="+cust.s_cust_id+" , @category_id="+category;
            }else{
                sSql = "EXEC usp_ccnt_list_get @type_id = 25, @CustomerId="+cust.s_cust_id;
            }
			...
			while (resultSet.next()){
                ...
                //string
                lastUpdate = dateFormatter(resultSet.getString(6));
                statusId = resultSet.getInt(7);
                status = resultSet.getString(8);
                editor = resultSet.getString(9);
                //datetime
                Timestamp modify_dateTimestamp = resultSet.getTimestamp(10);
                if(modify_dateTimestamp != null) {
                    modifyDate =  modify_dateTimestamp.toLocalDateTime().format(DateTimeFormatter.ofPattern("yyyy-MM-dd HH:mm"));
                }

...
<form name="FT" method="post" action="link_scan_save_zafer.jsp">
...
<table width=650 class=listTable cellspacing=0 cellpadding=0>
	<tr>
		<th>&nbsp;<b class=sectionheader>Step 1:</b> Select and Name Links to Track For <%= contName %></th>
	</tr>
	...
	protected String scanForOneLink (String s) throws Exception
	{
		...
		while (true) {
			...
			if (j1 != -1 || j2 != -1 || j3 != -1 || j4 != -1 || j5 != -1 || j6 != -1)
			{
				...
				if(oneLink.indexOf("\n") != -1)
				{
					System.out.println("yes founddddddddddddddd");
				} else {

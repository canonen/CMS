...
JsonArray linkInfoArr= new JsonArray();
...
try
{
          ...
          if (bTextProcessed) {
               if (!bHtmlProcessed || !bImageProcessed) {
                    ...
                    if (sContentId == null) {
                        ...
                        /*linkInfo.put("sLoadId",sLoadId);
                        linkInfo.put("cont_id",sContentId);
                        linkInfo.put("sUseAnchorName",sUseAnchorName);
                        linkInfo.put("sUseLinkRenaming",sUseLinkRenaming);
                        linkInfo.put("sReplaceScannedLinks",sReplaceScannedLinks);
                        linkInfo.put("Message:","cont load saved successfully");

                        linkInfoArr.put(linkInfo);
                        out.print(linkInfoArr);*/
                    }
               }
     ...
     data.put("num_files",vSavedFiles.size());
     data.put("contentName",sContentName);
     data.put("SendTypes",sCharset);
     data.put("unsubID",sUnsubMsgId);
     data.put("unsubPos",sUnsubPos);
     data.put("cont_text_file",  bTextProcessed);
     data.put("cont_html_file", bHtmlProcessed);
     data.put("cont_image_file",bImageProcessed);

...
<%
  ...
  linkScanObj.put("sUseAnchorName", sUseAnchorName);
  linkScanObj.put("custID", custID);
  linkScanObj.put("sReplaceScannedLinks", sReplaceScannedLinks);
  linkScanObj.put("sUseLinkRenaming", sUseLinkRenaming);
  linkScanObj.put("sLoadId",sLoadId);

  JsonArray linkScanArr = new JsonArray();
  linkScanArr.put(linkScanObj);
  out.print(linkScanArr);
  ...
  ContBody cont_body = new ContBody(cont.s_cont_id);

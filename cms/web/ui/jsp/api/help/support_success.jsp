...
<%
	...
	s_user_name		= user.s_user_name + " " + user.s_last_name + " " + user.s_email;
	s_phone			= user.s_phone;
	//s_email_from	= user.s_email;
	s_email_from	= "bulten@e.revotas.com";
	...
	if (eRoot != null && !eRoot.getTagName().toUpperCase().equals("ERROR"))
	{
		...
		json.put("s_email_from", s_email_from);
		json.put("s_email_to", s_email_to);
		arr.put(json);
		out.print(arr);
	}
	else

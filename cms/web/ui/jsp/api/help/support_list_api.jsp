...
<%
	...
	try
	{
		...
		sSQL = " SELECT s.ticket_id, " +
				...
				"s.origin_ticket_id as origin_ticket , " +
		...
		while(resultSet.next())
		{
			...
			if(!resultSet.getString("origin_ticket").equals("0")) {
				continue;
			}
			sTicketId = resultSet.getString(1);
			sCustId = resultSet.getString(2);
			...
			sSubject = (resultSet.getString(10) != null) ? new String(resultSet.getString(10).getBytes("WINDOWS-1252"), StandardCharsets.ISO_8859_1) : "null";
			...
			sCreateDate = (resultSet.getString("create_date") != null) ? resultSet.getString("create_date") : "null";
			sModifyDate = (resultSet.getString("modify_date") != null) ? resultSet.getString("modify_date") : "null";
			...
			json.put("origin_ticket",resultSet.getString("origin_ticket"));
			json.put("category", resultSet.getString("category") == null ? "" : resultSet.getString("category"));
			json.put("first_response_date", resultSet.getString("first_response_date") == null ? "" : resultSet.getString("first_response_date"));
			arr.put(json);
		}
		out.print(arr);

...
<table cellspacing="0" cellpadding="0" align="center" width="600">
    <tr>
        <td align="center" style="font-size:16px; font-family: Verdana,Arial,Tahoma;"><a
                href="<%response.sendRedirect(request.getContextPath()+"/ui/jsp/report/ProductDashBoard.jsp");%>">onceki
            sayfaya don </a></td>
    </tr>
</table>
<%

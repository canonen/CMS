...
//KU: Added for content logic ui
	...
	jsonObject.put("type_id", FilterType.READ_X_MESSAGES_DURING_TIME_INTERVAL);

    if("=".equals(sMainCountCompareOperation)){
        jsonObject.put("mainCompareOperation","=");
        jsonObject.put("mainCompareOperationValue","Exactly (=)");
    }
    if(">".equals(sMainCountCompareOperation)){
        jsonObject.put("mainCompareOperation",">");
        jsonObject.put("mainCompareOperationValue","More Than (>)");
    }
    if(">=".equals(sMainCountCompareOperation)){
        jsonObject.put("mainCompareOperation",">=");
        jsonObject.put("mainCompareOperationValue","More Than Or Exactly (>=)");
    }
    if("<".equals(sMainCountCompareOperation)){
        jsonObject.put("mainCompareOperation","<");
        jsonObject.put("mainCompareOperationValue","Fewer Than (<");
    }
    if("<=".equals(sMainCountCompareOperation)){
        jsonObject.put("mainCompareOperation","<=");
        jsonObject.put("mainCompareOperationValue","Fewer Than Or Exactly (<=)");
    }

    jsonObject.put("main_count", HtmlUtil.escape(sMainCount));
	jsonObject.put("link_count", HtmlUtil.escape(sMainCount));
	jsonObject.put("date_diff",(("date_diff".equals(sMode))?" checked":""));
	jsonObject.put("diff_date", HtmlUtil.escape(sDiffDate));
    if("=".equals(sDayCountCompareOperation)){
        jsonObject.put("sDayCountCompareOperation","=");
        jsonObject.put("sDayCountCompareOperationValue","Equal To (=)");
    }
    else if(">".equals(sDayCountCompareOperation)){
        jsonObject.put("sDayCountCompareOperation",">");
        jsonObject.put("sDayCountCompareOperationValue","Greater Than (>)");
    }
    else if(">=".equals(sDayCountCompareOperation)){
        jsonObject.put("sDayCountCompareOperation",">=");
        jsonObject.put("sDayCountCompareOperationValue","Greater Than Or Equal To (>=)");
    }
    else if("<".equals(sDayCountCompareOperation)){
        jsonObject.put("sDayCountCompareOperation","<");
        jsonObject.put("sDayCountCompareOperationValue","Less Than (<)");
    }
    else if("<=".equals(sDayCountCompareOperation)){
        jsonObject.put("sDayCountCompareOperation","<=");
        jsonObject.put("sDayCountCompareOperationValue","Less Than Or Equal To (<=)");
    }
	jsonObject.put("day_count", HtmlUtil.escape(sDayCount));

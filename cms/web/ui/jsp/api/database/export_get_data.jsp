  ...
  if(logger == null)
    ...
    try {
        ...
        while(resultSet.next()){
            ...
            campObject.put("camp_name", new String(resultSet.getBytes("camp_name"), StandardCharsets.UTF_8));
        ...
        while(resultSet.next()){
            ...
            filterObject.put("filter_name", new String(resultSet.getBytes("filter_name"), StandardCharsets.UTF_8));
       ...
       jsonArray = new JsonArray();
         while(resultSet.next()){
              ...
              batchObject.put("batch_name", new String(resultSet.getBytes("batch_name"), StandardCharsets.UTF_8));
              jsonArray.put(batchObject);
        }
        jsonObject.put("BatchArray",jsonArray);
        resultSet.close();

        String linkQuery = "SELECT DISTINCT link_id, link_name  , c.camp_name FROM cjtk_link l, cque_campaign c "+
        ...
        while(resultSet.next()){
            ...
            linkObject.put("link_name", new String(resultSet.getBytes("link_name"), StandardCharsets.UTF_8));
            linkObject.put("camp_name", new String(resultSet.getBytes("camp_name"), StandardCharsets.UTF_8));
        ...
        while(resultSet.next()){
            ...
            retriveObject.put("display_name", new String(resultSet.getBytes("display_name"), StandardCharsets.UTF_8));

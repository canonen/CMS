...
<table width="500" class="listTable" cellspacing="0" cellpadding="0">
	<tr>
		<th class="sectionheader">&nbsp;<b class="sectionheader">Step 1:</b> Contact Information</th>
	</tr>
	<tbody class="EditBlock" id="block1_Step1">
	<tr>
		<td class="" valign="top" align="center" width="500">
...
<table width="500" class="listTable" cellspacing="0" cellpadding="0">
	<tr>
		<th class="sectionheader">&nbsp;<b class="sectionheader">Step 2:</b> Login Information</th>
	</tr>
...
<table width="500" class="listTable" cellspacing="0" cellpadding="0">
	<tr>
		<th class="sectionheader">&nbsp;<b class="sectionheader">Step 3:</b> Interface Settings</th>
	</tr>
	<tbody class="EditBlock" id="block3_Step1">
	<tr>
		<td class="" valign="top" align="center" width="500">
			<table class="" cellspacing="1" cellpadding="2" width="100%"<%=(nUIType != UIType.ADVANCED && nUIType != UIType.HYATT_ADMIN)?" style=\"display: none\"":""%>>
				<tr>
...
<table width="500" class="listTable" cellspacing="0" cellpadding="0">
	<tr>
		<th class="sectionheader">&nbsp;<b class="sectionheader">Step 4:</b> Recipient Ownership</th>
	</tr>
...
<table width="500" class="listTable" cellspacing="0" cellpadding="0">
	<tr>
		<th class="sectionheader">&nbsp;<b class="sectionheader">Step 4:</b> PV Login Settings</th>
	</tr>

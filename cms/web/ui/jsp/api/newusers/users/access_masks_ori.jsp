...
<table cellspacing="0" cellpadding="4" border="0">
    <tr>
        ...
        %>
        <td align="left" valign="middle">
            User Edit: <a class="subactionbutton"
                          href="user_edit.jsp?<%=(sUserId==null)?"":"user_id=" + sUserId %>"><b><%= (sUserId == null) ? "New" : u.s_user_name %>
        </b></a>
        </td>
        <%
            }
...
<FORM method="POST" action="access_masks_save.jsp" name="access_masks">
    ...
    <table width="500" class="main" cellspacing="0" cellpadding="0">
        <tr>
            <td class="sectionheader">&nbsp;<b class="sectionheader">Step 1:</b> User Access Levels
                for <%= (sUserId == null) ? "New User" : u.s_user_name %>
            </td>
        </tr>
    </table>
    <br>
    ...
    <table id="Tabs_Table1" cellspacing="0" cellpadding="0" width="500" border="0">
        <tr>
            <td class="EmptyTab" valign="center" nowrap align="middle" width="500"><img height=2
                                                                                        src="../../images/blank.gif"
                                                                                        width=1></td>
        </tr>
        <tr>
            <td class="fillTabbuffer" valign="top" align="left" width="500"><img height=2 src="../../images/blank.gif"
                                                                                 width=1></td>
        </tr>
            ...
            <td class="fillTab" valign="top" align="center" width="500">
                <table class="main" border="0" cellspacing="1" cellpadding="2" width="100%">
                    ...
                    <tr>
                        ...
                        <td align="center" valign="middle" nowrap><INPUT type="checkbox"
                                                                         name=<%=sTypeId%> value=<%=AccessRight.READ%> <%=((AccessRight.READ & iMask) == AccessRight.READ)?"checked":""%>>
                        </td>
                        <td align="center" valign="middle" nowrap><INPUT type="checkbox"
                                                                         name=<%=sTypeId%> value=<%=AccessRight.WRITE%> <%=((AccessRight.WRITE & iMask) == AccessRight.WRITE)?"checked":""%>>
                        </td>
                        <td align="center" valign="middle" nowrap><INPUT type="checkbox"
                                                                         name=<%=sTypeId%> value=<%=AccessRight.EXECUTE%> <%=((AccessRight.EXECUTE & iMask) == AccessRight.EXECUTE)?"checked":""%>>
                        </td>
                        <td align="center" valign="middle" nowrap><INPUT type="checkbox"
                                                                         name=<%=sTypeId%> value=<%=AccessRight.DELETE%> <%=((AccessRight.DELETE & iMask) == AccessRight.DELETE)?"checked":""%>>
                        </td>
                        <td align="center" valign="middle" nowrap><INPUT type="checkbox"
                                                                         name=<%=sTypeId%> value=<%=AccessRight.APPROVE%> <%=((AccessRight.APPROVE & iMask) == AccessRight.APPROVE)?"checked":""%>>
                        </td>
                    </tr>
                    <%
                            }

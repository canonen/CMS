...
<%
    ...
    Map<String,Integer> qtyProduct1 = new HashMap<String,Integer>();
    qtyProduct1.put("asfa",232);
    System.out.println(qtyProduct1.get("asfa"));
    ...
    lastWeek = new SimpleDateFormat("yyyy-MM-dd").format(lastWeekNotFormat);

    String today = currentYear + "-" + currentMonthCal + "-" + currentDay;
    String firstDate = lastWeek;
    ...
    try {
        ...
        Map<String,Double> qtyProductMap = new HashMap<String,Double>();
        ...
        if(nodeList !=null) {
            for (int i = 0; i < nodeList.getLength(); i++) {
                ...
                qtyProductMap.put(productId,qtyProductMap.getOrDefault(productId, 0.0) + qty);
        ...
        for (Map.Entry<String, Double> entry : qtyProductMap.entrySet()) {
            String productId = entry.getKey();
            Double qty = entry.getValue();
            JsonObject qtyJson = new JsonObject();
            qtyJson.put("productId", productId);
            qtyJson.put("qtyTotal", qty);
            resultsArray.put(qtyJson);

        }

        JsonObject result = new JsonObject();
        result.put("data", data);
        result.put("group_data", resultsArray);

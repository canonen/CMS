...
<%
    ...
    jsonObject.put("type_id", a.s_type_id);
    ...
    jsonObject.put("value_qty", (a.s_value_qty == null) ? "" : "1");
    jsonObject.put("fingerprint_seq", (ca.s_fingerprint_seq == null) ? "" : "1");
    jsonObject.put("newsletter_flag", (ca.s_newsletter_flag != null) ? ca.s_newsletter_flag : "1");
    jsonObject.put("ns1", (ca.s_newsletter_flag == null || "1".equals(ca.s_newsletter_flag)) ? "on" : "");
    jsonObject.put("ns2", (ca.s_newsletter_flag != null && "Y".equals(ca.s_newsletter_flag)) ? "on" : "");
    jsonObject.put("sync_flag", (ca.s_sync_flag == null || ca.s_sync_flag.equals("0")) ? "" : "1");
    jsonObject.put("hist_flag", (ca.s_hist_flag == null || ca.s_hist_flag.equals("0")) ? "" : "1");

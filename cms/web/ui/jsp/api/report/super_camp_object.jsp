...
<table width=650 class=listTable cellspacing=0 cellpadding=0>
	<tr>
		<th class=sectionheader>&nbsp;<b class=sectionheader>Super Campaign:</b> General Information</th>
	</tr>
...
<table width=650 class=listTable cellspacing=0 cellpadding=0>
	<tr>
		<th class=sectionheader>&nbsp;<b class=sectionheader>Super Campaign:</b> Campaigns</th>
	</tr>
	<tbody class=EditBlock id=block2_Step1>
	<tr>
		<td valign=top align=center width=650>
			<table class=table-soft cellspacing=0 cellpadding=2 width="100%">
				<tr>
...
<table width=650 class=listTable cellspacing=0 cellpadding=0>
	<tr>
		<th class=sectionheader width="100%">&nbsp;<b class=sectionheader>Super Campaign:</b> Links</th>

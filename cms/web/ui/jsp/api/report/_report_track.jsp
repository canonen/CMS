...
<%
    ...
    try {
        ...
        if ((sCampID != null)) {
            ...
            System.out.println("REPORT NAME BURADA11 :"+reportName);
            rs.close();
        }
        ...
        if ((sCampID == null) || ("".equals(sCampID)) || (numRecs < 1)) {
            ...
            System.out.println("SCAMP_İD11 +"+mbsRevenueReport.s_camp_id);
            if (mbsRevenueReport.retrieve() > 0) {
                displayPurchOnChart = true;
                System.out.println("DİSPLAYPURCHONCHART İÇİNDEYİM...");

                Service service = null;
                Vector services = Services.getByCust(ServiceType.RRCP_RECIP_VIEW, cust.s_cust_id);
                service = (Service) services.get(0);
                sMbsReportDetailsUrl =
                        "http://" + service.getURL().getHost() + "/rrcp/imc/rpt/mbs_revenue_report_details_api.jsp" +
            ...
            System.out.println("DİSPLAYPURCHHHHHH ::"+displayPurchOnChart);
            //	<!-- Revenue Report End -->
            ...
            if (DURUM) {
                ...
                jsonObject.put("reportName", reportName);
                System.out.println("REPORT NAME BURADA22 :"+reportName);
                System.out.println("S_TOTAL ::"+HtmlUtil.escape(mbsRevenueReport.s_total));
                System.out.println("TOTALLLL2222222222222 :: "+mbsRevenueReport.s_total);
                if (displayPurchOnChart) {
                    jsonObject.put("tReceived", tReceived);
                    jsonObject.put("tRead", tRead);
                    jsonObject.put("tClicks", tClicks);
                    jsonObject.put("clickPerct", clickPerct + 0.1);
                    jsonObject.put("customers", mbsRevenueReport.s_purchasers);
                    jsonObject.put("s_delivered",  mbsRevenueReport.s_delivered);
                    jsonObject.put("revenue",mbsRevenueReport.s_total);
                    jsonObject.put("orders",mbsRevenueReport.s_purchases);
                }
            }

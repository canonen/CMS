...
{
	String campID = st.nextToken();
    swXML.write("<camp_report>");
    swXML.write("<camp_id>" + campID + "</camp_id>");
    swXML.write("<cust_id>" + cust.s_cust_id + "</cust_id>");
    swXML.write("</camp_report>");

     jsonObject.put("camp_report",swXML);
...
while (st2.hasMoreTokens())
{
	String sSql =
		...
		", @status_id = " + ReportStatus.QUEUED;
         ...
         jsonObject.put("camp_id",sCampID);
	     jsonObject.put("cust_id", cust.s_cust_id);
         jsonObject.put("@status_id",cust.s_status_id);
         //JsonArray.put(jsonObject);
	 //jsonObject = new JsonObject();     
}

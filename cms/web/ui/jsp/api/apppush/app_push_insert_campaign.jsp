...
<%
    ...
    String push_type = request.getParameter("push_type");
    ...
    try {
        ...
        appPushCampaignSql = "INSERT INTO cque_app_push_campaign (cust_id,type_id,status_id,camp_name,filter_id,camp_code,approval_flag,camp_temp_type,title,img,url,msg,icon,personalize,topic,push_type) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
...
//        ps.executeUpdate();
        ...
        data.put("camp_id" , currentCampaignId);
        rs.close();
        ps.close();

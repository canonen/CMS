...
// Connection
	...
	try
	{
		...
		while ( rs.next() )
		{
			...
			data.put("iEmailTypeId",iEmailTypeId [nEmailType]);
			data.put("sEmailType", sEmailType [nEmailType]);
			nEmailType ++;
			array.put(data);
		}
		rs.close();
		...
		while ( rs.next() )
		{
			...
			data.put("iRecipStatusId",iRecipStatusId [nEmailType]);
			data.put("sRecipStatus", sRecipStatus [nEmailType]);
			nRecipStatus ++;
			array.put(data);
		}
		rs.close();
...
//	out.println(data.toString());
		...
		if (nTotReturned > 0)
		{
			...
			for (i=0 ; i < nEmailType ; i ++)
			{
				...
				data1.put("iEmailTypeId ",iEmailTypeId [i]);
				data1.put("sEmailType",sEmailType [i]);

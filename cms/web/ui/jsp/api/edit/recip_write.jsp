...
// Connection
    ...
    try	{
        ...
        swXML.write("<cust_id>"+custId+"</cust_id>\r\n");
        if (sBatchID != null)
        ...
        rs = stmt.executeQuery ("SELECT c.attr_id FROM ccps_attribute a, ccps_cust_attr c"
                + " WHERE a.attr_id = c.attr_id AND c.cust_id = " + custId
...
//System.out.print(swXML.toString());
        String sMsg = Service.communicate(ServiceType.RUPD_MANUAL_IMPORT_SETUP, custId, swXML.toString());

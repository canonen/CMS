...
<%
	...
	try {
		...
		while (rs.next()) {
			...
			nextConfiguration.setModifyDate(modifyDate);
			nextConfiguration.setCreateDate(createDate);
		...
		for (Map.Entry<String, SmartConfiguration> entry : map.entrySet()) {
			...
			System.out.println("config23.getPopupId(): " + config23.getPopupId());
			...
			click = config23.getClick();
			submit = config23.getSubmit();

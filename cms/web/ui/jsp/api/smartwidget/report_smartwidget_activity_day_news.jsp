...
<%
    try {
        ...
        Date dateFirst = obj.parse(firstDate);
        Date dateLast = obj.parse(lastDate);


        long days_difference=((dateLast.getTime())-(dateFirst.getTime())% 365);
        ...
        out.println(array);
        out.println("days: "+days_difference);

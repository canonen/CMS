...
//			createDate = rs.getString("createDate");
		...
		for (Map.Entry<String, SmartConfiguration> entry : map.entrySet()) {
			...
			data.put("clickBetweenDate", config23.getClickBetweenDate());
			data.put("submitBetweenDate", config23.getSubmitBetweenDate());
			data.put("viewBetweenDate", config23.getViewBetweenDate());

    ...
    try {
        ...
        String ultraQuery =
                "SET NOCOUNT ON; " +
                        ...
                        "        MAX(CAST(a.type_name AS VARCHAR(10))) AS type_name, " +
                        ...
                        "        MAX(CAST(ISNULL(c.popup_name, '') AS VARCHAR(200))) AS popup_name, " +
                        "        MAX(c.config_param)   AS config_param, " +
                        "        MAX(c.create_date)    AS create_date, " +
                        "        MAX(c.modify_date)    AS modify_date, " +
...
//                    break;
        ...
        dbUtil.closeResources(rs, stmt, conn, cp);
    }

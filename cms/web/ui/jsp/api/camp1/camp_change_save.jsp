...
// CampSendParam object (table)
	try{
		...
		if(sLimitPerHour == null || sLimitPerHour.equals("NaN")) sLimitPerHour = "0";
...
// and setup will be done regular way by CampSetupTimer after campaign is queued
		...
		logger.error("Error in camp_change_save.jsp", ex);
		out.println("Error in camp_change_save.jsp: " + ex.getMessage());
		throw ex;
	}
%>

...
<form name="subscriptionObject" method="post" action="form_save.jsp">
    ...
    <table cellspacing="0" cellpadding="4" border="0">
        <tr>
            <td align="left" valign="middle">
                <a class="savebutton" href="#"
                   onClick="document.all.ActionSave.value='1'; document.subscriptionObject.action='form_save.jsp'; document.subscriptionObject.target='_self';document.subscriptionObject.submit();">Save</a>&nbsp;
            </td>
            <td align="left" valign="middle">
                <a class="savebutton" href="#"
                   onClick="document.all.ActionSave.value='2'; document.subscriptionObject.action='form_save.jsp'; document.subscriptionObject.target='_self';document.subscriptionObject.submit();">Clone</a>
            </td>
            <!--
            <td align="left" valign="middle">
    ...
    <table id="Tabs_Table1" cellspacing=0 cellpadding=0 width=95% border=0>
        <tr>
            <td class=EmptyTab valign=center nowrap align=middle width=100%><img height=2 src="../../images/blank.gif"
                                                                                 width=1></td>
        </tr>
        <tr>
            <td class=fillTabbuffer valign=top align=left width=100%><img height=2 src="../../images/blank.gif" width=1>
            </td>
        </tr>
    ...
    <table id="Tabs_Table2" cellspacing=0 cellpadding=0 width=95% border=0>
        <tr>
            <td class=EditTabOn id=tab2_Step1 width=150
                onclick="switchSteps('Tabs_Table2', 'tab2_Step1', 'block2_Step1');" valign=center nowrap align=middle>
                Basic Options
            </td>
            <td class=EditTabOff id=tab2_Step2 width=150
                onclick="switchSteps('Tabs_Table2', 'tab2_Step2', 'block2_Step2');" valign=center nowrap align=middle>
                Advanced Options
            </td>
            <td class=EditTabOff id=tab2_Step3 width=150
                onclick="switchSteps('Tabs_Table2', 'tab2_Step3', 'block2_Step3');" valign=center nowrap align=middle>
                Elements Template
            </td>
            <td class=EmptyTab valign=center nowrap align=middle width=100%><img height=2 src="../../images/blank.gif"
                                                                                 width=1></td>
        ...
        <tr>
            <td class=fillTabbuffer valign=top align=left width=100% colspan=4><img height=2
                    ...
                    <tr>
                        ...
                        <td>
                            <select name="prefill_no_validate_flag">
                                ...
                                <option value="0" <%= prefillNoValidateFlag.equals("0") ? "selected" : "" %>>Yes
                                </option>
                            </select>
                        </td>
                    </tr>
        ...
        <tr>
            <td class=fillTab valign=top align=left width=100% colspan=4>
                <table class="main" cellpadding="2" cellspacing="1">
                    <tr>
                        <td><b>Custom Field: </b><input type="text" width="100%" name="MacroName" size="27"
                    ...
                    <tr valign="top">
                        ...
                        <td valign="top" align="left">
                            <textarea name="XSLElement" rows="6" cols="100"
                                      style="width: 100%; height: 23mm"></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td align="right"></td>
                        <td align="right"><input type="button" class="subactionbutton" name="btnSelect"
                                                 value="Select All" onClick="document.all.XSLElement.select();"/></td>
                    </tr>
                </table>
            </td>
        </tr>
    ...
    <table id="Tabs_Table3" cellspacing=0 cellpadding=0 width=95% border=0>
        <tr>
            <td class=EditTabOn id=tab3_Step1 width=150
                onclick="switchSteps('Tabs_Table3', 'tab3_Step1', 'block3_Step1');" valign=middle nowrap align=center>
                Enter XSL
            </td>
            <td class=EditTabOff id=tab3_Step2 width=150
                onclick="switchSteps('Tabs_Table3', 'tab3_Step2', 'block3_Step2');" valign=middle nowrap align=center>
                XSL Builder
            </td>
            <td class=EmptyTab valign=center nowrap align=middle width=350><img height=2 src="../../images/blank.gif"
                                                                                width=1></td>
        </tr>
        <tr>
            <td class=fillTabbuffer valign=top align=left width=100% colspan=3><img height=2
                                                                                    src="../../images/blank.gif"
                                                                                    width=1></td>
        </tr>
        ...
        <tr>
            <td class=fillTab valign=top align=left width=100% height=350 colspan=3>
                <table width="100%" class="main" cellpadding="2" cellspacing="1">
                    <tr>
                        <td colspan="2">
                            <textarea name="form_source" rows="20" cols="100"
                                      style="width:100%;"><%= HtmlUtil.escape(formSource) %></textarea>
                        </td>
                    </tr>
                    <tr>
                        <td align="right"><input type="button" class="subactionbutton" name="btnSelect"
                                                 value="Select All" onClick="document.all.form_source.select();"/></td>
                        <td align="left"><input type="button" class="subactionbutton" name="btnPreview" value="Preview"
                                                onClick="POpen()"/></td>
                    </tr>
                </table>
            </td>
                ...
                <table class="main" cellpadding="2" cellspacing="1">
                    <tr valign="middle">
                        ...
                        <td width="20%" valign="middle" align="center">
                            <input type="button" class="subactionbutton" name="AddR" value="Add Required >>"
                                   style="width: 90%"
                                   onClick="moveList(document.subscriptionObject.elements['AllFields'].selectedIndex, 'Yes', 0)"/><br/>
                            <input type="button" class="subactionbutton" name="AddN" value="Add Non Required >>"
                                   style="width: 90%"
                                   onClick="moveList(document.subscriptionObject.elements['AllFields'].selectedIndex, 'No', 0)"/>
                        </td>
                        <td width="40%" valign="middle" align="center">
                    ...
                    <tr>
                        ...
                        <td width="20%" align="center"><input type="button" class="subactionbutton" name="btnCreate"
                                                              value="Create XSL" onClick="GenerateForm();"/></td>
                        <td width="40%" align="right">
                            <input type="button" class="subactionbutton" name="btnDelete" value="Delete"
                                   style="width: 10mm"
                                   onClick="moveList(document.subscriptionObject.elements['SelectedFields'].selectedIndex, '', 1);"/>
                            <input type="button" class="subactionbutton" name="btnUp" value="Up" style="width: 10mm"
                                   onClick="shiftList(document.subscriptionObject.elements['SelectedFields'].selectedIndex, 0);"/>
                            <input type="button" class="subactionbutton" name="btnDown" value="Down" style="width: 10mm"
                                   onClick="shiftList(document.subscriptionObject.elements['SelectedFields'].selectedIndex, 1);"/>
                        </td>
                    </tr>
                </table>
            </td>
    ...
    <table class="main" cellpadding="2" cellspacing="1" width="95%">
        <tr>
            ...
            <td width="30%"><u><%= creator %>
            </u></td>
            <td width="20%">Modified by</td>
            <td width="30%"><u><%= modifier %>
            </u></td>
        </tr>
        <tr>
            <td width="20%">Creation date</td>
            <td width="30%"><u><%= createDate %>
            </u></td>
            <td width="20%">Modify date</td>
            <td width="30%"><u><%= modifyDate %>
            </u></td>
        </tr>
    </table>
    <br/><br/>

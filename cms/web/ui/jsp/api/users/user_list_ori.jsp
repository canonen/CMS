...
<div class="page_desc">Manage users on Revotas.</div>
<div id="info">
<div id="xsnazzy">
...
%>
						...
						<TD noWrap align=right style="padding-right:10px;">
							<A class="newbutton" href="user_list.jsp"><img src="../../../images/refresh.png" align="absmiddle">&nbsp;Refresh</A>
						</TD>
					</TR>
				</TBODY>
			</TABLE>
			...
			<table class="list_table" id="example" width="100%" cellpadding="2" cellspacing="0">
				<thead>
					...
					<th width="10%"  valign="middle" nowrap>Phone</th>
					<th width="80%" valign="middle" nowrap>Email</th>
				</thead>
				<tbody>

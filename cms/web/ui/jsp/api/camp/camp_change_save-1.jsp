...
boolean bResponseFrwdAddrChanged = sResponseFrwdAddr == null ? false : !sResponseFrwdAddr.equals(csp.s_response_frwd_addr);
...
try {
	System.out.println("Inside the 4th try block.");
	conn = cp.getConnection(this);
	stmt = conn.createStatement();

...
<%!
    ...
    boolean childControlFlag = false;
    ...
    public com.britemoon.cps.tgt.Filter createRecursiveFilter (String filterId) {
        ...
        try {
            ...
            if(firstTimeFlag){
                ...
                if(getParentId(filterId).equals(mainFilterId)){
                    System.out.println("LfilterParts : " + LfilterParts.toXml());
                    finalFilterParts.add(LfilterPart);
                }
                if(getParentId(filterId).equals("")){
                    ArrayList<String> filterIdList = new ArrayList();
                    filterIdList = findAllChildFilterId(mainFilterId);

                    for(String val : filterIdList){
                        if(!val.equals(mainFilterId)){
                            if(childControlBool(val)){ // eger child id'si var ise group var demektir. child var ise true doner
                                childControlFlag = true;
                    ...
                    if(childControlFlag){
                        ...
                        finalFilter.m_FilterParts = LfilterParts;
                    }
/*                    if(filterIdList.size()<=3){
                        finalFilter.m_FilterParts = LfilterParts;
                    }else{
                        finalFilter.m_FilterParts = finalFilterParts;
                    }*/
    ...
    public void init (){
        ...
        finalFilter = new com.britemoon.cps.tgt.Filter();;
        RecursiveParentFilter = new com.britemoon.cps.tgt.Filter();
        ArrayList<String> filterIdList = new ArrayList();
        String ListFilterId = null;
        String mainFilterId = null;
        String localFilterId = null;
        ...
        childControlFlag = false;

    }
    public boolean childControlBool (String filterId){
        ConnectionPool cp4 = null;
        Connection conn4 = null;
        Statement stmt4 = null;
        ResultSet rs4 = null;

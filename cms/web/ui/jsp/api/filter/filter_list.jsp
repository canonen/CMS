...
<%
    ...
    jsonObject.put("sSelectedCategoryId", (sSelectedCategoryId!=null)?sSelectedCategoryId:"");
    
    boolean bIsPrintEnabled = CustFeature.exists(cust.s_cust_id, Feature.PRINT_ENABLED);
    if (bIsPrintEnabled) {
        jsonObject.put("bIsPrintEnabled", bIsPrintEnabled);
    }
    if (canTGPreview) {
        jsonObject.put("canTGPreview", canTGPreview);
    }
    ...
    try {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                filterJsonObject.put("filterCount", filterCount);
                filterJsonObject.put("sClassAppend", sClassAppend);
                filterJsonObject.put("sFilterId", sFilterId);
                filterJsonObject.put("sFilterName", sFilterName);
                filterJsonObject.put("sFinishDate", (sFinishDate == null) ? "" : sFinishDate);            
                filterJsonObject.put("sRecipQty", (sRecipQty == null) ? "&nbsp;" : sRecipQty);
                if (bIsPrintEnabled) {
                filterJsonObject.put("sPrintRecipQty", (sPrintRecipQty == null) ? "&nbsp;" : sPrintRecipQty);
                }
                filterJsonObject.put("iStatusId", iStatusId);
                filterJsonObject.put("sStatusName", sStatusName);
                filterJsonObject.put("sAprvlStatusFlag", sAprvlStatusFlag);

                filterJsonArray.put(filterJsonObject);
            }
            jsonObject.put("filter", filterJsonArray);

            System.out.println("sFinishDate: " + sFinishDate);

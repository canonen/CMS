...
//*************** Alinan JSON'in XML e cevrildigi kisim **********************************
    ...
    String sFilterXml = BriteRequest.getParameter(request, "filter_xml"); // json string olarak alir
...
//****************************************************************************************
    ...
    out.println("Gelen Request : " + requestData);

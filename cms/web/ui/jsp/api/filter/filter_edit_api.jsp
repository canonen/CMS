...
<%
	...
	try {
		...
		jsonNode = xmlMapper.readTree(sFilterXml);
		sFilterXml = jsonNode.toString();
	} catch (Exception e) {
		logger.error("Error while converting filter XML to JSON: ", e);
		System.out.println("Error while converting filter XML to JSON: " + e.getMessage());
		throw e;
	}

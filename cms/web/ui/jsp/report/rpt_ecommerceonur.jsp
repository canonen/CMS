...
try{
	...
	if(request.getParameter("date1")==null) {
		SQL=   	" SELECT MAX(CONVERT(VARCHAR(10),DATEADD (day, -1,mbs.date), 111)) FROM untt_mbs_order_date as mbs WHERE cust_id = " +sCustId;
		...
		//	date1=rs.getString(1);
			...
			calendarLast7Day.add(Calendar.DATE, -7);
			date1 = dateFormat.format(calendarLast7Day.getTime());

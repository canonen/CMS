	...
	<tr>
		<td class="fillTab" valign="top" align="left" colspan="6">
			...
			while( rs.next() )
			{
				...
				%>
				<tr>
					<td align="left" width="20" class="list_row<%= sClassAppend %>"><a href="report_object.jsp?act=VIEW&id=<%= sCampID %>&Z=1&C=<%= sCacheID %>" class="subactionbutton">View</a></td>
					<td align="left" width="40" class="list_row<%= sClassAppend %>" nowrap><input type="checkbox" name="CCheck" value="<%= sCacheID %>"></td>
					<td align="left" width="50" class="list_row<%= sClassAppend %>" nowrap><%= sStartDate %></td>
					<td align="left" width="50" class="list_row<%= sClassAppend %>" nowrap><%= sEndDate %></td>
					<td align="left" class="list_row<%= sClassAppend %>" nowrap><%= sCriteria %></td>
					<td align="left" width="50" class="list_row<%= sClassAppend %>" nowrap><%= sUserID %></td>
					<td align="left" width="40" class="list_row<%= sClassAppend %>" nowrap>
					<% if (canUpdate) { %>
					...
					<td align="left" width="50" class="list_row<%= sClassAppend %>" nowrap><%= sLastUpdateDate %></td>
					<td align="left" width="50" class="list_row<%= sClassAppend %>" nowrap><%= sLastStatus %></td>
					<td align="left" width="20" class="list_row<%= sClassAppend %>">
					<% if (canUpdate) { %>
			...
			if (iCount == 0)
			{
				%>
				<tr>
					<td class="list_row" colspan="6">There are currently no Demographic or Time Reports.</td>
				</tr>
				<%
			}
			rs.close();

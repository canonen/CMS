    ...
    try {
        ...
        if(nodeList !=null) {
            ...
            for (int i = 0; i < nodeList.getLength(); i++) {
                ...
                jsonObject.put("totalQty", qty);
                jsonObject.put("totalAmt", sumAmt);
                jsonObject.put("avgAmt", avgAmt);
                jsonObject.put("avgQty", avgQty);
...
<section class="content-header">
    <div class="box box-solid">
        <div class="box-header with-border">
            <div class="col-md-6"><h3>PRODUCT | PERFORMANCE</h3></div>
            <div class="col-md-6">
...
<section class="content" style="margin-left:20px;margin-right:20px;">
    ...
    <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number" id="total_qty"><%=totalQty%></span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box ">
                ...
                <div class="info-box-content ">
                    ...
                    <span class="info-box-number" id="total_amt"><%=totalAmt%></span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
                <span class="info-box-icon b_mavi"><i class="glyphicon glyphicon-stats  c_beyaz"></i></span>

                <div class="info-box-content">
                    <span class="info-box-text">AVG Quantity</span>
                    <span class="info-box-number"><%=totalAvgQtyDom%></span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
                <span class="info-box-icon b_pembe"><i class="fa fa-area-chart"></i></span>

                <div class="info-box-content">
                    <span class="info-box-text">AVG Amount</span>
                    <span class="info-box-number" id="total_avg_amt"><%=totalAvgAmt%></span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
...
<script>
    ...
    fetch('https://'+rcpLink+'/rrcp/imc/currency/get_currency_config.jsp?cust_id=<%=sCustId%>')
        ...
        .then(async resp => {
            ...
            var totalAmtDom = document.getElementById('total_amt')
            totalAmtDom.innerText = formatCurrency(totalAmt,currencyConfigs.filter(config=>config.active==1)[0]);
            var totalAvgvAmt = <%=totalAvgAmt%>
            var totalAvgAmtDom = document.getElementById('total_avg_amt')
            totalAvgAmtDom.innerText = formatCurrency(totalAvgvAmt,currencyConfigs.filter(config=>config.active==1)[0]);
            ...
            resultList.forEach((item) => {
                ...
                newEntry.innerHTML =
                    ...
                    '<td>' + item.totalQty + '</td>' +
                    '<td>' + formatCurrency(item.totalAmt, currencyConfigs.filter(config => config.active == 1)[0]) + '</td>' +
                    '<td>' + formatCurrency(item.avgAmt, currencyConfigs.filter(config => config.active == 1)[0]) + '</td>' +
                    '<td>' + item.avgQty + '</td>' +
    ...
    $('#daterange-btn').daterangepicker(
        ...
        function (start, end) {
            ...
            location.href = "product_performance.jsp?date1=" + date1 + "&date2=" + date2;
            /* $.ajax({
                 type: "GET",
                 url: "product_performance.jsp?date1=" + date1 + "&date2=" + date2",

...
<body onload="SubmitPrepare(2)">
<form name="FT" method="post" target="preview" action="cont_preview_2-sinan.jsp">
...
<table width="100%" class="lisTable" cellspacing="0" cellpadding="0">
	<tr>
		<th class="sectionheader">&#x20;<b class="sectionheader"></b> Heatmap</th>
	</tr>
</table>
<br/>


<p>Content Name = <%= contName %></p>

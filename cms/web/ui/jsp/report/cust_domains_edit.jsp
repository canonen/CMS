...
%>
	<tr>
		...
		<td class="list_row<%= sClassAppend %>"><INPUT type="text" size="50" name="domain<%=i%>" value="<%=cd.s_domain%>"></td>
	</tr>
<%
	}
...
%>
	<tr>
		...
		<td class="list_row<%= sClassAppend %>"><INPUT type="text" size="50" name="domain<%=i+1%>" value=""></td>
	</tr>
<%	
	}
%>

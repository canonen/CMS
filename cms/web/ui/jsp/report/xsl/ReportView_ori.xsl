...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
	...
	<xsl:template match="/">
		...
		<head>
			...
			<link rel="stylesheet" media="all" type="text/css" href="http://cms.revotas.com/cms/ui/css/style_compressed.css" />
			<script type="text/javascript" src="http://cms.revotas.com/cms/ui/js/report/main_compressed.js"></script>	
			...
			<xsl:choose>
					...
					<div class="sectionBox">
						...
						<div id="sortableColumnLeft" class="droptrue moveObj">
							...
							<div class="ui-state-default sectionblock" id="section-reportSummary">
								<a class="sectionSheaders" href="javascript:toggleContentBox('reportSummaryCnt')"><img id="reportSummaryCnt_excol" style="border:none;" src="../../images/report/b_1.png" alt="expand-collapse" /> <span>Report Summary</span></a>	
																	...
																	<div style="display:block;" id="sumGraph1">
																		<div id="chartContainerRecieved">
																			...
																			<xsl:variable name="reclink">
																				<xsl:text>http://chart.apis.google.com/chart?chf=bg,s,414141&amp;chs=220x150&amp;cht=p3&amp;chco=008000|FF0000&amp;chd=t:</xsl:text><xsl:value-of select='CampaignList/Campaigns/Row/ReachingPrc'/><xsl:text>,</xsl:text><xsl:value-of select='100-CampaignList/Campaigns/Row/ReachingPrc'/><xsl:text>&amp;chdl=Received|Bounced&amp;chdlp=b&amp;chdls=FFFFFF,10</xsl:text>
																			</xsl:variable>
								...
								<div class="ui-state-default sectionblock" id="section-DetailedClickedUnique">
									<a class="sectionSheaders" href="javascript:toggleContentBox('reportDetailedClickedUnique')"><img id="reportDetailedClickedUnique_excol" style="border:none;" src="../../images/report/b_2.png" alt="expand-collapse" /> <span>Detailed Click Throughs (Unique)</span></a>	
										...
										<table cellpadding="0" cellspacing="0" border="0" width="100%">
											<tr class="sectionContainerTbl">
												...
												<xsl:variable name="jsonDataLinksHTMLClicks">
													<xsl:for-each select="CampaignList/Campaigns/Row/Links">
														<xsl:text>{ "value" : "</xsl:text>
													    		<xsl:value-of select="(DistinctHTMLPrc * DistinctClickPrc) div 100"/>
													    	<xsl:text>" },</xsl:text>
													</xsl:for-each>
												</xsl:variable>
												...
												<xsl:variable name="jsonDataLinksTextClicks">
													<xsl:for-each select="CampaignList/Campaigns/Row/Links">
														<xsl:text>{ "value" : "</xsl:text>
													    		<xsl:value-of select="(DistinctTextPrc * DistinctClickPrc) div 100"/>
													    	<xsl:text>" },</xsl:text>
													</xsl:for-each>
												</xsl:variable>
												...
												<div id="clickthrueuniqgraph">
													...
													<xsl:variable name="detailedClickLink">
														<xsl:text>http://chart.apis.google.com/chart?chf=bg,s,414141&amp;chxl=0:|0|20|40|60|80|100|1:|</xsl:text><xsl:value-of select='$detailedClickLabels'/><xsl:text>&amp;chxs=0,FFFFFF,10,0,l,676767|1,FFFFFF,10,0,l,676767&amp;chxt=x,y&amp;chbh=14,10,10&amp;chs=450x</xsl:text><xsl:value-of select="$TotalNumOfLinksurl"></xsl:value-of><xsl:text></xsl:text><xsl:text>&amp;cht=bhs&amp;chco=3399CC,80C65A&amp;chd=t:</xsl:text><xsl:value-of select='$detailedClickTextValues'/><xsl:text>|</xsl:text><xsl:value-of select='$detailedClickHTMLValues'/><xsl:text>&amp;chdlp=b&amp;chg=20,20,2,2&amp;chm=N,000000,0,-1,11|N,FFFFFF,1,-1,11,1</xsl:text>
													</xsl:variable>
													...
													<div class="lessmoreBtn">
														<a href="javascript:toggleClickThrue('lessmoreContentLess','reportDetailedClickedUnique','bigSizeBoxes')"><img src="http://www.revotas.com/v5/samplereport/images/less.gif" style="border:none;" alt=""  /></a> 
														<a href="javascript:toggleClickThrue('lessmoreContentMore','reportDetailedClickedUnique','bigSizeBoxes')"><img src="http://www.revotas.com/v5/samplereport/images/more.gif" style="border:none;" alt=""  /></a>
													</div>
													</div>
												</td>
											</tr>
								...
								<div class="ui-state-default sectionblock" id="section-DetailedClickedAgg">
									<a class="sectionSheaders" href="javascript:toggleContentBox('reportDetailedClickedAgg')"><img id="reportDetailedClickedAgg_excol" style="border:none;" src="../../images/report/b_2.png" alt="expand-collapse" /> <span>Detailed Click Throughs (Aggregate)</span></a>	
										...
										<table cellpadding="0" cellspacing="0" border="0" width="100%">
											<tr class="sectionContainerTbl">
												<td>
													...
													<div class="lessmoreBtn">
														<a href="javascript:toggleClickThrue('lessmoreContentLess','reportDetailedClickedAgg','smallSizeBoxes')"><img src="http://www.revotas.com/v5/samplereport/images/less.gif" style="border:none;" alt=""  /></a> 
														<a href="javascript:toggleClickThrue('lessmoreContentMore','reportDetailedClickedAgg','smallSizeBoxes')"><img src="http://www.revotas.com/v5/samplereport/images/more.gif" style="border:none;" alt=""  /></a>
													</div>
													</div>
												</td>
											</tr>
						...
						<!-- Report Parameters Start -->
							<div class="ui-state-default sectionblock" id="section-reportParams" style="border:1px solid #FFCC00;">
								<a class="sectionSheaders" href="javascript:toggleContentBox('reportParams')"><img id="reportParams_excol" style="border:none;" src="../../images/report/b_2.png" alt="expand-collapse" /> <span>Report Parameters</span></a>	
							...
							<xsl:if test="1 = /CampaignList/BBackSecFlag">
								...
								<div class="ui-state-default sectionblock" id="section-bouncebackCategories">
									<a class="sectionSheaders" href="javascript:toggleContentBox('reportBbacksCnt')"><img id="reportBbacksCnt_excol" style="border:none;" src="../../images/report/b_2.png" alt="expand-collapse" /> <span>Bounceback Categories</span></a>	
											...
											<tr class="sectionContainerTbl">
												...
												<td style="width:220px;">
													...
													<xsl:variable name="bouncebackCatLinks">
														<xsl:text>http://chart.apis.google.com/chart?chf=bg,s,414141&amp;chxl=0:|%250|%2520|%2540|%2560|%2580|%25100|1:</xsl:text><xsl:value-of select='$bounceCatNames'/><xsl:text>&amp;chxs=0,FFFFFF,10,0,l,676767|1,FFFFFF,10,0,l,676767&amp;chxt=x,y&amp;chbh=14,10,10&amp;chs=300x150&amp;cht=bhs&amp;chco=3399CC&amp;chd=t:</xsl:text><xsl:value-of select='$bounceCatValues'/><xsl:text>&amp;chdlp=b&amp;chg=20,20,2,2&amp;chm=N%25,CCCCCC,0,-1,10</xsl:text>
													</xsl:variable>
						...
						<xsl:if test="count(CampaignList/Campaigns/Row/Domains) &gt; 0">
							...
							<div class="ui-state-default sectionblock" id="section-domainDeliv">
								<a class="sectionSheaders" href="javascript:toggleContentBox('domainDeliv')"><img id="domainDeliv_excol" style="border:none;" src="../../images/report/b_2.png" alt="expand-collapse" /> <span>Domain Deliverability</span></a>	
														...
														<td valign="top" width="220">
															<div id="chartContainer342">
																...
																<xsl:variable name="domaindelivlink">
																	<xsl:text>http://chart.apis.google.com/chart?chf=bg,s,414141&amp;chs=300x150&amp;cht=p3&amp;chco=008000|FF0000|3399CC|FF9900|C2BDDD&amp;chds=0,10000&amp;chd=t:</xsl:text><xsl:value-of select='$domainDelivValues'/><xsl:text>&amp;chdl=</xsl:text><xsl:value-of select='$domainDelivLabels'/><xsl:text>&amp;chdlp=b&amp;chdls=FFFFFF,10</xsl:text>
																</xsl:variable>
										...
										<tr class="sectionContainerTbl">
											<td>
												...
												<div style="position:relative;">
													...
													<div class="lessmoreBtn">
														<a href="javascript:toggleClickThrue('lessmoreContentLess','domainDeliv','bigSizeBoxes')"><img src="http://www.revotas.com/v5/samplereport/images/less.gif" style="border:none;" alt=""  /></a> 
														<a href="javascript:toggleClickThrue('lessmoreContentMore','domainDeliv','bigSizeBoxes')"><img src="http://www.revotas.com/v5/samplereport/images/more.gif" style="border:none;" alt=""  /></a>
													</div>
												</div>
											</td>
										</tr>
						...
						<xsl:if test="1 = /CampaignList/BBackSecFlag">
								...
								<div class="ui-state-default sectionblock" id="section-unsubs">
									<a class="sectionSheaders" href="javascript:toggleContentBox('reportUnsub')"><img id="reportUnsub_excol" style="border:none;" src="../../images/report/b_2.png" alt="expand-collapse" /> <span>Unsubscribe Categories</span></a>	
							...
							<div class="ui-state-default sectionblock" id="section-optouts">
								<a class="sectionSheaders" href="javascript:toggleContentBox('reportOptouts')"><img id="reportOptouts_excol" style="border:none;" src="../../images/report/b_2.png" alt="expand-collapse" /> <span>Newsletter Optouts</span></a>	
							...
							<div class="ui-state-default sectionblock" id="section-formSubmissions">
								<a class="sectionSheaders" href="javascript:toggleContentBox('reportFormSubmissions')"><img id="reportFormSubmissions_excol" style="border:none;" src="../../images/report/b_2.png" alt="expand-collapse" /> <span>Form Submissions</span></a>	
							...
							<div class="ui-state-default sectionblock" id="section-addmetrics">
								<a class="sectionSheaders" href="javascript:toggleContentBox('reportAddmetrics')"><img id="reportAddmetrics_excol" style="border:none;" src="../../images/report/b_2.png" alt="expand-collapse" /> <span>Additional Metrics</span></a>	
							...
							<!-- Additional Metrics End -->
								...
								<div class="ui-state-default sectionblock" id="section-ReciepentActions">
									<a class="sectionSheaders" href="javascript:toggleContentBox('reportRecActions')"><img id="reportRecActions_excol" style="border:none;" src="../../images/report/b_2.png" alt="expand-collapse" /> <span>Recipient Actions</span></a>	
											...
											<tr class="sectionContainerTbl">
												...
												<td style="width:220px;">
														...
														<xsl:variable name="recActionsLink">
															<xsl:text>http://chart.apis.google.com/chart?chf=bg,s,414141&amp;chxl=0:|%250|%2520|%2540|%2560|%2580|%25100|1:|Open HTML|Click Throughs|Unsubscribes&amp;chxs=0,FFFFFF,10,0,l,676767|1,FFFFFF,10,0,l,676767&amp;chxt=x,y&amp;chbh=14,10,10&amp;chs=300x100&amp;cht=bhs&amp;chco=3399CC&amp;chd=t:</xsl:text>
				...
				<div id="sortableColumnLeft" class="droptrue moveObj" style="width:100%;border:none;">
					...
					<div class="ui-state-default sectionblock" id="section-CampInfo">
						<a class="sectionSheaders" href="javascript:toggleContentBox('reportCampInfo')"><img id="reportCampInfo_excol" style="border:none;" src="../../images/report/b_2.png" alt="expand-collapse" /> <span>Campaign Info</span></a>	
					...
					<div class="ui-state-default sectionblock" id="section-GenCampStats">
						<a class="sectionSheaders" href="javascript:toggleContentBox('reportGenCampStats')"><img id="reportGenCampStats_excol" style="border:none;" src="../../images/report/b_2.png" alt="expand-collapse" /> <span>General Campaign  Statistics</span></a>	
					...
					<xsl:if test="1 = /CampaignList/DistClickSecFlag">
						...
						<div class="ui-state-default sectionblock" id="section-DetCTInfo">
							<a class="sectionSheaders" href="javascript:toggleContentBox('reportDetCTInfo')"><img id="reportDetCTInfo_excol" style="border:none;" src="../../images/report/b_2.png" alt="expand-collapse" /> <span>Detailed Clickthrough Info</span></a>	
					...
					<xsl:if test="1 = /CampaignList/TotClickSecFlag">
						...
						<div class="ui-state-default sectionblock" id="section-AddTCInfo">
							<a class="sectionSheaders" href="javascript:toggleContentBox('reportAddTCInfo')"><img id="reportAddTCInfo_excol" style="border:none;" src="../../images/report/b_2.png" alt="expand-collapse" /> <span>Additional Total Clickthrough Info</span></a>	

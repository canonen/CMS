...
<head>
	...
	<xsl:element name="link">
			<xsl:attribute name="rel">stylesheet</xsl:attribute>
			<xsl:attribute name="href">https://cms.revotas.com/cms/ui/css/demo_table_jui.css</xsl:attribute>
			<xsl:attribute name="type">text/css</xsl:attribute>
	</xsl:element>
	<xsl:element name="link">
			<xsl:attribute name="rel">stylesheet</xsl:attribute>
			<xsl:attribute name="href">https://cms.revotas.com/cms/ui/css/jquery-ui-1.7.2.custom.css</xsl:attribute>
			<xsl:attribute name="type">text/css</xsl:attribute>
	</xsl:element>
...
<SCRIPT src="https://cms.revotas.com/cms/ui/js/jquery.dataTables.min_new.js"></SCRIPT>
	<script type="text/javascript">
		$(document).ready(function() {
			...
			oTable = $('#example').dataTable( {
				"bJQueryUI": true,
				"aoColumns": [{ "bSortable": false },null,null,null,{ "sType": 'date' },null,null,null,null,null,null],
				"aaSorting": []
				} );
				...
				<xsl:for-each select="CampaignList/Campaigns/Row">
					<tr>
						...
						<xsl:element name="td">
							...
							<xsl:if test="MediaTypeId = 2">(SMS)</xsl:if>
							&#160;
							</xsl:if>
						</xsl:element>

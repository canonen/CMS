			...
			<head>
				...
				<xsl:element name="link">
					...
					<xsl:attribute name="href">
						<xsl:value-of select="CampaignList/StyleSheet"/>
					</xsl:attribute>
							...
							<tr>
								<xsl:if test="1 = /CampaignList/ReportCache">
									<td vAlign="middle" align="left">
										<xsl:element name="a">
											...
											<xsl:attribute name="href">
												report_cache_list.jsp?Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>
											</xsl:attribute>
									...
									<xsl:if test="/CampaignList/Campaigns/Row/Cache/StartDate!='' or /CampaignList/Campaigns/Row/Cache/EndDate!='' or /CampaignList/Campaigns/Row/Cache/AttrName!=''">
										<td vAlign="middle" align="left">
											<xsl:element name="a">
												...
												<xsl:attribute name="href">
													report_cache_edit.jsp?Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>&#38;C=<xsl:value-of select="CampaignList/Campaigns/Row/CacheId"/>
												</xsl:attribute>
												Edit Criteria
											</xsl:element>
										</td>
								...
								<td vAlign="middle" align="left">
									<xsl:element name="a">
										<xsl:attribute name="class">resourcebutton</xsl:attribute>
										<xsl:attribute name="href">
											report_object.jsp?act=PRNT&#38;id=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>&#38;Z=<xsl:value-of select="CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="CampaignList/Campaigns/Row/CacheId"/>
										</xsl:attribute>
										Export to Excel
									</xsl:element>
								</td>
										...
										<tr>
											<xsl:choose>
												<xsl:when test="1 = /CampaignList/ReportCache">
													<td class="EditTabOff" width="200" valign="center" nowrap="true" align="middle">
														<xsl:attribute name="onclick">
															location.href = 'report_object.jsp?act=VIEW&#38;id=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>';
														</xsl:attribute>
														Campaign Results
													</td>
												...
												<xsl:otherwise>
													...
													<td class="EditTabOff" width="200" valign="center" nowrap="true" align="middle">
														<xsl:attribute name="onclick">
															location.href = 'report_cache_list.jsp?Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>';
														</xsl:attribute>
														Demographic Or Time Report
													</td>
												</xsl:otherwise>
											</xsl:choose>
											<td class="EditTabOff" width="200" valign="center" nowrap="true" align="middle">
												<xsl:attribute name="onclick">
													location.href = 'report_time.jsp?Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>';
												</xsl:attribute>
												Activity vs. Time Report
											</td>
											...
											<xsl:if test="1 = /CampaignList/DeliveryTrackerRptFlag">
												<td class="EditTabOff" width="200" valign="center" nowrap="true" align="middle">
													<xsl:attribute name="onclick">
														location.href = 'eTrackerReport.jsp?Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>';
													</xsl:attribute>
													Delivery Tracking
												</td>
											</xsl:if>
											...
											<xsl:if test="0 &lt; /CampaignList/ReportPosFlag">
												<td class="EditTabOff" width="200" valign="center" nowrap="true" align="middle">
													<xsl:attribute name="onclick">
														location.href = 'report_track.jsp?Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>&#38;Z=<xsl:value-of select="CampaignList/ReportCache"/>';
													</xsl:attribute>
													RevoTrack Results
												</td>
											</xsl:if>
											<td class="EmptyTab" valign="center" nowrap="true" align="middle" width="100%">
												<img height="2" src="../../images/blank.gif" width="1" />
											</td>
										</tr>
									</table>
								</td>
										...
										<div id="xsnazzy">
											...
											<div class="xboxcontent">
												...
												<table style="width: 100%">
													<tr>
														<td>
															<b class="sectionheader">Campaign Name</b>
														</td>
														<td>
															<b class="sectionheader">Sending Start</b>
														</td>
														<td>
															<b class="sectionheader">Sending Finished</b>
														</td>
													</tr>
													<tr>
														<td>
															<xsl:value-of select="CampaignList/Campaigns/Row/Name"/>
														</td>
														<td>
															<xsl:value-of select="CampaignList/Campaigns/Row/StartDate"/>
														</td>
														<td>
															<xsl:value-of select="CampaignList/Campaigns/Row/EndDate"/>
														</td>
													</tr>
												</table>
											</div>
												...
												<xsl:if test="/CampaignList/Campaigns/Row/Cache/StartDate!=''">
													<tr>
														...
														<td class="list_row" width="100%">
															<nobr>
																&#160;<xsl:value-of select="/CampaignList/Campaigns/Row/Cache/StartDate"/>
															</nobr>
														</td>
													</tr>
												</xsl:if>
												<xsl:if test="/CampaignList/Campaigns/Row/Cache/EndDate!=''">
													<tr>
														...
														<td class="list_row_other" width="100%">
															<nobr>
																&#160;<xsl:value-of select="/CampaignList/Campaigns/Row/Cache/EndDate"/>
															</nobr>
														</td>
													</tr>
												</xsl:if>
												...
												<div id="xsnazzy">
													...
													<div class="xboxcontent">
														...
														<table class="listTable" cellSpacing="0" cellPadding="2" width="100%" style="padding-top: 4px;">
															...
															<tr>
																<td width="150" align="left" class="list_row_other" nowrap="true">Bounceback :</td>
...
<xsl:attribute name="src">http://chart.apis.google.com/chart?chs=300x100&amp;chf=bg,a,C0C0C0&amp;chd=t:<xsl:value-of select="CampaignList/Campaigns/Row/BBackPrc"/>,<xsl:value-of select="CampaignList/Campaigns/Row/ReachingPrc"/>&amp;cht=p3&amp;chl=Bounceback|Received</xsl:attribute>
</xsl:element>
-->
																	<xsl:element name="table">
															...
															<tr>
																<td width="150" align="left" class="list_row" nowrap="true">Received :</td>
																<td class="list_row" nowrap="true">
																	&#160;
																	<xsl:element name="a">
																		<xsl:attribute name="href">
															...
															<tr>
																<td width="150" align="left" class="list_row_other" nowrap="true">ClickThru :</td>
																<td class="list_row_other" nowrap="true">
																	&#160;
																	<xsl:element name="a">
																		<xsl:attribute name="href">
															...
															<tr>
																<td width="150" align="left" class="list_row" nowrap="true">Read :</td>
																<td class="list_row" nowrap="true">
																	&#160;
																	<xsl:element name="a">
																		<xsl:attribute name="href">
																	...
																	</xsl:element> (<xsl:value-of select="CampaignList/Campaigns/Row/DistinctReadPrc"/>%)
																</td>
																<td class="list_row" nowrap="true">
																	&#160;
															...
															<tr>
																<td width="150" align="left" class="list_row_other" nowrap="true">Unsubscribes :</td>
																<td class="list_row_other" nowrap="true">
																	&#160;
																	<xsl:element name="a">
																		<xsl:attribute name="href">
																...
																<tr>
																	<xsl:element name="td">
																		<xsl:attribute name="class">
																			list_row<xsl:value-of select="StyleClass"/>
																		</xsl:attribute>
																	...
																	<xsl:element name="td">
																		...
																		<xsl:element name="a">
																			<xsl:attribute name="href">
																				javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=bbk&#38;Q=<xsl:value-of select="CampID"/>&#38;B=<xsl:value-of select="CategoryID"/>&#38;Z=<xsl:value-of select="/CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="/CampaignList/Campaigns/Row/CacheId"/>');
																			</xsl:attribute>
														...
														<table class="listTable" cellspacing="0" cellpadding="2" width="100%">
															...
															<tr>
																...
																<td class="list_row_other" nowrap="true">
																	...
																	<xsl:element name="a">
																		<xsl:attribute name="href">
																			javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=read&#38;Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>&#38;Z=<xsl:value-of select="CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="CampaignList/Campaigns/Row/CacheId"/>');
																		</xsl:attribute>
																		<xsl:value-of select="CampaignList/Campaigns/Row/DistinctReads"/>
																	</xsl:element>
																	(<xsl:value-of select="CampaignList/Campaigns/Row/DistinctReadPrc"/>%)
															...
															<tr>
																...
																<td class="list_row" nowrap="true">
																	...
																	<xsl:element name="a">
																		<xsl:attribute name="href">
																			javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=click&#38;Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>&#38;Z=<xsl:value-of select="CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="CampaignList/Campaigns/Row/CacheId"/>');
																		</xsl:attribute>
																		<xsl:value-of select="CampaignList/Campaigns/Row/DistinctClicks"/>
																	</xsl:element> (<xsl:value-of select="CampaignList/Campaigns/Row/DistinctClickPrc"/>%)
																</td>
															...
															<tr>
																...
																<td class="list_row_other" nowrap="true">
																	...
																	<xsl:element name="a">
																		<xsl:attribute name="href">
																			javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=unsub&#38;Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>&#38;Z=<xsl:value-of select="CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="CampaignList/Campaigns/Row/CacheId"/>');
																		</xsl:attribute>
																		<xsl:value-of select="CampaignList/Campaigns/Row/Unsubs"/>
																	</xsl:element> (<xsl:value-of select="CampaignList/Campaigns/Row/UnsubPrc"/>%)
																</td>
														...
														<table class="listTable" cellspacing="0" cellpadding="2" width="100%">
															...
															<xsl:for-each select="CampaignList/Campaigns/Row/Unsub">
																<tr>
																	<xsl:element name="td">
																		<xsl:attribute name="class">
																			list_row_other<xsl:value-of select="StyleClass"/>
																		</xsl:attribute>
																		<xsl:attribute name="width">150</xsl:attribute>
																		<xsl:attribute name="align">left</xsl:attribute>
																		<xsl:attribute name="nowrap">true</xsl:attribute>
																	...
																	<xsl:element name="td">
																		...
																		<xsl:element name="a">
																			<xsl:attribute name="href">
																				javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=unsublevel&#38;Q=<xsl:value-of select="CampID"/>&#38;S=<xsl:value-of select="LevelID"/>&#38;Z=<xsl:value-of select="/CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="/CampaignList/Campaigns/Row/CacheId"/>');
																			</xsl:attribute>
															...
															<xsl:for-each select="CampaignList/Campaigns/Row/Optouts">
																<tr>
																	...
																	<xsl:element name="td">
																		...
																		<xsl:element name="a">
																			<xsl:attribute name="href">
																				javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=optout&#38;Q=<xsl:value-of select="CampID"/>&#38;N=<xsl:value-of select="AttrID"/>&#38;Z=<xsl:value-of select="/CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="/CampaignList/Campaigns/Row/CacheId"/>');
																			</xsl:attribute>
																...
																<td class="list_row" width="100%">
																	<xsl:element name="table">
																		...
																		<tr>
																			...
																			<td class="reportmarkers" valign="middle" width="10%" align="left">0%</td>
																			<td class="reportmarkers" valign="middle" width="10%" align="right">
																				<img height="10" width="1" src="/cms/ui/images/blank.gif" />
																			</td>
																		</tr>
																	</xsl:element>
															...
															<xsl:for-each select="CampaignList/Campaigns/Row/Links">
																<tr>
																	...
																	<xsl:element name="td">
																		...
																		<xsl:element name="a">
																			<xsl:attribute name="href">
																				javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=click&#38;Q=<xsl:value-of select="CampID"/>&#38;H=<xsl:value-of select="HrefID"/>&#38;Z=<xsl:value-of select="/CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="/CampaignList/Campaigns/Row/CacheId"/>');
																			</xsl:attribute>
																		...
																		<xsl:element name="a">
																			<xsl:attribute name="href">
																				javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=click&#38;Q=<xsl:value-of select="CampID"/>&#38;H=<xsl:value-of select="HrefID"/>&#38;T=T&#38;Z=<xsl:value-of select="/CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="/CampaignList/Campaigns/Row/CacheId"/>');
																			</xsl:attribute>
																		...
																		<xsl:element name="a">
																			<xsl:attribute name="href">
																				javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=click&#38;Q=<xsl:value-of select="CampID"/>&#38;H=<xsl:value-of select="HrefID"/>&#38;T=H&#38;Z=<xsl:value-of select="/CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="/CampaignList/Campaigns/Row/CacheId"/>');
																			</xsl:attribute>
																...
																<td class="list_row" width="100%">
																	<table cellspacing="0" cellpadding="3" border="0">
																		<tr>
																			...
																			<td class="text" align="left" valign="middle" style="border:1px solid #000000;">
																				<img height="10" width="10" src="/cms/ui/images/blank.gif" />
																			</td>
																			<td align="left" valign="middle">Text Click</td>
																			<td align="left" valign="middle">&#160;</td>
																			<td class="html" align="left" valign="middle" style="border:1px solid #000000;">
																				<img height="10" width="10" src="/cms/ui/images/blank.gif" />
																			</td>
															...
															<xsl:for-each select="CampaignList/Campaigns/Row/Forms">
																<tr>
																	...
																	<xsl:element name="td">
																		...
																		<xsl:element name="a">
																			<xsl:attribute name="href">
																				javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=view&#38;Q=<xsl:value-of select="CampID"/>&#38;F=<xsl:value-of select="FirstFormID"/>&#38;Z=<xsl:value-of select="/CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="/CampaignList/Campaigns/Row/CacheId"/>');
																			</xsl:attribute>
																	...
																	<xsl:element name="td">
																		...
																		<xsl:element name="a">
																			<xsl:attribute name="href">
																				javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=submit&#38;Q=<xsl:value-of select="CampID"/>&#38;F=<xsl:value-of select="LastFormID"/>&#38;Z=<xsl:value-of select="/CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="/CampaignList/Campaigns/Row/CacheId"/>');
																			</xsl:attribute>
																	...
																	<xsl:element name="td">
																		...
																		<xsl:element name="a">
																			<xsl:attribute name="href">
																				javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=multisubmit&#38;Q=<xsl:value-of select="CampID"/>&#38;F=<xsl:value-of select="LastFormID"/>&#38;Z=<xsl:value-of select="/CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="/CampaignList/Campaigns/Row/CacheId"/>');
																			</xsl:attribute>
												...
												<div class="xboxcontent">
													<table class="listTable" cellspacing="0" cellpadding="2" width="100%">
														...
														<xsl:if test="1 = /CampaignList/MultiReadFlag">
															<tr>
																<td align="right" class="list_row_other" nowrap="true">Opened HTML Email more than once</td>
																<td class="list_row" width="100%">
																	&#160;
																	<xsl:element name="a">
																		<xsl:attribute name="href">
																			javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=multiread&#38;Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>&#38;Z=<xsl:value-of select="CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="CampaignList/Campaigns/Row/CacheId"/>');
																		</xsl:attribute>
														...
														<xsl:if test="1 = /CampaignList/MultiLinkClickFlag">
															<tr>
																<td align="right" class="list_row_other" nowrap="true">Clicked on more than one link</td>
																<td class="list_row" width="100%">
																	&#160;
																	<xsl:element name="a">
																		<xsl:attribute name="href">
																			javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=multilink&#38;Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>&#38;Z=<xsl:value-of select="CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="CampaignList/Campaigns/Row/CacheId"/>');
																		</xsl:attribute>
														...
														<xsl:if test="1 = /CampaignList/LinkMultiClickFlag">
															<tr>
																...
																<td class="list_row" width="100%">
																	...
																	<xsl:element name="a">
																		<xsl:attribute name="href">
																			javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=multiclick&#38;Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>&#38;Z=<xsl:value-of select="CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="CampaignList/Campaigns/Row/CacheId"/>');
																		</xsl:attribute>
													...
													<div class="xboxcontent">
														<table class="listTable" cellspacing="0" cellpadding="2" width="100%">
															...
															<tr>
																...
																<td class="subsectionheader" nowrap="true">Unsubscribe - Spam Complaints</td>
																<!-- Spam Complaints -->
															</tr>
															<xsl:for-each select="CampaignList/Campaigns/Row/Domains">
																<tr>
																	...
																	<xsl:element name="td">
																		...
																		<xsl:element name="a">
																			<xsl:attribute name="href">
																				javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=domainsent&#38;Q=<xsl:value-of select="CampID"/>&#38;D=<xsl:value-of select="Domain"/>&#38;Z=<xsl:value-of select="/CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="/CampaignList/Campaigns/Row/CacheId"/>');
																			</xsl:attribute>
																	...
																	<xsl:element name="td">
																		...
																		<xsl:element name="a">
																			<xsl:attribute name="href">
																				javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=domainbbk&#38;Q=<xsl:value-of select="CampID"/>&#38;D=<xsl:value-of select="Domain"/>&#38;Z=<xsl:value-of select="/CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="/CampaignList/Campaigns/Row/CacheId"/>');
																			</xsl:attribute>
																			<xsl:value-of select="BBacks"/>
																		</xsl:element>
																		(<xsl:value-of select="BBackPrc"/>%)
					...
					<xsl:otherwise>
						...
						<xsl:if test="1 = /CampaignList/GeneralSecFlag">
							<br />
							<br />
							<b>General Campaign  Statistics</b>
							<br />
							<br />
							<!-- Block for many campaigns-->
							<table class="main" width="100%" cellpadding="1" cellspacing="1">
								...
								<xsl:for-each select="CampaignList/Campaigns/Row">
									<tr>
										...
										<td>
											<xsl:element name="a">
												<xsl:attribute name="href">
													javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=read&#38;Q=<xsl:value-of select="Id"/>&#38;C=<xsl:value-of select="CacheId"/>');
												</xsl:attribute>
											...
											- <xsl:element name="a">
												<xsl:attribute name="href">
													javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=multiread&#38;Q=<xsl:value-of select="Id"/>&#38;C=<xsl:value-of select="CacheId"/>');
												</xsl:attribute>
												<xsl:value-of select="MultiReaders"/>
											</xsl:element> repeat readers
										</td>
										<td>
							...
							<xsl:for-each select="CampaignList/Campaigns/Row">
								<table class="main" width="100%" cellpadding="1" cellspacing="1">
									...
									<tr>
										...
										<td width="10%">
											<xsl:value-of select="TotalLinks"/>
										</td>
										<td width="10%">
											<xsl:element name="a">
												<xsl:attribute name="href">
										...
										<tr>
											...
											<td width="10%" colspan="2">
												<xsl:element name="a">
													...
													<xsl:value-of select="TotalClicks"/>
												</xsl:element> (<xsl:value-of select="TotalClickPrc"/>%)
											</td>
											<td width="10%"  colspan="2">
												<xsl:element name="a">
													<xsl:attribute name="href">
														javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=multiclick&#38;Q=<xsl:value-of select="CampID"/>&#38;C=<xsl:value-of select="../CacheId"/>&#38;H=<xsl:value-of select="HrefID"/>');
													</xsl:attribute>

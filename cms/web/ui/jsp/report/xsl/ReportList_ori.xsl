	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			oTable = $('#example').dataTable({
				"sDom": "tlrip",
				"aoColumns": [{ "bSortable": false },{ "bSortable": false },null,null,{ "sType": 'date' },null,null,null,null,null,null],
				"aaSorting": [[ 4, "desc" ]]
			});
...
<div class="xboxcontent">
				...
				<tbody>
					<tr>
						...
						<TD nowrap="true" align="right" style="padding-right:10px;">
							<A class="newbutton" href="report_list.jsp"><img src="../../images/refresh.png" align="absmiddle"/>&#160;Refresh</A>
						</TD>
					</tr>
				</tbody>
			</table>
			<table class="list_table" width="100%" cellpadding="2" cellspacing="0">
				<tr>
					<th align="left" nowrap="true">Reports&#160;</th>
				</tr>
			</table>
			<table class="list_table" id="example" width="100%" cellpadding="2" cellspacing="0">
				<thead>
					...
					<th valign="middle" nowrap="true">Campaign Type</th>
					...
					<th valign="middle" nowrap="true">Click Throughs</th>
					<th valign="middle" nowrap="true">Unsubscribes</th>

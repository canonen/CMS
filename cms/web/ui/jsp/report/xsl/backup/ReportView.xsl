								...
								<xsl:if test="1 = /CampaignList/ReportCache">
									<td vAlign="middle" align="left">
										<xsl:element name="a">
											...
											<xsl:attribute name="href">report_cache_list.jsp?Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/></xsl:attribute>&lt;&lt; Return to Demographic or Time Reports</xsl:element>
									</td>
									<xsl:if test="/CampaignList/Campaigns/Row/Cache/StartDate!='' or /CampaignList/Campaigns/Row/Cache/EndDate!='' or /CampaignList/Campaigns/Row/Cache/AttrName!=''">
										<td vAlign="middle" align="left">
											<xsl:element name="a">
												...
												<xsl:attribute name="href">report_cache_edit.jsp?Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>&#38;C=<xsl:value-of select="CampaignList/Campaigns/Row/CacheId"/></xsl:attribute>Edit Criteria</xsl:element>
										</td>
									</xsl:if>
								</xsl:if>
								<td vAlign="middle" align="left">
...
<!--
<table id="Tabs_Table6" cellspacing="0" cellpadding="5" width="660" border="0">
	<tr>
		<td class="Tab_ON" id="tab6_Step1" width="150" onclick="tab_steps('Tabs_Table6', 'tab6_Step1', 'block6_Step1');" valign="center" align="middle">Opens</td>
		<td class="Tab_OFF" id="tab6_Step2" width="150" onclick="tab_steps('Tabs_Table6', 'tab6_Step2', 'block6_Step2');" valign="center" align="middle">Clicks</td>
		<td class="Tab_OFF" id="tab6_Step3" width="150" onclick="tab_steps('Tabs_Table6', 'tab6_Step3', 'block6_Step3');" valign="center" align="middle">Bounces</td>
		<td class="Tab_OFF" id="tab6_Step4" width="150" onclick="tab_steps('Tabs_Table6', 'tab6_Step4', 'block6_Step4');" valign="center" align="middle">Unsubscribes</td>
		<td class="Tab_CLEAR" valign="center" align="middle" width="0"></td>
	</tr>
	<tr>
		<td class="Tab_SEPR" valign="top" align="left" width="660" colspan="4"><img height="2" src="../../images/blank.gif" width="1"/></td>
	</tr>
...
-->
															...
															<tr>
																...
																<td class="list_row"><xsl:value-of select="CampaignList/Campaigns/Row/ReachingPrc"/>%</td>
																<td class="list_row" nowrap="true">
																	&#160;N/A
																</td>
																<td class="list_row" width="100%">
															...
															<tr>
																...
																<td class="list_row_other" nowrap="true"><xsl:value-of select="CampaignList/Campaigns/Row/DistinctClickPrc"/>%</td>
																<td class="list_row_other">
																...
																<td class="list_row_other" width="100%">
																	<xsl:element name="table">
																		<xsl:attribute name="width">
																			<xsl:value-of select="CampaignList/Campaigns/Row/DistinctClickPrc"/>%</xsl:attribute>
																		<xsl:attribute name="border">0</xsl:attribute>
																		<xsl:attribute name="cellpadding">0</xsl:attribute>
																		<xsl:attribute name="cellspacing">0</xsl:attribute>
																		<tr>
															...
															<tr>
																...
																<td class="list_row"><xsl:value-of select="CampaignList/Campaigns/Row/DistinctReadPrc"/>%</td>
																<td class="list_row" nowrap="true">
																...
																<td class="list_row" width="100%">
																	<xsl:element name="table">
																		<xsl:attribute name="width">
																			<xsl:value-of select="CampaignList/Campaigns/Row/DistinctReadPrc"/>%</xsl:attribute>
																		<xsl:attribute name="border">0</xsl:attribute>
																		<xsl:attribute name="cellpadding">0</xsl:attribute>
																		<xsl:attribute name="cellspacing">0</xsl:attribute>
																		<tr>
															...
															<tr>
																...
																<td class="list_row_other"><xsl:value-of select="CampaignList/Campaigns/Row/UnsubPrc"/>%</td>
																<td class="list_row_other" nowrap="true">
																	&#160;N/A
																</td>
																<td class="list_row_other" width="100%">
																	<xsl:element name="table">
																		<xsl:attribute name="width">
																			<xsl:value-of select="CampaignList/Campaigns/Row/UnsubPrc"/>%</xsl:attribute>
																		<xsl:attribute name="border">0</xsl:attribute>
																		<xsl:attribute name="cellpadding">0</xsl:attribute>
																		<xsl:attribute name="cellspacing">0</xsl:attribute>
																		<tr>
															...
															<xsl:for-each select="CampaignList/Campaigns/Row/Optouts">
																<tr>
																	...
																	<xsl:element name="td">
																		...
																		<xsl:element name="table">
																			<xsl:attribute name="width">
																				<xsl:value-of select="OptoutPrc"/>%</xsl:attribute>
																			<xsl:attribute name="border">0</xsl:attribute>
																			<xsl:attribute name="cellpadding">0</xsl:attribute>
																			<xsl:attribute name="cellspacing">0</xsl:attribute>
																			<tr>
																...
																<td class="list_row" width="100%">
																	<xsl:element name="table">
																		...
																		<tr>
																			...
																			<td class="reportmarkers" valign="middle" width="10%" align="left">0%</td>
																			<td class="reportmarkers" valign="middle" width="10%" align="right"><img height="10" width="1" src="/cms/ui/images/blank.gif" />
																			</td>
																		</tr>
																	</xsl:element>
																</td>
														...
														<table class="listTable" cellspacing="0" cellpadding="2" width="100%">
															...
															<xsl:for-each select="CampaignList/Campaigns/Row/Domains">
																<tr>
																	...
																	<xsl:element name="td">
																		<xsl:attribute name="class">list_row<xsl:value-of select="StyleClass"/></xsl:attribute>
																		<xsl:attribute name="nowrap">true</xsl:attribute>&#160;<xsl:element name="a"><xsl:attribute name="href">javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=domainsent&#38;Q=<xsl:value-of select="CampID"/>&#38;D=<xsl:value-of select="Domain"/>&#38;Z=<xsl:value-of select="/CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="/CampaignList/Campaigns/Row/CacheId"/>');</xsl:attribute>
																		<xsl:value-of select="Sent"/></xsl:element>
																	</xsl:element>

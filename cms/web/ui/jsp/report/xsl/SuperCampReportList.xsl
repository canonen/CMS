...
<div class="page_header">Super reports</div>
<div class="page_desc">Merge your reports with super reports.</div>
...
<table cellspacing="0" cellpadding="0" width="95%" border="0">
	<tr>
		<td class="listHeading" valign="center" nowrap="true" align="left">
			<table class="listTable" cellspacing="" cellpadding="" border="0" align="right">
				<tr>
					<td align="right" valign="middle" nowrap="true">&#160;&#160;<a class="data_refresh" href="javascript:GO(2)">Refresh List</a>&#160;&#160;</td>
					<td style="font-weight:bold" align="right" valign="middle" nowrap="true">&#160;<span id="page_1"></span></td>
					<td style="font-weight:bold" align="center" valign="middle">

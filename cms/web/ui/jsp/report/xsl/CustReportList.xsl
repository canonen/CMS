...
<div class="page_header">Global Reposts</div>
<div class="page_desc">Create reports with specifying dates.</div>
...
<div id="filterBox" style="display:none;">
	<table class="listTable" cellspacing="0" cellpadding="0" border="0">
		...
		<tr>
			<td valign="middle" align="center" colspan="2"><a class="subactionbutton" href="#" onClick="filterReveal(30,event);GO(2);">Filter</a></td>
			<td valign="middle" align="right">&#160;</td>
		</tr>
	</table>
</div>
	...
	<tr>
		<td class="listHeading" valign="center" nowrap="true" align="left">
			<table class="listTable" cellspacing="0" cellpadding="0" border="0" align="right">
				<tr>
					<td align="right" valign="middle" nowrap="true">&#160;&#160;<a class="data_refresh" href="javascript:GO(2)">Refresh</a>&#160;&#160;</td>
			...
			<xsl:for-each select="ReportList/Reports/Row">
				...
				<table class="listTable" width="100%" cellpadding="2" cellspacing="0" id="reportTable">
					<tr>
						<td style="padding:0" width="100%" class="listItem_Data" valign="top" nowrap="true">
							<table width="100%" border="0" cellpadding="2" cellspacing="0">
								...
								<tr>
									...
									<td nowrap="true" class="listItem_Data" width="25%">
							...
							<table width="100%" border="0" cellpadding="2" cellspacing="0">
								...
								<tr>
									<td nowrap="true" class="listItem_Data" colspan="3" style="display:none;">
										...
										<div class="list-headers">Bounceback Categories</div>
										<table class="listTable" width="100%" border="0" cellpadding="2" cellspacing="0">
											
											<tr>
												<th nowrap="true" class="subsectionheader"><b>Category</b></th>
												<th nowrap="true" class="subsectionheader"><b>Bouncebacks</b></th>
											</tr>
										...
										<div class="list-headers">Domain Deliverability</div>
										<table class="listTable" width="100%" border="0" cellpadding="2" cellspacing="0">
											
											<tr>
												<th nowrap="true" class="subsectionheader"><b>Domain</b></th>
												<th nowrap="true" class="subsectionheader"><b>Sent</b></th>
												<th nowrap="true" class="subsectionheader"><b>Bounced back</b></th>
												<th nowrap="true" class="subsectionheader"><b>Read</b></th>
												<th nowrap="true" class="subsectionheader"><b>Clicked</b></th>
												<th nowrap="true" class="subsectionheader"><b>Total Unsubscribed</b></th>
												<th nowrap="true" class="subsectionheader"><b>Unsubscribe - Spam Complaints</b></th>
											</tr>

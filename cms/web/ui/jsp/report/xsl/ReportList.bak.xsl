...
<table width="100%">
	<tr>
		<td class="page_header">Reporting</td>
	</tr>
</table>
<br/>	
...
<table cellpadding="3" cellspacing="0" border="0" width="95%">
	<tr>
		<td vAlign="middle" align="left" nowrap="true">
			<a class="subactionbutton" href="#1" OnClick="PrepSubmit('1');">
			<img border="0" width="45" src="../../images/45_45_reportg.png" onmouseout="this.src='../../images/45_45_report.png'" onmouseover="this.src='../../images/45_45_reportg.png'"/><br/>
			Compare</a>&#160;&#160;&#160;
		</td>
		<td vAlign="middle" align="left" nowrap="true">
			<a class="subactionbutton" href="#1" OnClick="PrepSubmit('2');">
    	<img border="0" width="45" src="../../images/45_45_report_cust.png" onmouseout="this.src='../../images/45_45_report_cust.png'" onmouseover="this.src='../../images/45_45_report_custg.png'"/><br/>
			Update</a>&#160;&#160;&#160;
		</td>
		<td vAlign="middle" align="left" nowrap="true">
			<a class="subactionbutton" href="#1" OnClick="PrepSubmit('3');">
				<img border="0" width="45" src="../../images/45_45_report_sup.png" onmouseout="this.src='../../images/45_45_report_sup.png'" onmouseover="this.src='../../images/45_45_report_supg.png'"/><br/>
		Export to Excel</a>&#160;&#160;&#160;
		</td>
		...
		<td class="listHeading" valign="center" nowrap="true" align="left">
			...
			<table class="listTable" width="100%" cellpadding="2" cellspacing="0" id="reportTable">
				<tr>
					...
					<th></th>
					<th></th>
					<th align="left"><img src="../../images/16_L_refresh.gif"/><a href="javascript:GO(2)">Refresh List</a></th>
				</tr>
				<tr>
					<th class="list_name">Action</th>
					<th class="list_name">Campaign Name</th>
					<th class="list_name">Campaign Type</th>
					<th class="list_name">Start Date</th>
					<th class="list_name">Size</th>
					<th class="list_name">Bounce Backs</th>
					<th class="list_name">Click Throughs</th>
					<th class="list_name">Unsubscribes</th>
					<th class="list_name">Update Date</th>
					<th class="list_name">Update Status</th>
				</tr>

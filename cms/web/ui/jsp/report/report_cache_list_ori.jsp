...
<div class="wrapper">
<!-- neeeeeeeeeeeewwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww  -->
...
<div class="topLinksContainer">
	<a href="report_cache_edit.jsp?Q=<%= sCampID %>&C=<%=sCacheIDC %>" class="topLinks">New Demographic or Time Report</a>
	<a href="javascript:void(null)" class="topLinks" onclick="PrepSubmit('1');">Compare Reports</a>
	<a href="javascript:void(null)" class="topLinks" onclick="PrepSubmit('2');">Update Reports</a>
	<a href="javascript:void(null)" class="topLinks" onclick="PrepSubmit('3');" style="float:right;">Refresh List</a>
	<div class="clearfix"></div>
</div>
<div>
	<table id="reportSummaryCnt" class="sectionContainerTbl" width="100%" cellspacing="0" cellpadding="0" border="0">
	<tr>
	<td>
	<table class="borderTbl" width="100%" cellspacing="0" cellpadding="0" border="0">
		<tr class="sectionHeaders">
			...
			if (iCount == 0)
			{
				%>
				<tr>
					<td colspan="10">There are currently no Demographic or Time Reports.</td>
				</tr>
				<%
			}
			rs.close();

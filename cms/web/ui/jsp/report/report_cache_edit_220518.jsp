...
try	{
	...
	if ((sCampID == null) || (sCampID == "") || (numRecs < 1))
	{
		...
		<tr>
									<th align="center" valign="middle" style="padding:10px;">
										<b>Campaigns</b>
									</th>
						</tr>
...
<a href="report_cache_list.jsp?Q=<%= sCampID %>&C=<%=sCacheID%>" class="resourcebutton">Return to Demographic or Time Reports</a>
...
<br> 
	...
	<div class="sectionBox" style=margin-top:5px>
		...
		<div>
			<table class="sectionContainerTbl" width="96%" cellspacing="0" cellpadding="0" border="0">
				<tr>
					<td>
						<table id="newdemograph" class="listTable" width="100%" cellspacing="0" cellpadding="0" border="0">
							<tr>
								<th colspan="3"><span style="color:#21759b"><%= reportName %> : </span>  Use the below options to create a Demographic Or Time Report which will break down your campaign results based on the below criteria.</th>
							<tr>
							...
							<tr>
								<td colspan="3" align="center"><a class=buttons-action href="#" onClick="trySubmit();">Create/Update Report</a></td>
							</tr>
							<tr>
								<td colspan="3">&nbsp;</td>
							</tr>

...
<script type="text/javascript" src="../../js/report/FusionCharts.js"></script>
...
%>
	<table width=95% class=listTable  cellspacing=0 cellpadding=0>
		<tr>
			<th class=sectionheader>&nbsp;<b class=sectionheader>Report:</b> <%= reportName %></th>
		</tr>
	</table>
	<br>
	...
	<a href="report_cache_edit.jsp?Q=<%=sCampID%>">
	...
	<table id="Tabs_Table1" cellspacing="0" cellpadding="0" width="95%" border="0">
		<tr>		
			...
			<td class="" valign="center" nowrap="true" align="middle" width="250"><img height="2" src="../../images/blank.gif" width="1" /></td>
		</tr>
		<tbody class="EditBlock" id="block1_Step1">
		<tr>
			<td class="" valign="top" align="center" width="100%" colspan="6">
...
<%
	...
	String campSummarySql = "select * from crpt_camp_summary where camp_id = " + sCampID;
	...
	String xmlData = "<graph isSliced='1' decimalPrecision='0'>";
...
var chart = new FusionCharts("fusioncharts/FCF_Funnel.swf", "chartdiv1", "250", "350");

...
<table id="Tabs_Table1" cellspacing="0" cellpadding="0" width="95%" border="0">
	<tr>
		<td class="EditTabOff" width="200" valign="center" nowrap="true" align="middle" onclick="location.href = 'report_object.jsp?act=VIEW&id=<%=sCampID%>';">Campaign Results</td>
	...
	<tr>
		<td class="fillTab" valign="top" align="left" colspan="6">
			<a href="report_cache_list.jsp?Q=<%= sCampID %>" class="resourcebutton"><< Return to Demographic or Time Reports</a>
			<br><br>
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td colspan="3" align="center" valign="middle" style="padding:10px;">
						Use the below options to create a Demographic Or Time Report which will break down your campaign results based on the below criteria.
					</td>
				</tr>
				<tr>
					<td valign="middle">
					...
					<td width="250" nowrap valign="middle">
						Include activity that occured on or after this Start Date: 
					</td>
					<td >
				...
				<tr>
					<td valign="middle">
						<input name="sd2" type="checkbox" onclick="setDateFlag(this,1,this.form.end_date);">
					</td>
					<td width="250" nowrap>
						Include activity that occured on or before this End Date: 
					</td>
					<td >
				...
				<tr>
					<td valign="middle">
						<input name="at" type="checkbox" onclick="setRecipFlag(this);" <%=(sCacheAttrValue1.length()>0 || sCacheFilterID.length() > 0)?" checked":""%>>
					</td>
					<td width="250" nowrap>
						Only activities generated by recipients of the selected option: 
					</td>
					<td>
						<table>
							<tr>
								<td>
									<INPUT type="radio" name="recip_option" id="recip_option_2" value="2" onClick="setRecipOpt2(this);">Report Filter
								</td>
								<td>
							...
							<tr>
								<td>
									<INPUT type="radio" name="recip_option" id="recip_option_3" value="3" onClick="setRecipOpt3(this);">Target Group
								</td>
								<td>
				...
				<tr>
					<td colspan="3" align="center" valign="middle" style="padding:10px;">
						<a class="savebutton" href="#" onClick="trySubmit();">Create/Update Report</a>
					</td>
				</tr>
			</table>
		</td>

			...
			<table cellspacing="0" cellpadding="0" width="100%" border="0">
				<tr>
					<td class="listHeading" valign="center" nowrap align="left">
						Help Documentation
						<br><br>
						<table class="main" cellpadding="2" cellspacing="1" border="0" width="100%">
							<tr>
								<td align="left" valign="top" style="padding:10px;">
									...
									<table class="listTable" cellspacing="0" cellpadding="5" border="0" width="100%">
										<tr>
											...
											<td align="center" valign="middle" class="listItem_Data_Alt" nowrap style="padding:5px;"><a class="subactionbutton" href="http://www.revotas.com/products/60help/BriteMoon60.htm">Go >></a>&nbsp;&nbsp;&nbsp;</td>
										</tr>
									</table>
									<% } %>
								</td>

...
try
{
	...
	if (sAction != null)
	{
		...
		{
			sSql = "update chom_user_note set admin=1, published = 0, modify_date = GETDATE() where note_id = '" + sNoteId + "' and cust_id = '" + cust.s_cust_id + "'";
		...
		{
			sSql = "update chom_user_note set admin=1, published = 1, modify_date = GETDATE() where note_id = '" + sNoteId + "' and cust_id = '" + cust.s_cust_id + "'";
			stmt.executeUpdate(sSql);
			%>
			<html>
			<head>

...
try
{
	...
	conn = cp.getConnection("admin_note_list.jsp");
...
<table cellpadding="3" cellspacing="0" border="0" width="95%">
	<tr>
		<td vAlign="middle" align="left" nowrap>
			<a class="newbutton" href="admin_note_edit.jsp">New Admin Note</a>&nbsp;&nbsp;&nbsp;
		</td>
...
<table cellspacing="0" cellpadding="0" width="95%" border="0">
	<tr>
		<td class="listHeading" valign="center" nowrap align="left">
			...
			if (!sParentId.equals(cSuper.s_cust_id))
			{
				sSql = "EXEC usp_chom_user_note_list_get_published @cust_id=" + sParentId + ",@admin=1,@exclude_id="+ sNoteId;
				rs = stmt.executeQuery(sSql);
				...
				while (rs.next())
				{
					...
					cNote = new Customer(sParentId);
					%>
				<tr id="pRow_<%= sId %>"<%= (iCount != 1)?" height=\"24\"":"" %>>
					<td>
						<table cellspacing="0" cellpadding="1" border="0" class="adminTable layout" style="width:100%;">
							<col width="25">
							<col width="50">
							<col>
							<col width="40">
							...
							<col width="150">
							<tr height="25">
								<td class="AdminMenuBar" nowrap><a id="link_<%= sId %>" class="resourcebutton" style="width:15px;text-align:center;" href="javascript:showHide('<%= sId %>');"><%= (iCount != 1)?"+":"-" %></a>&nbsp;&nbsp;&nbsp;</td>
								<td class="AdminMenuBar" align="left" valign="middle"><b>Subject:</b></td>
								<td class="AdminMenuBar" align="left" valign="middle"><%= sSubj %></td>
								<td class="AdminMenuBar" align="left" valign="middle"><b>From:</b></td>
								<td class="AdminMenuBar" align="left" valign="middle"><%= sUser %> @ <%= cNote.s_cust_name %></td>
								<td class="AdminMenuBar" align="left" valign="middle"><b>Date:</b></td>
								<td class="AdminMenuBar" align="left" valign="middle"><%= sDate %></td>
							</tr>
					...
					<td>
						<table cellspacing="0" cellpadding="1" border="0" class="adminTable layout" style="width:100%;">
							...
							<tr height="25">
								...
								<td class="AdminMenuBar" align="left" valign="middle"><%= sSubj %></td>
								<td class="AdminMenuBar" align="left" valign="middle"><b>From:</b></td>
								<td class="AdminMenuBar" align="left" valign="middle"><%= sUser %></td>
								<td class="AdminMenuBar" align="left" valign="middle"><b>Date:</b></td>
								<td class="AdminMenuBar" align="left" valign="middle"><%= sDate %></td>
							</tr>
							<tr id="row_<%= sId %>"<%= (iCount != 1)?" style=\"display:none;\"":"" %>>
			...
			if (iCount == 0)
			{
				%>
				<tr>
					<td class="listItem_Title" align="left" valign="middle">There are currently no Admin Notes</td>
				</tr>
				<%
			}
			%>
...
<table cellspacing="0" cellpadding="0" width="95%" border="0">
	<tr>
		<td class="listHeading" valign="center" nowrap align="left">
			...
			<%
			sSql = "EXEC usp_chom_user_note_list_get_my @cust_id=" + cust.s_cust_id + ",@user_id="+ user.s_user_id + ",@admin=1";
			...
			while (rs.next())
			{
				...
				{
					sStatus = "Published";
					if (can.bWrite) sAction = "<a href=\"admin_note_publish.jsp?action=setdraft&note_id=" + sId + "\">Set to Draft</a>";
				}
				else
				{
					sStatus = "Draft";
					if (can.bWrite) sAction = "<a href=\"admin_note_publish.jsp?action=publish&note_id=" + sId + "\">Publish</a>";
				}
				%>
				<tr>
					<td class="listItem_Data<%= sClassAppend %>" align="left" valign="middle" width="40%"><a href="admin_note_edit.jsp?note_id=<%=sId%>"><%=sSubj%></a></td>
			...
			if (iCount == 0)
			{
				%>
				<tr>
					<td class="listItem_Title" colspan="5" align="left" valign="middle">There are currently no Admin Notes</td>
				</tr>
				<%
			}
			%>
...
{ 
	ErrLog.put(this,ex,"admin_note_list.jsp",out,1);	
}
finally
{

...
<body<% if ("false".equals(inWin)) { %> leftmargin="0" topmargin="0" marginheight="0" marginwidth="0" style="padding:0px;"<% } %> bgcolor="#303030">
<%
...
if (sNoteId != null)
{
	...
	if (eRoot != null && !eRoot.getTagName().toUpperCase().equals("ERROR"))
	{
		...
		%>
		<table cellspacing="0" cellpadding="0" width="100%" height="100%" border="0" style="background-color:#303030">
			<tr>
					...
					<table cellspacing="0" cellpadding="4" border="0" class="systemTable layout" style="width:100%; height:100%;">
						...
						<tr>
							<td align="left" valign="top" colspan="2">
								<div style="height: 60px;overflow-y: scroll;padding: 0;width: 100%;">
									<%= s_body %>
								</div>
							</td>
						</tr>

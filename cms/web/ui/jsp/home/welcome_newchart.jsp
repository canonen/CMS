	...
	var chart = new Highcharts.Chart({
      ...
      series: [{
         ...
         data: [
			...
			['Unsubs',totalUnsubsPrc],
            ['Bounced',totalBBacksPrc]
         ]
      }]
   });	
}
...
function graphBy(type, skipLoader, amount) {
	...
	$.get(fileLoc+period, function(data) {
		...
		for(var i=0;i<values.length-1;i++){
			...
			var dateLabel = periods;
			
			if(periodItems !== 'undefined' && periodItems.length > 0)
			{
				dateLabel = periodItems[2]+"/"+periodItems[1]+"/"+periodItems[0];
			}			

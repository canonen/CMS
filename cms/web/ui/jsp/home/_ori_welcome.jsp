...
<table cellpadding="0" cellspacing="0" border="0" width="100%">
	<tr>
		<td align="left" valign="middle" class="pageheader">Welcome to <%= sSysName %><%= (!isHyatt)?(", "+user.s_user_name):"" %></td>
	</tr>
</table>
<%
				...
				<tr>
					<td class="listHeading" valign="center" nowrap align="left">
						...
						<table id="Tabs_Table1" cellspacing=0 cellpadding=0 width=100% border=0>
							<tr>
								<% if (canCamp.bRead) { %><td class=<%= campClass %> id=tab1_Step1 width=100 onclick="switchSteps('Tabs_Table1', 'tab1_Step1', 'block1_Step1');" valign=center nowrap align=middle>Campaigns</td><% } %>
								<% if (canRept.bRead) { %><td class=<%= reptClass %> id=tab1_Step2 width=100 onclick="switchSteps('Tabs_Table1', 'tab1_Step2', 'block1_Step2');" valign=center nowrap align=middle>Reports</td><% } %>
								<% if (canCont.bRead) { %><td class=<%= contClass %> id=tab1_Step3 width=100 onclick="switchSteps('Tabs_Table1', 'tab1_Step3', 'block1_Step3');" valign=center nowrap align=middle>Content</td><% } %>

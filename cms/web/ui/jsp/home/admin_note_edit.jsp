...
if (sAction != null) {
	...
	if (sAction.equals("save")) {
		...
		<script language="javascript">
			location.href = "admin_note_list.jsp";
		</script>
		</head>
		<body>
		</body>
		...
		<head>
		<script language="javascript">
			location.href = "admin_note_edit.jsp?note_id=<%= sNoteId %>";
		</script>
		</head>
		<body>
		</body>
...
<BODY>
<FORM METHOD="POST" NAME="FT" ACTION="admin_note_edit.jsp" TARGET="_self">
<%
				...
				<table width=100% class=main border="0" cellspacing="1" cellpadding="2">
					...
					<tr>
						<td colspan="2" align="left" valign="middle">
							<script language="JavaScript1.2" defer>editor_generate('body');</script><textarea rows=18 cols=75 name="body"><%=(note.s_body!=null?note.s_body:"")%></textarea>
						</td>
					</tr>
				</table>
			</td>

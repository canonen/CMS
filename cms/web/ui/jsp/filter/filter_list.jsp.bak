...
<table width="100%">
	<tr>
		<td class="page_header">Segmentation</td>
	</tr>
</table>
<br>	
<div id="info">
...
<table cellspacing="0" cellpadding="0" width="10%" border="0">
	<tr>
		...
		<td class="main_button" valign="center" nowrap align="left">
			<% if (can.bWrite) { %>
			<a class="newbutton" href="filter_edit.jsp<%=(sSelectedCategoryId!=null)?"?category_id="+sSelectedCategoryId:""%>">		<img border="0" width="45" src="../../images/45_45_seg.png" onmouseout="this.src='../../images/45_45_seg.png'" onmouseover="this.src='../../images/45_45_segg.png'"><br/>New Target Group</a>&nbsp;&nbsp;&nbsp;
			<% } %>			
		</td>
		<td class="main_button" valign="center" nowrap align="left"><img width="10" src="../../images/blank.gif"/></td>
		<td class="main_button" valign="center" nowrap align="left">
...
<div id="filterBox" style="display:none;">
	...
	<table class="list_table_filter" cellspacing="0" cellpadding="2" border="0">
		<tr>
			<th class="list_name" valign="middle" align="left" colspan="2">Filter the Target Groups</th>
			<th class="list_name" valign="top" align="right" style="cursor:hand;" onclick="filterReveal(30);">&nbsp;<b>X</b>&nbsp;</th>
		</tr>
...
<div class="xboxcontent">			
			...
			<table class="listTable" width="100%" cellpadding="2" cellspacing="0">
				...
				<tr>
					...
					<th align="left" nowrap></th>
					<th align="left" nowrap></th>
					<th align="left" nowrap><img src="../../images/16_L_refresh.gif"/> <a href="#" onclick="GO(0);"><a href="#" onclick="GO(3);">Refresh</a></TH>
				</tr>	
									
					<th class="list_name" valign="middle" nowrap>Name</th>
<%
	boolean bIsPrintEnabled = CustFeature.exists(cust.s_cust_id, Feature.PRINT_ENABLED);
	if(bIsPrintEnabled)
	{
%>
					<th class="list_name" valign="middle" nowrap>Email</th>
					<th class="list_name" valign="middle" nowrap>Print</th>
<%
	}
	else
	{
%>
					<th class="list_name" valign="middle" nowrap>Records</th>
<%
	}
%>
					<th class="list_name" valign="middle" nowrap>Last update</th>
					<% if (canTGPreview) { %><th class="list_name" valign="middle" nowrap>Preview</th><% } %>
					<th class="list_name" valign="middle" nowrap>Update</th>
					<th class="list_name" valign="middle" nowrap>Update status</th>
				</tr>
<%
...
%>
				<tbody id="Id2" onclick="location.href='filter_edit.jsp?filter_id=<%=sFilterId%><%=(sSelectedCategoryId!=null)?"&category_id="+sSelectedCategoryId:"'"%>" onmouseover="do_effect('navhover')" onmouseout="do_effect('navoff')">
				<tr>

...
<div class="page_header"><fmt:message key="header_tg"/></div>
<div class="page_desc"><fmt:message key="header_tg_desc"/></div>
				...
				<TBODY>
					<TR>
						<TD noWrap align=left style="padding-left:10px; width:5%;">
							...
							&nbsp;
							<fmt:message key="button_tg"/></a>
							<% } %>	
						</TD>
						<TD noWrap align=right style="padding-right:10px;">
							<A class="newbutton" href="filter_list.jsp"><fmt:message key="button_refresh"/></A>
						</TD>
					</TR>
				</TBODY>
			</TABLE>
			
			<div class="list-headers"><fmt:message key="button_tg"/></div>
			<table class="listTable" id="example" width="100%" cellpadding="2" cellspacing="0">
				<thead>
					<th><input type="checkbox" id="checkboxall"></th>
					<th>&nbsp;</th>
				<th valign="middle" nowrap><fmt:message key="tg_column_name"/></th>
<%
...
%>
					...
					<th  valign="middle" nowrap>SMS</th>
<%
	}
	else
	{
%>
					<th valign="middle" nowrap><fmt:message key="tg_column_records"/></th>
<%
	}
%>
					<th valign="middle" nowrap><fmt:message key="tg_column_last_update"/></th>
					<% if (canTGPreview) { %><th valign="middle" nowrap><fmt:message key="tg_column_preview"/></th><% } %>
					<th valign="middle" nowrap><fmt:message key="tg_column_update"/></th>
					<th valign="middle" nowrap><fmt:message key="tg_column_update_status"/></th>
				</thead>
				<tbody>
<%
...
%>
				...
				<tr>
					...
					<td class="list_row<%= sClassAppend %>"><img src="../../images/icon_report_18_18.png" border="0" alt="" width="18" heigh="18"></td>

...
//
//    data.put("bIsPrintEnabled", bIsPrintEnabled);
    ...
    try {
        ...
        getStatistics(cust);
        data.put("getStatistics",getStatistics(cust));
        ...
        try {
            ...
            while (rs.next()) {
                ...
                sFilterName = new String(rs.getBytes(2), StandardCharsets.UTF_8);
                ...
                if (canTGPreview) {
                    if ((sRecipQty != null) && (Integer.parseInt(sRecipQty) > 0)) {
                        data.put("sRecipQtybigger0", sFilterId);
                ...
                if ((iStatusId != FilterStatus.QUEUED_FOR_PROCESSING) && (iStatusId != FilterStatus.PROCESSING)) {
                    ...
                    data.put("sSelectedCategoryIdisFilterStatus20and30", sSelectedCategoryId);


                } else if (iStatusId != FilterStatus.PROCESSING_ERROR) {
                    data.put("iStatusIdvalue140", "update");

                }


                if ("0".equals(sAprvlStatusFlag)) {
                    data.put("sAprvlStatusFlag0", sAprvlStatusFlag);


                } else if ("-1".equals(sAprvlStatusFlag)) {

                    data.put("sAprvlStatusFlag-1", "(pending campaign approval)");

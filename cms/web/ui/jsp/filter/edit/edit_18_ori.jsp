...
<HEAD>
	<TITLE><%= sTargetGroupDisplay %>: Open HTML Calculations</TITLE>
	...
	<SCRIPT>
		function do_submit()
		{
			...
			{
				alert("Zero is not a valid number for the HTML Open Count. Only recipients who opened the HTML emails can be used in calculations.")
...
%>
<INPUT type=hidden name=type_id value="<%=FilterType.READ_COUNT_WITHIN_TIME_INTERVAL%>">
...
<table id="Tabs_Table1" cellspacing=0 cellpadding=0 width=100% border=0>
	...
	<tr>
		<td class=fillTab valign=top align=center width=100%>
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle" style="padding:5px;">
						<b>Open HTML Calculations</b><br>
						Select recipients who opened a specified number of HTML emails during a specified time period.<br>
						The variable <font color="red">TODAY</font> can be used to create calculations based on the current date.<br>
						Use the <font color="red">NOT</font> option on the main edit screen to select recipients who did not open HTML emails during the time periods specified below.
					</td>
				</tr>
			</table>
			<br>
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle">Start by selecting the number of emails for which a recipient has an Open HTML read</td>
				</tr>
				<tr>
					<td align="center" valign="middle">
						The recipient opened &nbsp;
						...
						&nbsp;<input type="text" name="main_count" value="<%= HtmlUtil.escape(sMainCount) %>" size="3" onkeyup="setCalcInfo();">&nbsp;HTML emails
					</td>
				</tr>
			</table>
			<br>
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle" width="100%" colspan="2">Next, calculate the dates in which the recipient received the campaigns where they opened those <span id="open_count"><%= HtmlUtil.escape(sMainCount) %></span> HTML emails</td>
				</tr>
				<tr>
					<td align="center" valign="top" width="50%">
						<table cellspacing="0" cellpadding="2" border="0">
							...
							<tr>
								<td align="center" valign="middle">
									All recipients who opened the HTML email where the <b>difference</b> between the 
								</td>
							</tr>
							<tr>
								<td align="center" valign="middle">

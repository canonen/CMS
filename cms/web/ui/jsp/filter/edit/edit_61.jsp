...
%>
<INPUT type=hidden name=type_id value="<%=FilterType.SUBMIT_X_PERCENT_FORMS_IN_CAMPAIGNS_DURING_TIME_INTERVAL%>">
...
<table id="Tabs_Table1" cellspacing=0 cellpadding=0 width=100% border=0>
	...
	<tr>
		<td valign=top align=center width=100%>
			<table class=listTable cellspacing=0 cellpadding=0 width="100%">
				<tr>
					<th align="center" valign="middle">
						<b>Form Submission Calculations</b>
				...
				<tr>
									<td align="center" valign="middle" >
										...
										Select recipients who submitted Forms from a specified percentage of campaigns during a specified time period.<br>
			...
			<table class=listTable cellspacing=0 cellpadding=0 width="100%">
				<tr>
					<th align="center" valign="middle">Start by selecting the percentage of campaigns a recipient submitted Forms from</th>
				</tr>
				<tr>
					<td align="center" valign="middle">
						The recipient submitted Forms from&nbsp;
						...
						&nbsp;<input type="text" name="main_count" value="<%= HtmlUtil.escape(sMainCount) %>" size="3" onkeyup="setCalcInfo();">&nbsp;percent of campaigns
					</td>
				</tr>
			</table>
			<br>
			<table class=listTable cellspacing=0 cellpadding=0 width="100%">
				<tr>
					<th align="center" valign="middle" width="100%" colspan="2">Next, calculate the dates in which the recipient submitted those <span id="link_count"><%= HtmlUtil.escape(sMainCount) %></span> forms(s)</th>
				</tr>
				<tr>
					<td align="center" valign="top" width="50%">
						<table cellspacing="0" cellpadding="2" border="0">
							...
							<tr>
								<td align="center" valign="middle">
									All recipients who submitted Forms where the <b>difference</b> between the 
								</td>
							</tr>
							<tr>
								<td align="center" valign="middle">
									Form submit date and &nbsp;<input type="text" name="diff_date" value="<%= HtmlUtil.escape(sDiffDate) %>" onfocus="this.select();">&nbsp;is
								</td>
							</tr>
							<tr>
								<td align="center" valign="middle">
					...
					<td align="center" valign="top" width="50%">
						<table cellspacing="0" cellpadding="2" border="0" width="100%">
							...
							<tr>
								<td align="center" valign="middle" colspan="2">
									The Forms were submitted on dates 
								</td>
							</tr>
							<tr>

...
<table id="Tabs_Table1" cellspacing=0 cellpadding=0 width=100% border=0>
	...
	<tr>
		<td valign=top align=center width=100%>
			...
			<table class=listTable cellspacing=0 cellpadding=0 width="100%">
				<tr>
					<th align="center" valign="middle">Start by selecting the number of emails for which a recipient has an Open HTML read</th>
				</tr>
				<tr>
					<td align="center" valign="middle">
			...
			<table class=listTable cellspacing=0 cellpadding=0 width="100%">
				<tr>
					<th align="center" valign="middle" width="100%" colspan="2">Next, calculate the dates in which the recipient received the campaigns where they opened those <span id="open_count"><%= HtmlUtil.escape(sMainCount) %></span> HTML emails</th>
				</tr>
				<tr>

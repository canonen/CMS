...
<table id="Tabs_Table1" cellspacing=0 cellpadding=0 width=100% border=0>
	...
	<tr>
		<td valign=top align=center width=100%>
			...
			<table class=listTable cellspacing=0 cellpadding=0 width="100%">
				<tr>
					<th align="center" valign="middle">Start by selecting the number of bounce backs for a recipient </th>
				</tr>
				<tr>
					<td align="center" valign="middle">
			...
			<table class=listTable cellspacing=0 cellpadding=0 width="100%">
				<tr>
					<th align="center" valign="middle" width="100%" colspan="2">Next, calculate the dates the campaign was sent in which they bounced back from those <span id="bback_count"><%= HtmlUtil.escape(sMainCount) %></span> campaign(s)</th>
				</tr>
				<tr>

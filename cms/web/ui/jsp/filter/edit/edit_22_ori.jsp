...
<table id="Tabs_Table1" cellspacing=0 cellpadding=0 width=100% border=0>
	...
	<tr>
		<td class=fillTab valign=top align=center width=100%>
			...
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle" width="100%" colspan="2">Start by selecting the aggregate criteria</td>
				</tr>
				<tr>
			...
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle" width="100%" colspan="2">Next, determine the date range to apply to the aggregate criteria</td>
				</tr>
				<tr>
					<td align="center" valign="top" width="100%">
						<table cellspacing="0" cellpadding="2" border="0" width="100%">

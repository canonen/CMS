	...
	<tr>
		<td  valign=top align=center width=100%>
			...
			<table class=listTable cellspacing=0 cellpadding=0 width="100%">
				<tr>
					<th align="center" valign="middle">Start by selecting the Action the recipient performed
			...
			<table class=listTable cellspacing=0 cellpadding=0 width="100%">
				<tr>
					<th colspan=2 align="center" valign="middle" width="100%" colspan="2">Next, calculate the dates in which the recipient performed the Action</th>
				</tr>
				<tr>

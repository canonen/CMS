...
%>
<INPUT type=hidden name=type_id value="<%=FilterType.READ_X_MESSAGES_DURING_TIME_INTERVAL%>">
...
<table id="Tabs_Table1" cellspacing=0 cellpadding=0 width=100% border=0>
	...
	<tr>
		<td class=fillTab valign=top align=center width=100%>
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle" style="padding:5px;">
						...
						Select recipients who opened HTML Emails from a specified number of campaigns during a specified time period.<br>
			...
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle">Start by selecting the number of campaigns a recipient opened HTML emails from</td>
				</tr>
				<tr>

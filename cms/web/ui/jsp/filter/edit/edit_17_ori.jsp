...
%>
<INPUT type=hidden name=type_id value="<%=FilterType.CLICK_COUNT_WITHIN_TIME_INTERVAL%>">
...
<table id="Tabs_Table1" cellspacing=0 cellpadding=0 width=100% border=0>
	...
	<tr>
		<td class=fillTab valign=top align=center width=100%>
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle" style="padding:5px;">
						<b>Link Click Calculations</b><br>
						Select recipients who clicked a specified number of links during a specified time period.<br>
						The variable <font color="red">TODAY</font> can be used to create calculations based on the current date.<br>
						Use the <font color="red">NOT</font> option on the main edit screen to select recipients who did not click on links during the time periods specified below.
					</td>
				</tr>
			</table>
			<br>
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle">Start by selecting the number of links a recipient clicked on</td>
				</tr>
				<tr>
					<td align="center" valign="middle">
						The recipient clicked on&nbsp;
						...
						&nbsp;<input type="text" name="main_count" value="<%= HtmlUtil.escape(sMainCount) %>" size="3" onkeyup="setCalcInfo();">&nbsp;link(s)
					</td>
				</tr>
			</table>
			<br>
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle" width="100%" colspan="2">Next, calculate the dates in which the recipient clicked on those <span id="link_count"><%= HtmlUtil.escape(sMainCount) %></span> link(s)</td>
				</tr>
				<tr>

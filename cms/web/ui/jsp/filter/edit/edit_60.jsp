...
%>
<INPUT type=hidden name=type_id value="<%=FilterType.SUBMIT_X_FORMS_IN_CAMPAIGNS_DURING_TIME_INTERVAL%>">
	...
	<tr>
		<td valign=top align=center width=100%>
			<table class=listTable cellspacing=1 cellpadding=2 width="100%">
				...
				</tr>				<tr>					<td>						Select recipients who submitted Forms from a specified number of campaigns during a specified time period.<br>						The variable <font color="red">TODAY</font> can be used to create calculations based on the current date.<br>					</td>			</tr>
			</table>
			<br>
			<table class=listTable cellspacing=0 cellpadding=0 width="100%">
				<tr>
					<th align="center" valign="middle">Start by selecting the number of campaigns a recipient submitted Forms from</th>
				</tr>
				<tr>

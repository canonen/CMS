...
<HEAD>
	<TITLE><%= sTargetGroupDisplay %>: HTML Email Read Calculation</TITLE>
...
%>
<INPUT type=hidden name=type_id value="<%=FilterType.READ_X_PERCENT_MESSAGES_DURING_TIME_INTERVAL%>">
...
<table id="Tabs_Table1" cellspacing=0 cellpadding=0 width=100% border=0>
	...
	<tr>
		<td class=fillTab valign=top align=center width=100%>
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle" style="padding:5px;">
						<b>HTML Email Read Calculation</b><br>
						Select recipients who opened HTML Emails from a specified percentage of campaigns during a specified time period.<br>
			...
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle">Start by selecting the percentage of campaigns a recipient opened HTML emails from</td>
				</tr>
				<tr>
					<td align="center" valign="middle">
						The recipient opened HTML Emails from&nbsp;
			...
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle" width="100%" colspan="2">Next, calculate the dates in which the recipient opened those <span id="link_count"><%= HtmlUtil.escape(sMainCount) %></span> HTML Email(s)</td>
				</tr>
				<tr>

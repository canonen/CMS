...
<table id="Tabs_Table1" cellspacing=0 cellpadding=0 width=100% border=0>
	...
	<tr>
		<td valign=top align=center width=100%>
			<table class=listTable cellspacing=0 cellpadding=0 width="100%">
				<tr>
					<th align="center" valign="middle">
						<b>HTML Email Read Calculation</b>
			...
			<table class=listTable cellspacing=0 cellpadding=0 width="100%">
				<tr>
					<th align="center" valign="middle">Start by selecting the percentage of campaigns a recipient opened HTML emails from</th>
				</tr>
				<tr>
					<td align="center" valign="middle">
			...
			<table class=listTable cellspacing=0 cellpadding=0 width="100%">
				<tr>
					<th align="center" valign="middle" width="100%" colspan="2">Next, calculate the dates in which the recipient opened those <span id="link_count"><%= HtmlUtil.escape(sMainCount) %></span> HTML Email(s)</th>
				</tr>
				<tr>

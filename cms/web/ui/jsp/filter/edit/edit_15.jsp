...
<HEAD>
	<TITLE><%= sTargetGroupDisplay %>: Recipients who bounced back from a specific Campaign</TITLE>
	...
	<SCRIPT>
		...
		function setFilterName(obj)
		{
			...
			filter_form.filter_name.value = '(BBACK FROM CAMPAIGN) ' + ops[si].text;
...
%>
<INPUT type=hidden name=type_id value="<%=FilterType.BBACK_FROM_CAMPAIGN%>">
			...
			%>
				<tr>
					<td align="center" valign="middle" style="padding:10px;">
						Recipients who bounced back from a specific Campaign<br>

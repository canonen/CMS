...
//	out.println("1ttt" +ui.n_ui_type_id);
//	out.println("ssss" +bSTANDARD_UI);


//}else{

//	out.println("2ttt" +ui.n_ui_type_id);
...
%>
			<td vAlign="middle" align="left">
				<a class="savebutton" id="tgtsave" href="#" onClick="filter_save(); return false;">Save</a>
			</td>
     <% } 
		if ( (!bWorkflow
				|| (bWorkflow && can.bApprove) 
...
<%@ include file="filter_functions_zaf_test.inc"%>

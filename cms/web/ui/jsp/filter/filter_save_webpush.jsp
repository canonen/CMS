...
<table width=650 class=listTable cellspacing=0 cellpadding=0>
	<tr>
		<th>&nbsp;<b class=sectionheader><%= sTargetGroupDisplay %>:</b> Saved</th>
	</tr>
...
%> 
	<p><A href='<%= "http://" + service.getURL().getHost() +"/rrcp/imc/webpush/segment_list.jsp?cust_id="+cust.s_cust_id%>'>Back to list</A></p>
	<p><A href="filter_edit.jsp?referer=webpush&filter_id=<%=f.s_filter_id%><%=(sUsageTypeId!=null)?"&usage_type_id="+sUsageTypeId:""%><%=(sSelectedCategoryId!=null)?"&category_id="+sSelectedCategoryId:""%>">Back to edit</A></p>
<%
	}
	else
	{

...
{
    console.log(child_xml_tag,"child xml tag");
	var oResult = null;
	...
	for(var i=0; i<l; ++i)
	{
		...
		{
		    console.log(oChild,"my ochild");
			return oChild;
		}
	}
	console.log(oChild,"return oChild")
    console.log(oResult,"new result")
	return oResult;
}

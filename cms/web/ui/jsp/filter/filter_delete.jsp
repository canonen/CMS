								...
								if(referer!=null){
									...
									<script type="text/javascript">
										...
										$( document).ready(function() {
										    ...
										    var href ="http://<%=service.getURL().getHost()%>/rrcp/imc/webpush/cps/Cps_Segment_Delete.jsp?cust_id=<%=cust.s_cust_id%>&filter_id=<%=sFilterId%>";
										//	var href ="http://localhost/rrcp/imc/webpush/cps/Cps_Segment_Delete.jsp?cust_id=<%=cust.s_cust_id%>&filter_id=<%=sFilterId%>";
									...
									<a id="link" href="http://<%=service.getURL().getHost()%>/rrcp/imc/webpush/segment_list.jsp?cust_id=<%=cust.s_cust_id%>">Back to list</a><%

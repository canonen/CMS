...
<table cellspacing="0" cellpadding="0" width="95%" border="0">
	<tr>
		<td class="listHeading" valign="center" nowrap align="left">
			<table cellspacing="0" cellpadding="4" border="0" class="listTable" width="100%">
				<tr>
					<th>
						Status
					</th>
...
<table cellspacing="0" cellpadding="0" width="95%" border="0" class=listTable>
	<tr>
		<th colspan=3>
	...
	<tr>
		<td class="listHeading" valign="center" nowrap align="left">
			<table cellspacing="0" cellpadding="4" border="0" class="listTable" width="100%">
				...
				<tr>
					<td align="center" valign="middle" style="padding:10px;">
						<p><font color="red"><b>To access this page you need tbe Revotas Plus User </b></font>
						<br><br>To upgrade your system contact us <a href="mailto:operasyon@revotas.com">operasyon@revotas.com</a></p>
					</td>
				</tr>
			</table>
		</td>

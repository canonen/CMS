...
<%
	...
	try{
           url  = new URL("http://" + service.getURL().getHost() +"/rrcp/imc/home/wizard_stats.jsp?opt="+opt+"&custid="+cid);
          //url  = new URL("http://rcp1.revotas.com/rrcp/imc/home/wizard_stats.jsp?opt="+opt+"&custid="+cid);

...
<body style="margin:0;background-color:#FFFFFF">
		...
		<a href="selecttemplate.jsp" class="zbuttons zbuttons-normal zbuttons-green mta5">
			...
			<span class="zlabel">Yeni ?çerik Yarat</span>
		</a>
<br>
<table class="list-table dtables" width="100%" cellspacing="0" cellpadding="0">
	<thead>
	<tr>
		<th align="left" nowrap>?çerik Ad?</th>
		<th align="left" nowrap>Kullan?lan ?ablon</th>
...
<tr>
	...
	<%=(!status.equals("locked"))?("<a class=\"btn btn-danger\" href=\"\" onClick=\"if( confirm('Silmek istedi?inize emin misiniz ?') ) href='pagedelete.jsp?contentID="+contentID+"'\">Sil</a>"):("")%>
	</td>
	<% if ("0".equals(isHyatt)) { %>
	<td class="listItem_Data<%=sClassAppend%>" align=center>
	...
	<% 	} else { %>
		<a class="subactionbutton" href="uncommit.jsp?contentID=<%= contentID %>&templateID=<%= templateID %>">Onay? Kald?r</a>
	<% 	}
		} else { %>
	&nbsp;
	<%	} %>

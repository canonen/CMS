				...
				<tr>
					...
					<td align="center" valign="middle">
						<table cellspacing="0" cellpadding="0" border="0" width="100%">
							...
							<tr>
								<td><iframe style="width:100%;height:350px;overflow-y:scroll;overflow-x:hidden" src="<%= contEditFrame %>" border="0" name="selectContent" frameborder="0" scrolling="auto" id="selectContent"></iframe></td>
							</tr>
						</table>
					</td>
				</tr>

...
<body>
	...
	%>
	<div id="wrapper">
	<div id="topLogo"><img src="http://cms.revotas.com/cms/ui/ooo/images/nav/rminilogo.png" border="0"/></div>
	<ul id="tabnav">
				<li>
				...
				<li>
					<a class="<%if(activeTab.equals("help"))out.println("active");%>" href="../mini/help.jsp?a=help">Yard?m</a>
				</li>
			</ul>

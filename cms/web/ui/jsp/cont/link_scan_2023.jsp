...
<form name="FT" method="post" action="link_scan_save.jsp">
    ...
    <table cellpadding="4" cellspacing="0" border="0">
        <tr>
            <td vAlign="middle" align="left">
                <% if (linkCount != 0) { %>
                <a class="savebutton" href="javascript:SubmitPrepare();"/><fmt:message key="link_scan_btn_save_to_content"/></a>
                <% } else { %>
                <a class="savebutton" href="cont_edit.jsp?cont_id=<%= contID %>"><fmt:message key="link_scan_btn_back_to_edit"/></a>
                <br><br>
    ...
    <table width=650 class=listTable cellspacing=0 cellpadding=0>
        <tr>
            <th>&nbsp;<b class=sectionheader>Step 1:</b> <fmt:message key="link_scan_step1_header"/> <%= contName %></th>
        </tr>
                ...
                <table width="100%" class="" cellspacing="0" cellpadding="0">
                    <tr>
                        <td valign="center" align="middle" style="padding:10px;">
                            <fmt:message key="link_scan_step1_desc"/>
                        </td>
                    </tr>
                </table>
                <br>

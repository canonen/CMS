...
<%
	...
	// Sinan CELIK 07-01-2019 DROP Clone
		String OLD_DROP_CONT_ID=null;
		String NEW_DROP_CONT_ID=null;
	...
	{
		// Sinan CELIK 07-01-2019 DROP Clone
		OLD_DROP_CONT_ID=cont.s_cont_id;
	...
	// Sinan CELIK 07-01-2019 DROP Clone
		 NEW_DROP_CONT_ID=cont.s_cont_id;	
		 
		if(iActionSave==SAVE_AS_NEW && !OLD_DROP_CONT_ID.equals("") && OLD_DROP_CONT_ID!=null && !NEW_DROP_CONT_ID.equals("") && NEW_DROP_CONT_ID!=null  ){
			...
			String SQL="EXEC [zcs_EmailBuilder_Clone] @old_cont_id="+OLD_DROP_CONT_ID+", @new_cont_id="+NEW_DROP_CONT_ID+" ";

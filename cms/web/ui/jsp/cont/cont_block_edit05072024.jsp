...
// Check the text
	console.log(FT);
	if(document.querySelector("#newContent")){
		if(document.querySelector("#newContent").value.length == 0){
			alert("You have to enter something to the Text field");
			return;
		}
	}
	if(document.querySelector("#newContent1")){
		if(document.querySelector("#newContent1").value.length == 0){
			alert("You have to enter something to the Text field");
			return;
		}
	}

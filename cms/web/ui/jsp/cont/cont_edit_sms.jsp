...
function undisable_forms()
{
	...
	for(var i=0; i < l; i++)
	{
     ...
     FT.action = "cont_save_sms.jsp"      //disable_forms clears this out (I think)
}
...
<script language="javascript" src="https://code.jquery.com/jquery-3.2.1.js"></script>
 ...
 $(document).ready(function(){
	...
	var karakter_count= $("#ContentText").val().length;
	 
	 $("#count_message1").text("Kullanilan Karakter Sayisi: " + karakter_count );
	 
 $("#ContentText").keyup(function(){
	 if($(this).val().length<160){
		 $("#count_message1").text("Kullanilan Karakter Sayisi: " + $(this).val().length );
		 $("#count_message2").text("Kalan Karakter Sayisi: " + (160 - $(this).val().length));
		 
	 }else{
		 
		 $("#count_message2").text("Bir Mesaj sinirin gecti " + ( $(this).val().length));
	 }
...
<% if (can.bWrite) { %>
	<tr>
		<td valign="middle">
			...
			<input type=hidden name=ctiDocID value="1">
			...
			<input type="hidden" name="contTypeID" value="40"/>
				...
				<tr>
					<td valign=top align=center width="100%" colspan=4>
						<table  cellspacing=1 cellpadding=2 width=100%>
							<tr>
								<td align="center">
									<br>Enter SMS Content Here<br>
									<textarea rows="11" name="ContentText" id="ContentText" cols="60" style="width: 505; height: 231"><%= HtmlUtil.escape(contText) %></textarea>
									<br><br>
									<span style="font-family: Tahoma; font-size: 11px;  font-weight: bold; padding: 6px;" id="count_message1"></span><br/>
									 <span style="font-family: Tahoma; font-size: 11px;  font-weight: bold; padding: 6px;" id="count_message2"></span> 
									<br>
									<br>
								</td>
							</tr>
...
<a class="resourcebutton" onclick="CKEDITOR.instances.ContentHTML.execCommand('source');" href="javascript:void(null);"/>Switch Mode</a></div>
	...
	toolbar :
			...
			<!--- Step 4 Header----->
			<table style="display:none;" width="750px" class=listTable cellspacing=0 cellpadding=0>
				<tr>

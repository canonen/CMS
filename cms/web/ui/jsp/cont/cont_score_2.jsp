...
<%	
    	...
    	byte[] ss = subj_html.getBytes("UTF-8");
    	String newS =  new String(ss, "UTF-8");

%>

<table width=100% cellspacing=0 cellpadding=0>
  <tr><td><table class=main width=100% cellspacing=1 cellpadding=3 border=0>
            <tr><td><b>From</b>: <%= URLDecoder.decode(from, "UTF-8") %><br><b>Subject</b>: <%= newS %><object width=100%><p><%= previewHtml %></object></td></tr>
          </table></td></tr>
</table> 
<%
	}

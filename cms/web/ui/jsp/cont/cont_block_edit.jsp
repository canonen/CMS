...
// Check the text
	console.log(FT);
		...
		if(document.querySelector("#newContent").value.length == 0 && document.querySelector("#newContent1").value.length == 0){
...
function scanContentForPers(attrID) {
	...
	var vtext = document.querySelector("#newContent").value;
	var vhtml = document.querySelector("#newContent1").value;
	...
	if(vhtml != null && vhtml.length != 0) {
		document.querySelector("#newContent1").value = replacePers(vhtml,attrName,newDefault);
	}
...
<table width=700 class=listTable cellspacing=0 cellpadding=0>
	<tr>
		<th class=sectionheader>&nbsp;<b class=sectionheader>Step 1:</b> Name Your Content Element</th>
	</tr>
...
<table width=700 class=listTable cellspacing=0 cellpadding=0>
	<tr>
		<th colspan=3 class=sectionheader>&nbsp;<b class=sectionheader>Step 2:</b> Personalize Your Content Element</th>
	</tr>
	<tr>
	...
	<tr>
		<td valign=top align=left width=650 colspan=3>
			<table class="" cellpadding="2" cellspacing="1" width="100%">
				<tr>
	...
	<tr>
		<td valign=top align=left width=650 colspan=3>
			<table class="" width="100%" cellpadding="2" cellspacing="1">
				<tr>
...
<table width=700 class=listTable cellspacing=0 cellpadding=0>
	<tr>
		<th colspan=4 class=sectionheader>&nbsp;<b class=sectionheader>Step 3:</b> Enter Your Content</th>
	</tr>
	<tr>
	...
	<tr>
		<td class=Tab_ON id=tab3_Step1 width=200 onclick="toggleTabs('tab3_Step','block3_Step',1,3,'Tab_ON','Tab_OFF');" valign=center nowrap align=middle><b>Text</b></td>
		<td class=Tab_OFF id=tab3_Step2 width=200 onclick="toggleTabs('tab3_Step','block3_Step',2,3,'Tab_ON','Tab_OFF');" valign=center nowrap align=middle><b>HTML</b></td>
			...
			<table cellspacing=0 cellpadding=2 width=100%>
				<tr>
					<td align="center">
						...
						<textarea rows="11" id="newContent" name="ContentText" cols="60" style="width: 505; height: 231"><%= WebUtils.convertToByteSymbolSequence(contText) %></textarea>
						<br><br>
						<a class="subactionbutton" href="javascript:WinOpen(document.querySelector("#newContent").value, FT.UnsubContentText.value, '1')">Preview Text</a>
						<br>
						<br>
					</td>
				</tr>
			...
			<table cellspacing=1 cellpadding=2 width=100%>
				<tr>
					<td width="625" align="center">
						...
						<textarea rows="11" id="newContent1" name="ContentHTML" cols="60" style="width: 505; height: 231"><%= WebUtils.convertToByteSymbolSequence(contHTML) %></textarea>
						<br><br>
						<a class="subactionbutton" href="javascript:WinOpen(document.querySelector("#newContent1").value, FT.UnsubContentHTML.value, '2')">Preview HTML</a>
						<br>
						<br>
					</td>
				</tr>

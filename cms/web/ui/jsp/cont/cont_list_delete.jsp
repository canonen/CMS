...
htmlContentChild +=
	...
	"\">" + new String(rs3.getBytes(2),"UTF-8")+"</a></td>\n";
			...
			htmlContentDT += "<td class=\"list_row" + sClassAppend + "\"><img src=\"../../images/icon_report_18_18.png\" border=\"0\" alt=\"\"></td>";
...
<link rel="stylesheet" href="http://datatables.net/release-datatables/media/css/demo_table_jui.css" TYPE="text/css">
<link rel="stylesheet" href="http://datatables.net/media/css/jui_themes/start/jquery-ui-1.7.2.custom.css" TYPE="text/css">
...
<div class="page_header">Content</div>
<div class="page_desc">Create the content to be sent in your campaigns.</div>	
<div id="info">
<div id="xsnazzy">
			...
			<table cellpadding="3" cellspacing="0" border="0" width="95%">
				<tr>
					...
					<TD noWrap align=right style="padding-right:10px;">
						<A class="newbutton" href="cont_list.jsp">Refresh</A>
					</TD>
				</tr>
			</table>				

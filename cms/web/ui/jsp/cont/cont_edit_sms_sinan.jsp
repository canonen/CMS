...
<script language="javascript" src="https://code.jquery.com/jquery-3.2.1.js"></script>
 ...
 $("#ContentText").keyup(function(){
	 if($(this).val().length<160){
		 $("#message").text("Karakter Sayisi: " + (160 - $(this).val().length));
		 
	 }else{
		 
		 $("#message").text("Ikinci Mesaj olarak iletilecek " + ( $(this).val().length));
	 }
						...
						<table  cellspacing=1 cellpadding=2 width=100%>
							<tr>
								<td align="center">
									...
									<br><br>
									<span style="color:red; font-size:14px;" id="message"></span>

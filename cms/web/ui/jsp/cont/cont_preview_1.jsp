...
<body>
<form name="FT" method="post" target="preview" action="cont_preview_2.jsp">
...
<table width="100%" class="listTable" cellspacing="0" cellpadding="0">
	<tr>
		<th colspan=2 class="sectionheader">&#x20;<b class="sectionheader">Step 2:</b> Enter Values To Preview</th>
	</tr>
	<%= htmlValues %>
</table>
...
<table width="100%" class="lisTable" cellspacing="0" cellpadding="0">
	<tr>
		<th class="sectionheader">&#x20;<b class="sectionheader">Step 3:</b> Preview Content</th>
	</tr>
</table>
<br/>

<center>
<a class="subactionbutton" href="javascript:SubmitPrepare(1);">Preview Text</a>

<a class="subactionbutton" href="javascript:SubmitPrepare(2);">Preview HTML</a>
<!--

<a class="subactionbutton" href="javascript:SubmitPrepare(3);">Preview AOL</a>
//-->
</center>
</form>
</body>

...
<script type="text/javascript" src="/cms/ui/js/CKEditor/cy_ckeditor.js"></script>
	...
	<tr>
		<td valign="middle">
			...
			<table width="100%" class=listTable cellspacing=0 cellpadding=0>
				<tr>
					<th colspan=3><b class=sectionheader>Step 1:</b> <fmt:message key="header_content_step1"/></th>
				</tr>
			...
			<table width="750px" class=listTable cellspacing=0 cellpadding=0>
				...
				<tr>
					<td colspan=4 align="right">
						<a class="resourcebutton" href="javascript:PreviewURL('../form/form_list_url.jsp')">Link to a Revotas hosted form</a>
						<a class="resourcebutton" href="javascript:LibraryURL('../image/folder_details_url.jsp')">Insert a Revotas-hosted image URL</a>
					</td>
				</tr>
						...
						<table cellspacing=1 cellpadding=2 width=100%>
							<tr>
								<td align="center">
									...
									<br><br>
									<a class="subactionbutton" href="javascript:WinOpen(CKEDITOR.instances.ContentHTML.getData(), '2');"/>Preview HTML</a>
								<%
								if (canDynCont)
								{
									%>

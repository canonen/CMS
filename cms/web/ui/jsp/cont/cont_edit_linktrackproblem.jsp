...
<%
	...
	try
	{
		...
		if (contID!=null)
		{
			...
			while (rs.next())
			{
				htmlTracking += "<tr>aaaaa";
				htmlTracking += (bShowButton?"<td align=\"right\" valign=\"middle\" nowrap><a class=\"subactionbutton\" href=\"#EditLink\" onclick=\"EditLinkTable(event)\">edit</a></td>ddddddd":"");
				b = rs.getBytes(1);
				
				htmlTracking += "<td align=\"left\" valign=\"middle\">"+((b==null)?"":new String(b,"UTF-8"))+"</td>cccccc";
				htmlTracking += "<td align=\"left\" valign=\"middle\"><div style=\"overflow:hidden; text-overflow:ellipsis;\"><a title=\"Click here to verify that your link is valid.\" href=\"javascript:void(0);\" onclick=\"launchURL();\">"+HtmlUtil.escape(rs.getString(2))+"</a></div></td>vvvvvv";
				htmlTracking += (bShowButton?"<td align=\"right\" valign=\"middle\" nowrap><a class=\"resourcebutton\" href=\"#EditLink\" onclick=\"CloneLinkTable(event)\">clone</a></td>dddddddddddddddd":"");
				htmlTracking += (bShowButton?"<td align=\"right\" valign=\"middle\" nowrap><a class=\"resourcebutton\" href=\"javascript:void(0);\" onclick=\"DeleteLinkTable(event)\">delete</a></td>xxxxxx":"");
				htmlTracking += "</tr>zzzzzz";
			}
			rs.close();
		}
	...
	<tr>
		<td valign="middle">
			...
			<table width="100%" class=listTable cellspacing=0 cellpadding=0>
				<tr>
					<th colspan=3><b class=sectionheader>Step 1:</b> Name Your Content</th>
				</tr>
...
<% } else { %>
			...
			<table width="750px" class=listTable cellspacing=0 cellpadding=0>
				<tr>
					<th class=sectionheader><b>Step 2:</b> Personalize Your Content</th>
				</tr>
	...
	<tr>
		<td valign="top">
			...
			<table id="Tabs_Table2" class=listTable cellspacing=0 cellpadding=0 width="100%" border=0>
				<tr>
					<td class=Tab_ON id=tab2_Step1 width=150 onclick="toggleTabs('tab2_Step','block2_Step',1,2,'Tab_ON','Tab_OFF');" valign=center nowrap align=middle><b>Available Options</b></td>
					<td class=Tab_OFF id=tab2_Step2 width=150 onclick="toggleTabs('tab2_Step','block2_Step',2,2,'Tab_ON','Tab_OFF');" valign=center nowrap align=middle><b>Current Personalization</b></td>
			...
			<table width="750px" class=listTable cellspacing=0 cellpadding=0>
				<tr>
					<th  colspan=4><b>Step 3:</b> Enter Your Content</th>
				</tr>
				<tr>
				...
				<tr style="background-color:#F2F2F2">
					<td class=Tab_ON id=tab3_Step1 width=150 onclick="toggleTabs('tab3_Step','block3_Step',1,2,'Tab_ON','Tab_OFF');" valign=center nowrap align=middle><b>Text</b></td>
					<td class=Tab_OFF id=tab3_Step2 width=150 onclick="toggleTabs('tab3_Step','block3_Step',2,2,'Tab_ON','Tab_OFF');" valign=center nowrap align=middle><b>HTML</b></td>
			...
			<table width="750px" class=listTable cellspacing=0 cellpadding=0>
				<tr>
					<th class=sectionheader><b class=sectionheader>Step 4:</b> Define Tracking Links</th>
				</tr>
	...
	<tr>
		<td valign="top">
			...
			<table id="Tabs_Table4" cellspacing=0 cellpadding=0 border=0 class="listTable" style="width:100%; height:100%;">
				...
				<tr>
					<td class=Tab_ON id=tab4_Step1 onclick="toggleTabs('tab4_Step','block4_Step',1,2,'Tab_ON','Tab_OFF');" valign=center nowrap align=middle><b>Link Scanning</b></td>
					<td class=Tab_OFF id=tab4_Step2 onclick="toggleTabs('tab4_Step','block4_Step',2,2,'Tab_ON','Tab_OFF');" valign=center nowrap align=middle><b>Advanced Options</b></td>
...
<% } %>
			...
			<table width=750px class=listTable cellspacing=0 cellpadding=0>
				<tr>
					<th colspan=4 class=sectionheader>&nbsp;<b class=sectionheader>History</b></th>
				</tr>

...
<%
	...
	if (iActionSave == SAVE_RETURN) sRedirectUrl = "cont_edit_sms.jsp?cont_id=" + cont.s_cont_id;
	else if (iActionSave == DYNAMIC_PREVIEW) sRedirectUrl = "cont_edit_sms.jsp?popup=true&cont_id=" + cont.s_cont_id;
...
<% if (iActionSave!=SAVE_TO_DEST) { %>
						<P align="center">
							<a href="cont_edit_sms.jsp?cont_id=<%=cont.s_cont_id%><%=(sSelectedCategoryId!=null)?"&category_id="+sSelectedCategoryId:""%>">

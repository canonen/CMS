	...
	<tr>
		<td valign="top">
			...
			<table width="750px" class=listTable cellspacing=0 cellpadding=0>
				...
				<tr>
					<td colspan=4 align="center">
						HTML Creator from Image <a class="resourcebutton" href="javascript:LibraryURL('../image/imagetohtml.jsp')">Select Image</a>
					</td>
				</tr>
						...
						<table cellspacing=1 cellpadding=2 width=100%>
							<tr>
								...
								%>
									...
									var CKEDITOR_BASEPATH = '/cms/ui/js/CKEditorStandart/';
</script>
									<script type="text/javascript">
											//<![CDATA[

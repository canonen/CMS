        ...
        while ((myPart = mp.readNextPart()) != null)
        {
            ...
            if (myPart.isFile())
            {
                ...
                if (sProcessedMsg.equalsIgnoreCase("success")) {
                    ...
                    String path ="C:/Revotas/cms/web/ui/images/"+cust.s_cust_id+"/"+sFileName;
                    //CDN de bulunmasi istenen uzanti
                    String url = "ui/images/"+cust.s_cust_id+"/"+sFileName;
                    ...
                    String DOMAIN_URL ="'https://revocdn.revotas.com/cms/ui/images/%s/%s'";
                    DOMAIN_URL = String.format(DOMAIN_URL,cust.s_cust_id,sFileName);

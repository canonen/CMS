...
<table cellpadding="3" cellspacing="0" border="0" width="95%">
	<tr>
		...
		<td vAlign="middle" align="left" nowrap>
			<a class="newbutton" href="image_new.jsp?<%=(sSelectedCategoryId!=null)?"&category_id="+sSelectedCategoryId:""%>">New Image</a>&nbsp;&nbsp;&nbsp;
		</td>
		<td vAlign="middle" align="left" nowrap>
			<a class="newbutton" href="folder_new.jsp">New Folder</a>&nbsp;&nbsp;&nbsp;
		</td>
		<td vAlign="middle" align="left" nowrap>
			<a class="newbutton" href="image_zip_upload.jsp">Upload ZIP File</a>&nbsp;&nbsp;&nbsp;
		</td>
		<% } 
		if (ui.n_ui_type_id != UIType.HYATT_USER) { %>
		<td valign="middle" align="left" nowrap>
			&nbsp;&nbsp;&nbsp;<a class="resourcebutton" href="javascript:PreviewURL('folder_details_url.jsp');">URL Generator</a>&nbsp;&nbsp;&nbsp;
		</td>
		<% } %>

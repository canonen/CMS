...
<!--- Step 1 Header----->
<table width="<%= tabWidth %>" class="main" cellspacing="0" cellpadding="0">
	<tr>
...
<br>
<!---- Step 1 Info----->
<table id="Tabs_Table1" cellspacing="0" cellpadding="0" width="<%= tabWidth %>" border="0">
	<tr>
...
<table width="<%= tabWidth %>" class="main" cellspacing="0" cellpadding="0">
	<tr>
		<td class="sectionheader">&nbsp;<b class="sectionheader">Step 2:</b> Upload your Image</td>
	</tr>
</table>
<br>
<!---- Step 2 Info----->
<table id="Tabs_Table2" cellspacing="0" cellpadding="0" width="<%= tabWidth %>" border="0">
	<tr>
		<td class="EmptyTab" valign="center" nowrap align="middle" width="100%"><img height=2 src="../../images/blank.gif" width=1></td>
	</tr>
	<tr>
	...
	<tr>
		<td class="fillTab" valign="top" align="center" width="100%">
			<table class="main" cellspacing="1" cellpadding="2" width="100%" id="fileTable">
				<tr>
...
<br>
<!---- Step 3 Info----->
<table id="Tabs_Table3" cellspacing="0" cellpadding="0" width="<%= tabWidth %>" border="0">
	<tr>
		<td class="EmptyTab" valign="center" nowrap align="middle" width="100%"><img height=2 src="../../images/blank.gif" width=1></td>
	</tr>
	<tr>

...
String sql = "use brite_ainb_500 " + "select emailFrom as id,count(*) as sayi from mail_pmta_acct with (nolock) " + "where campId=1 and custId="+ CUSTOMER_ID + "group by emailfrom order by sayi desc ";

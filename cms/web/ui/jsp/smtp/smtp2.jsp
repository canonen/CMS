...
String sql = "use mail_pmta_accounting " + "select sum(sent) as total_sent, CONVERT(CHAR(7), create_date, 120) as mydate from mail_camp_summary with (nolock) " + "where create_date > '2017-05-31' AND cust_id="+ CUSTOMER_ID + "group by CONVERT(CHAR(7), create_date, 120) order by mydate desc ";
...
%>
	<tr>
		<td class="list_row<%= sClassAppend %>" center width="19%"><%= rss.getString("mydate") %></td>
		<td class="list_row<%= sClassAppend %>" center width="19%"><%= rss.getString("total_sent") %></td>
	</tr>		
</tr>	
<%
}

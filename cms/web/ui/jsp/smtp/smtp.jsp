...
if(CUSTOMER_ID.equals("900")){

	sql = "use brite_ainb_500 " + "select emailFrom as id,count(*) as sayi from mail_pmta_acct with (nolock) " + "where campId=0 and emailFrom like '%@reiskuyumculuk.com' group by emailfrom order by sayi desc ";
	...
	sql = "use brite_ainb_500 " + "select emailFrom as id,count(*) as sayi from mail_pmta_acct with (nolock) " + "where recipid=13 and custId="+ CUSTOMER_ID + " group by emailfrom order by sayi desc ";

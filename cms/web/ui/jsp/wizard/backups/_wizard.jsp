...
<HEAD>
	 ...
	 function Wizarddisable_all_tab_pages(tab_id)
	 {
	 	...
	 	{
	 		if (tab.cells(i).className == "SpecialTabOn")
	 		{
	 			tab.cells(i).className = "SpecialTabOff";
	 		}
	 	}
		...
		if (stepNum == "4") {
			...
			if (null != CONT_ID)
			{
				if( !CONT_ID.equals(""))
				{
					%>
					if (stepNum == "3")	{
						document.frames("selectContent").document.location.href = "/cms/ui/jsp/ctm/pageedit.jsp?isEdit=true&contentID=<%= WizardID %>";
					}
					<%
				}
			}
...
<table cellspacing="0" cellpadding="0" border="0" class="wizardLayout">
	<col>
<%
if (can.bWrite)
{
			...
			<table cellspacing=0 cellpadding=0 width="100%" border=0>
				...
				<tr>
					<td class=fillTab valign=top align=center width="100%">
						<table cellspacing="1" cellpadding="0" border="0" width="100%" class="main">
							<tr>
...
<table id=Tabs_Table1 cellspacing=0 cellpadding=0 border=0 class="wizardLayout">
	<col>
	<col>
	<col>
	<col>
	<col>
	<tr height="20">
		<td class="<%= classStep1 %>" id="tab1_Step1" valign="center" nowrap align="middle" onclick="moveSteps('1');">1. Campaign Name</td>
		<td class="<%= classStep2 %>" id="tab1_Step2" valign="center" nowrap align="middle" onclick="moveSteps('2');">2. Audience</td>
		<td class="<%= classStep3 %>" id="tab1_Step3" valign="center" nowrap align="middle" onclick="moveSteps('3');">3. Content</td>
		<td class="<%= classStep4 %>" id="tab1_Step4" valign="center" nowrap align="middle" onclick="moveSteps('4');">4. Send Campaign</td>
		<td class="<%= classStep5 %>" id="tab1_Step5" valign="center" nowrap align="middle" onclick="moveSteps('5');">Logs</td>
	</tr>
	<tr height="20">
		<td colspan="5">&nbsp;</td>
	</tr>
	...
	<tr height="20">
		<td class=sectionheader valign=middle align=center colspan=5><b>Step 1:</b> Enter Your Campaign Name</td>
	</tr>
	<tr height="150">
		<td class=fillTab valign=top align=center colspan=5>
			<table class="wizardLayout main" cellspacing=1 cellpadding=10 align=center border=0>
				<col width="135">
				<col>
				<col width="135">
				<tr>
					<td align="left" valign="middle" nowrap>
						<p align="right" class="prevDisabled"><< Previous Step</p>
						<p align="right">&nbsp;</p>
					</td>
					<td align="center" valign="middle">
						...
						<p><INPUT TYPE="text" NAME="camp_name" value="<%=CAMP_NAME%>" SIZE="40" MAXLENGTH="50"></p>
					</td>
					<td align="right" valign="middle" nowrap>
						<p align="left" class="nextActive">Next Step >></p>
	...
	<tr height="20">
		<td class=sectionheader valign=middle align=center colspan=5><b>Step 2:</b> Select Your Audience</td>
	</tr>
	<tr height="150">
		<td class=fillTab valign=top align=center colspan=5>
			<table class="wizardLayout main" cellspacing=1 cellpadding=10 align=center border=0>
				...
				<tr>
					<td align="left" valign="middle" nowrap>
						<p align="right" class="prevActive"><< Previous Step</p>
	...
	<tr height="20">
		<td class=sectionheader valign=middle align=center colspan=5><b>Step 3:</b> Create Your Content</td>
	</tr>
	<tr>
		<td class=fillTab valign=top align=center colspan=5>
			<table class="wizardLayout main" cellspacing=1 cellpadding=10 align=center border=0>
				...
				<tr>
					...
					<td align="center" valign="middle">
						<table cellspacing="0" cellpadding="0" border="0" class="wizardLayout">
							...
							<tr>
								<td><iframe style="width:100%;height:100%;" src="<%= contEditFrame %>" frameborder="0" scrolling="yes" id="selectContent"></iframe></td>
							</tr>
						</table>
					</td>
				</tr>
	...
	<tr height="20">
		<td class=sectionheader valign=middle align=center colspan=5><b>Step 4:</b> Send Your Campaign</td>
	</tr>
	<tr>
		<td class=fillTab valign=top align=center colspan=5>
			<table class="wizardLayout main" cellspacing=1 cellpadding=10 align=center border=0>
				...
				<tr>
					...
					<td align="center" valign="middle">
						<table class="wizardLayout main" cellspacing=1 cellpadding=2>
							<col width="150">
							<col>
							<tr height="30">
								<td colspan=2>
									<table cellspacing="0" cellpadding="4" width="100%">
										<tr>
											<td align="left" valign="middle" nowrap>
												...
												{
												%>
													<a class="actionbutton" href="#" onclick="send_test();">Send A Test</a>
												<%
												}
												%>
											</td>
											<td align="right" valign="middle" nowrap>
												...
												{
												%>
													<a class="actionbutton" href="#" onclick="send();"><%= (isHyatt)?"Request Approval":"Launch Campaign" %></a>
												<%
												}
												%>
											</td>
							...
							<tr height="25">
								<td nowrap>From Name / From Address </td>
								<td>
									<input type="text" name="from_name" value="<%=FROM_NAME%>" size="40" maxlength="50"><select name="from_address_id" size="1">
							...
							<tr height="25">
								...
								<td>
									<input type="text" name="subj_html" value="<%=SUBJ_HTML%>" size="40" maxlength="150">
								</td>
							</tr>
							<tr height="25">
								<td nowrap>Response Forwarding</td>
								<td nowrap>
									<input type="text" name="response_frwd_addr" value="<%=RESPONSE_FRWD_ADDR%>" size="40" maxlength="255"<%=(isHyatt?" onChange=\"FT.reply_to.value=this.value\"":"")%>>
								</td>
							</tr>
							<tr height="25">
...
<iframe id="prevContent" style="width:100%; height:100%;" src="<%=sIframeSrc%>" frameborder="0" scrolling="yes"></iframe>
	...
	<tr>
		<td style="padding: 5px;" valign="top" colspan="5">
			<table id="Tabs_Table6" class="layout" style="width:100%; height:100%;" cellspacing=0 cellpadding=0 border=0>
				<col width="150">
				<col width="150">
				<col width="150">
				<col>
				<tr height="22">
					<td class=EditTabOn id=tab6_Step1 onclick="switchSteps('Tabs_Table6', 'tab6_Step1', 'block6_Step1');" valign=center nowrap align=middle>Campaign History</td>
					<td class=EditTabOff id=tab6_Step2 onclick="switchSteps('Tabs_Table6', 'tab6_Step2', 'block6_Step2');" valign=center nowrap align=middle>Testing History</td>
					<td class=EditTabOff id=tab6_Step3 onclick="switchSteps('Tabs_Table6', 'tab6_Step3', 'block6_Step3');" valign=center nowrap align=middle>User History</td>
					<td class="EmptyTab" valign="center" nowrap align="middle">&nbsp;</td>
				</tr>
				<tr height="2">
					<td class=fillTabbuffer valign=top align=left colspan=4><img height=2 src="../../images/blank.gif" width=1></td>
				</tr>
				<tbody class=EditBlock id=block6_Step1>
				<tr>
					<td class=fillTab valign=top align=center colspan=4>
				...
				<tr>
					<td class=fillTab valign=top align=left colspan="4">
						<table class="main" cellspacing="1" cellpadding="3" width="100%" border="0">
							<tr>

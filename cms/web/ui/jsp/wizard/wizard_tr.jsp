...
//			"	p.queue_date " +
	...
	String filterHtml_s4 = "Hedef Grup Seçilmedi";
			...
			<table cellpadding="1" cellspacing="0" border="0">
				...
				if( !isDone && !isSending && !isTesting)
				{
					...
					<td vAlign="middle" align="left">
						<a class="savebutton" href="#" onclick="save();">Kaydet</a>
					</td>
					<td vAlign="middle" align="left">
						<a class="savebutton" href="#" onclick="savenexit();">Kaydet &amp; Çık</a>
					</td>
					<%
				}
				...
				if( CAMP_ID != null )
				{
					%>
					<td vAlign="middle" align="left">
						<a class="savebutton" href="#" onclick="clone();">Kopyala</a>
					</td>
					<%
				}
				%>
...
<table id="Tabs_Table1" class="listTable" cellspacing="0" cellpadding="0" width="100%">
	<tr>
		<td width="%20" class="<%= classStep1 %>" id="tab1_Step1" valign="center" nowrap align="middle" onclick="moveSteps('1');">1. Kampanya Adı</td>
		<td width="%20" class="<%= classStep2 %>" id="tab1_Step2" valign="center" nowrap align="middle" onclick="moveSteps('2');">2. Hedef Grup Seçimi</td>
		<td width="%20" class="<%= classStep3 %>" id="tab1_Step3" valign="center" nowrap align="middle" onclick="moveSteps('3');">3. İçerik</td>
		<td width="%20" class="<%= classStep4 %>" id="tab1_Step4" valign="center" nowrap align="middle" onclick="moveSteps('4');">4. Kampanyayı Başlat</td>
		<td width="%20" style="border-right:none;" class="<%= classStep5 %>" id="tab1_Step5" valign="center" nowrap align="middle" onclick="moveSteps('5');">Geçmiş Kayıtlar</td>
	</tr>
	<tr>
		<td colspan="5">&nbsp;</td>
	</tr>
	...
	<tr >
		<td class="stepHeaders" valign="middle" align="center" colspan=5><b>Basamak 1:</b> Kampanyanızı adlandırın</td>
	</tr>
	<tr>
			...
			<table width="100%" cellspacing=1 cellpadding=10 align=center border=0>
				<tr>
					<td width="150" align="left" valign="middle" nowrap class="prevborder">
						<p align="right" class="prevDisabled">&laquo; Önceki</p>
						<p align="right">&nbsp;</p>
					</td>
					<td align="center" valign="middle">
						<p>Aşağıda ki kutucuğa yeni bir kampanya ismi girin. Kampanyaları ayrıştırabilmeniz için kampanyanıza eşsiz bir isim verin.<br>Bu isim raporlama bölümünde gözükecektir.</p>
					...
					<td align="right" width="150px" valign="middle" nowrap class="nextborder">
						<p align="left" class="nextActive">Sonraki &raquo;</p>
						<p align="left"><a class="subactionbutton" href="javascript:moveSteps('2');">Hedef grubunuzu seçin</a></p>
					</td>
				</tr>
			</table>
		</td>
	...
	<tr>
		<td class="stepHeaders"  valign=middle align=center colspan=5><b>Basamak 2:</b> Hedef grubunuzu seçin</td>
	</tr>
	<tr>
		<td valign=top align=center colspan=5>
			<table width="100%" cellspacing=1 cellpadding=10 align=center border=0>
				<tr>
					<td width="150" align="left" valign="middle" nowrap class="prevborder">
						<p align="right" class="prevActive">&laquo; Önceki</p>
						<p align="right"><a class="subactionbutton" href="javascript:moveSteps('1');">Kampanyanızı adlandırın</a></p>
					</td>
					<td align="center" valign="middle">
						<p>Aşağıda ki listeden kampanyanızı göndereceğiniz hedef grubu seçin.</p>
						<p>
							...
							<% if (canTGPreview) { %>
							<br><br>
							<a class="resourcebutton" href="javascript:targetgroup_popup(document.all.item('filter_id')[document.all.item('filter_id').selectedIndex].value);">Hedef grubu görüntüle</a>
							<% } %>
						</p>
					</td>
					<td align="right" width="150px" valign="middle" nowrap class="nextborder">
						<p align="left" class="nextActive">Sonraki &raquo;</p>
						<p align="left"><a class="subactionbutton" href="javascript:moveSteps('3');">İçeriğinizi oluşturun</a></p>
					</td>
				</tr>
			</table>
		</td>
	...
	<tr>
		<td class="stepHeaders" valign=middle align=center colspan=5><b>Step 3:</b> İçeriğinizi oluşturun</td>
	</tr>
	<tr>
		<td valign=top align=center colspan=5>
			<table width="100%" cellspacing=1 cellpadding=10 align=center border=0>
				...
				<tr>
					<td width="150" align="left" valign="top" nowrap class="prevborder">
						<p align="right" class="prevActive">&laquo; Önceki</p>
						<p align="right"><a class="subactionbutton" href="javascript:moveSteps('2');">Hedef grubunuzu seçin</a></p>
					</td>
					<td align="center" valign="middle">
						<table cellspacing="0" cellpadding="0" border="0" width="100%">
							<tr>
								<td>Bu kampanyada gönderilmek üzere aşağıda ki bölümde içeriğinizi isimlendirin ve ya düzenleyin.</td>
							</tr>
							<tr>
	...
	<tr>
		<td class="stepHeaders" valign=middle align=center colspan=5><b>Step 4:</b> Kampanyanızı göderin</td>
	</tr>
	<tr>
		<td valign=top align=center colspan=5>
			<table width="100%" cellspacing=1 cellpadding=10 align=center border=0>
				...
				<tr>
					<td width="150" align="left" valign="top" nowrap class="prevborder">
						<p align="right" class="prevActive">&laquo; Önceki</p>
						<p align="right"><a class="subactionbutton" href="javascript:moveSteps('3');">İçeriğinizi düzenleyin</a></p>
					</td>
					<td align="center" valign="middle">
						<table width="100%" cellspacing=1 cellpadding=2>
									...
									<table cellspacing="0" cellpadding="4" width="100%">
										<tr>
											<td align="left" valign="middle" nowrap>
												...
												{
												%>
													<a class="buttons-subaction" href="#" onclick="send_test();">Test gönder</a>
												<%
												}
												%>
											</td>
											<td align="right" valign="middle" nowrap>
												...
												{
												%>
													<a class="buttons-action" href="#" onclick="send();"><%= (isHyatt)?"Onay bekliyor":"Kampanyayı başlat" %></a>
												<%
												}
												%>
											</td>
							...
							<tr>
								<td nowrap>Kampanya Adı</td>
								<td align="left" valign="middle"><b><%=CAMP_NAME%></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="resourcebutton" href="javascript:moveSteps('1');">düzenle</a></td>
							</tr>
							<tr>
								<td nowrap>Gönderen Adı</td>
								<td align="left" valign="middle"><input class="inputtexts" type="text" name="from_name" value="<%=FROM_NAME%>" size="40" maxlength="50"></td>
							</tr>
							<tr height="25">
								<td nowrap>Gönderen Adresi</td>
								<td>
									<select name="from_address_id" size="1">
										<option selected value="">---  Adres Seçin  ------</option>
										<%
							...
							<tr height="25">
								...
								<td nowrap>
									<%= filterHtml_s4 %>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="resourcebutton" href="javascript:moveSteps('2');">düzenle</a>
								</td>
							</tr>
							<tr height="25">
								<td nowrap>Email Başlığı</td>
								<td>
							...
							<tr height="25">
								<td colspan="2">İçerik &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="resourcebutton" href="javascript:moveSteps('3');">düzenle</a></td>
							</tr>
							<tr>

...
//camp.s_cust_id = sCustId;
        ...
        try {
            ...
            while (rs.next())
            {
                ...
                data.put("countOpen",iCount_open);
            ...
            while (rs.next())
            {
                ...
                iCount_click++;
                data.put("countClick",iCount_click);
            ...
            while (rs.next())
            {
                ...
                data.put("countMonth",iCount_open_month);
            ...
            while (rs.next())
            {
                ...
                data.put("countMonth",iCount_click_month);
            ...
            while (rs.next())
            {
                ...
                data.put("countOpenYear",iCount_open_year);
            ...
            while (rs.next())
            {
                ...
                data.put("count",iCount_open_year);

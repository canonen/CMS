...
<form name="saveUser" id="saveUser" action="http://<%= s_crm_server %>/BriteConnect/Users_AM.aspx" method="get">
<input type="hidden" name="id" id="hdnCRM_UserID" value="<%= s_crm_id %>">

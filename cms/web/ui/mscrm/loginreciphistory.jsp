...
try	
{
	...
	if ( bIsCustActive && bIsUserActive && bIsPasswordValid)
	{
		...
		if ((null != recipID) && (!"".equals(String.valueOf(recipID))))
		{
		...
		{
			%>
			<html><head><link rel="stylesheet" href="<%=ui.s_css_filename%>" TYPE="text/css"></head><body><center><br><br>This recipient does not exist in the Revotas system.<br><br></center></body></html>
			<%
		}

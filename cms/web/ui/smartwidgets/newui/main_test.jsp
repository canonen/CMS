...
.rvts-ig-story__image {
  width: 100%;
}

.rvts-ig-story-overlay {
  z-index: 2147483646;
  position: fixed;
  left: 0;
  top: 0;
...
.rvts-ig-story-viewer__bar>div>div {
  position: absolute;
  transition: width .1s;
...
.rvts-ig-story-viewer__container>img,.rvts-ig-story-viewer__container>video {
  width: 100%;
  height: 100%;
  position: absolute;
}

.rvts-ig-story-viewer__container>div:nth-child(1) {
  top: 50%;
  left: -15px;
  position: absolute;
  color: #fff;
...
.rvts-ig-story-viewer__container>div:nth-child(2) {
  top: 50%;
  right: -15px;
  position: absolute;
  color: #fff;
...
.rvts-ig-story-viewer__container>div:nth-child(4) {
  position: absolute;
  bottom: 20px;
  width: 100%;
  display: flex;
  ...
  font-size: 40px;
  cursor: pointer;
  animation: rvtsMoveUpDown 1s linear infinite;
}

@keyframes rvtsMoveUpDown {
  0%,100% {
    bottom: 3%;
  }
...
@keyframes storySaved {
  0%,100% {
    box-shadow: 0px 0px 10px 8px rgb(89 200 230);
  }

  30% {
    box-shadow: 0px 0px 25px 20px rgb(89 230 210);
  }
}
      
 @keyframes highlightArea {
  0%,100% {
    box-shadow: unset;
  }

  30% {
    box-shadow: 0 0 20px 20px #ced4da;
  }
}     

.rvts-ig-story-viewer__bar>div.active {
  background-color: #fff;
}
...
.rvts-close-button:after,.rvts-close-button:before {
  position: absolute;
  left: 9px;
  content: " ";
  height: 15px;
...
.rvts-close-button:before {
  transform: rotate(45deg);
}

.rvts-close-button:after {
  transform: rotate(-45deg);
}
...
.rvts-ig-story__button {
  border-color: #fff;
  border-width: 0 2px 2px 0;
}

.rvts-ig-story__button.left {
  left: 5px;
}

.rvts-ig-story__button.right {
  right: 5px;
}

.rvts-ig-story__button_container {
  background-color: #02020280;
  display: flex;
  justify-content: center;
  border-radius: 14px;
...
.media-list {
  ...
  align-items: center;
      ...
      #customStoryArea .media-div, #igStoryArea .media-div {
...
.rvts-story-gradient {
    ...
    height: 83px;
    position: absolute;
    background: linear-gradient(180deg, #e29c2d, #fff0d8);
    top: 20px;
    left: 11px;
    border-radius: 50%;
}
...
.media-div>img {
  width: 100%!important;
      ...
      .media-div.selected-media {
            box-shadow: 0px 0px 10px 8px rgb(89 200 230);
        }
      .selected-v-align, .selected-h-align {
          background-color: #e0e0e0;
      }
      body {
          font-family: 'Source Sans Pro', 'Helvetica Neue', Helvetica, Arial, sans-serif !important;
      }
      .card-primary.card-outline:not(.card-outline-tabs), .card-primary.card-outline-tabs>.card-header a.active {
...
<body>
   ...
   <div class="col-md-12">
             ...
             <!--HEADER-->
              <div class="headmenu card-header p-2" style="display: none;">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item" style="display:none;"><a class="nav-link campaign_ig_story" href="#campaign_ig_story" data-toggle="tab">IG Story</a></li>
         ...
         <div class="row">
                     ...
                     <div class="col-md-2 col-xs-2"> 
                            <label for="igStory" class="blabel"> 
                                <input class="no-preview" type="radio" name="type" id="igStory" value="igStory">  
                                <a class="btn btn-app2 bbox "><img src="http://cms.revotas.com/cms/ui/smartwidgets/newui/assets/icons/social-proof.png" style="width: 100px;margin: auto;height: 100px;display: block;">IG Story</a>
                           </label>
                    ...
                    <div class="input-group condition-configs">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="row">
                             ...
                             <div class="tab-pane" id="campaign_ig_story">
                              <div class="form-group row">
                                <label for="igStoryQuerySelector" class="col-md-1 col-form-label">Query Selector</label>
                                <div class="col-md-4">
                                  <input type="text" class="form-control no-preview" name="igStoryQuerySelector" id="igStoryQuerySelector">
                                </div>
                              </div>
                              <div class="form-group col-md-3 row">
                              <label>Insert Position</label>
                              <select id="igStoryInsertPosition" class="form-control select2" style="">
                                  <option value="beforebegin">Insert before target element</option>
                                  <option value="afterend">Insert after target element</option>
                                  <option value="replace">Replace target element</option>
                                  <option value="afterbegin">Insert as first child of target element</option>
                                  <option value="beforeend">Insert as last child of target element</option>
                                ...
                                <div class="row">
                                     ...
                                     <div class="col-md-2 col-xs-2"> 
                                            <label for="storyTypeInstagram" class="blabel"> 
                                                <input class="no-preview" type="radio" name="igStoryType" id="storyTypeInstagram" value="storyTypeInstagram" checked>  
                                                <a class="btn btn-app2 bbox ">Instagram Story</a>
                                           </label>

                                     </div>
                                     <div class="col-md-2 col-xs-2"> 
                                            <label for="storyTypeCustom" class="blabel"> 
                                                <input class="no-preview" type="radio" name="igStoryType" id="storyTypeCustom" value="storyTypeCustom">  
                                                <a class="btn btn-app2 bbox ">Custom Story</a>
                                           </label>
                              ...
                              <div class="row">
                               ...
                               <div id="igStoryArea" class="col-md-6 card card-outline card-primary igStoryArea">
                                  <div class="card-header">
                                  <button style="width: 100%" type="button" class="btn">
                                      <h3 class="card-title">Instagram Story</h3>
                                    </button>
                                  </div>
                                  <div class="card-body">
                                      <div class="form-group row">
                                        <label for="igAccount" class="col-md-2 col-form-label">Instagram Account</label>
                                        <div class="col-md-4">
                                          <input type="text" class="form-control no-preview" name="igAccount" id="igAccount">
                                        </div>
                                      </div>
                                      <div id="ig-story-list"></div>
                                    <div style="margin-top:20px;">
                                        <button style="margin-left:auto;" class="btn btn-primary" onclick="fetchIGStoriesHighlights(this)">Fetch Stories & Highlights</button>
                                        <i id="fetching-stories" style="display:none;" class="fas fa-spinner fa-spin"></i>
                                    </div>
                                    <div style="margin-top:20px;">
                                    <button style="margin-left:auto;" class="btn btn-primary" onclick="previewSelectedIgStory()">Preview</button>
                                </div>
                                 <div style="margin-top:20px;">
                                    <button style="margin-left:auto;" class="btn btn-primary" onclick="addSelectedIgStory()" >Add Story</button>
                                    <button style="margin-left:auto;display:none;" id="createGroupFromSelectedIgStory"  class="btn btn-primary" onclick="createGroupFromSelectedIgStory()" >Create New Group</button>
                                    <button style="margin-left:auto;display:none;" id="addToGroupFromSelectedIgStory" class="btn btn-primary" onclick="addToGroupFromSelectedIgStory()" >Add To Selected Group</button>
                                </div>
                                  </div>
                                </div>
                                <div id="customStoryArea" style="display:none;" class="col-md-6 card card-outline card-primary customStoryArea">
                                  <div class="card-header">
                                  <button style="width: 100%" type="button" class="btn">
                                      <h3 class="card-title">Custom Story</h3>
                                    </button>
                                  </div>
                                  <div class="card-body">  
                    <div>
                        <button style="margin-left:auto;" class="btn btn-primary" onclick="reloadMediaFiles()">Reload</button>
                    </div>
                    <div style="margin-top: 15px;">
                        Select From Uploaded Media Files
                    </div>
                     ...
                     <div style="margin-bottom: 20px;">
                         <input class="no-preview" type="file"
                           id="igStoryUpload" name="igStoryUpload"
                           accept="image/png, image/jpeg, image/jpg, video/mp4, video/webm">
                           <button id="uploadMediaFiles" style="margin-left:auto;display:none;" class="btn btn-primary" onclick="uploadMediaFiles(this)">Upload</button>
                           <i id="upload-media-loading" style="display:none;" class="fas fa-spinner fa-spin"></i>
                     </div>
                                
                                
                                 <div>
                        <button style="margin-left:auto;" class="btn btn-primary" onclick="previewSelectedMedia()">Preview</button>
                    </div>
                                 <div style="margin-top:20px;">
                        <button style="margin-left:auto;" class="btn btn-primary" onclick="addSelectedMediaStory()">Add Story</button>
                        <button style="margin-left:auto; display:none;" id="createGroupFromSelectedMediaStory" class="btn btn-primary" onclick="createGroupFromSelectedMediaStory()" >Create New Group</button>
                        <button style="margin-left:auto; display:none;" id="addToGroupFromSelectedMediaStory" class="btn btn-primary" onclick="addToGroupFromSelectedMediaStory()" >Add To Selected Group</button>
                        
                    </div>
                                  </div>
                                </div>
                                <div id="content-edit-area" class="col-md-6 card card-primary card-outline contentEditingArea card-outline-tabs">
              <div class="card-header p-0 border-bottom-0">
                <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                  <li class="nav-item">
                    <a class="nav-link active" id="ig-description-tab" data-toggle="pill" href="#ig-description" role="tab" aria-controls="ig-description" aria-selected="true">Description</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="ig-cta-tab" data-toggle="pill" href="#ig-cta" role="tab" aria-controls="ig-cta" aria-selected="false">CTA</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link" id="ig-duration-tab" data-toggle="pill" href="#ig-duration" role="tab" aria-controls="ig-duration" aria-selected="false">Duration</a>
                  </li>
                </ul>
              </div>
              <div class="card-body">
                <div class="tab-content" id="custom-tabs-three-tabContent">
                  <div class="tab-pane fade active show" id="ig-description" role="tabpanel" aria-labelledby="ig-description-tab">
                    <div class="form-group row">
                        <label for="igStoryTitle" class="col-md-1 col-form-label">Title</label>
                        <div class="col-md-4">
                          <input type="text" class="form-control no-preview" name="igStoryTitle" id="igStoryTitle">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="igStoryTitle" class="col-md-1 col-form-label">Colors</label>
                        <div class="col-md-4">
                          <button title="Story Color 1" style="position: relative;" onclick="this.children[1].click()">
                            <i style="color: rgb(0, 0, 0);" class="fa fa-paint-brush"></i>
                            <input style="visibility: hidden;position: absolute;right: 0;width: 0;height: 0;" class="no-preview color-apply" type="color" onclick="chooseStoryColor(this)" oninput="chooseStoryColor(this)" id="storycolor1">
                        </button>
                        <button title="Story Color 2" style="position: relative;" onclick="this.children[1].click()">
                            <i style="color: rgb(0, 0, 0);" class="fa fa-paint-brush"></i>
                            <input style="visibility: hidden;position: absolute;right: 0;width: 0;height: 0;" class="no-preview color-apply" type="color" onclick="chooseStoryColor(this)" oninput="chooseStoryColor(this)" id="storycolor2">
                        </button>
                        <button style="margin-left:10px;" class="btn btn-primary" onclick="updateAllColors()">Update All Colors</button>
                        </div>
                      </div>
                     <div style="margin:20px 0;" id="ig-description-editor">
                       <div style="position:relative;width:305px;">
                        <button onclick="document.execCommand('italic',false,null);"><i class="fa fa-italic"></i></button>
                        <button onclick="document.execCommand('bold',false,null);"><i class="fa fa-bold"></i></button>
                        <button onclick="document.execCommand('underline',false,null);"><i class="fa fa-underline"></i></button>
                        ...
                        <button title="Edit HTML" onclick="toggleHTMLMode3();"><i class="fa fa-code"></i></button>


                        <div style="display:none;" class="lead emoji-picker-container form-control" data-emojiable="true"
                       data-emoji-input="unicode"></div>
                        </div>
                        <div class="form-control" spellcheck="false" id="richTextEditor3" contenteditable="true" style="height:100px;overflow-y: scroll"></div>
                    </div>
                    <div class="form-group row">Text Alignment</div>
                    <div class="form-group row">
                    <div class="btn-group">
                        <button type="button" direction="flex-start" class="btn btn-default h-text-align"><i class="fas fa-align-left"></i></button>
                        <button type="button" direction="center" class="btn btn-default h-text-align selected-h-align"><i class="fas fa-align-center"></i></button>
                        <button type="button" direction="flex-end" class="btn btn-default h-text-align"><i class="fas fa-align-right"></i></button>
                      </div>
                      </div>
                      <div class="form-group row">
                      <div class="btn-group">
                        <button type="button" direction="flex-start" class="btn btn-default v-text-align"><i class="fas fa-arrow-up"></i></button>
                        <button type="button" direction="center" class="btn btn-default v-text-align selected-v-align"><i class="fas fa-bars"></i></button>
                        <button type="button" direction="flex-end" class="btn btn-default v-text-align"><i class="fas fa-arrow-down"></i></button>
                      </div>
                      </div>
                    
                  </div>
                  <div class="tab-pane fade" id="ig-cta" role="tabpanel" aria-labelledby="ig-cta-tab">
                     <div class="form-group row">
                        <label for="igCTAURL" class="col-md-2 col-form-label">URL</label>
                        <div class="col-md-4">
                          <input type="text" class="form-control no-preview" name="igCTAURL" id="igCTAURL">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="igCTAText" class="col-md-2 col-form-label">Call To Action</label>
                        <div class="col-md-4">
                          <input type="text" class="form-control no-preview" name="igCTAText" id="igCTAText">
                        </div>
                      </div>
                  </div>
                  <div class="tab-pane fade" id="ig-duration" role="tabpanel" aria-labelledby="ig-duration-tab">
                     <div class="form-group row">
                        <label for="igCustomStoryDuration" class="col-md-2 col-form-label">Story Duration</label>
                        <div class="col-md-6">
                          <input class="widget_slider no-preview" name="igCustomStoryDuration" style="width:100%;" id="igCustomStoryDuration" data-slider-id='ex309Slider' type="text" data-slider-orientation="horizontal" data-slider-min="2" data-slider-max="30" data-slider-step="1" data-slider-value="2"/>
                        </div>
                      </div>
                  </div>
                  <div>
                        <button style="margin-left:auto;display:none;" id="updateSelectedStory" class="btn btn-primary" onclick="updateSelectedStory(this)">Update Selected Story</button>
                        <button style="margin-left:auto;display:none;" id="updateSelectedGroup" class="btn btn-primary" onclick="updateSelectedGroup(this)">Update Selected Group</button>
                    </div>
                </div>
              </div>
              <!-- /.card -->
                              ...
                              <div id="added-stories-area" class="card card-outline card-primary storyArea">
                                  <div class="card-header">
                                  <button style="width: 100%" type="button" class="btn">
                                      <h3 class="card-title">Added Stories (Order of stories can be changed with left and right arrow keys)</h3>
                                    </button>
                                  </div>
                                  <div class="card-body">
                                      <div id="added-stories"></div>
                                      <div id="sub-stories"></div>
                                  </div>
                                </div>
...
<!-- End emoji-picker JavaScript -->
    ...
    $('#delay').slider({
       ...
       $('#height').slider({
        ...
        $('#igCustomStoryDuration').slider({
            formatter: function(value) {
                document.querySelector('label[for=igCustomStoryDuration]').textContent = 'Story Duration (' + value + ' s)';
                return value + ' s';
            }
        });
      ...
      $('#autoCloseDelay2').slider({
        ...
        if(configLoaded && config_param.type !== 'productAlert' && config_param.type !== 'socialProof' && config_param.type !== 'igStory') {
        ...
        var tempStartDate = moment().startOf('month');
        var tempEndDate = moment().endOf('month');
        
        /*$('#story_schedule').daterangepicker({
	   ranges: {
                'Today': [moment(), moment()],

  ...
  */
  ...
  var EmojiArea_WYSIWYG = function($textarea, id, options) {
    ...
    this.$editor.attr({
      ...
      'onkeyup': 'return KeyPressed(event)'
    });
  ...
  EmojiMenu.prototype.onItemSelected = function(emoji) {
    if(this.emojiarea.$editor.text().length + this.emojiarea.$editor.find('img').length >= this.emojiarea.$editor.attr('maxlength'))
    {
      return;
       ...
       if(document.querySelector('.campaign_social_proof').parentElement.style.display === 'none') {
        this.emojiarea.$editor[0] = document.getElementById('richTextEditor');
        this.emojiarea.insert(emoji);
          showProductAlertPreview();
      }
       else {
         this.emojiarea.$editor[0] = document.getElementById('richTextEditor2');
         this.emojiarea.insert(emoji);
           showSocialProofPreview();
       }
      //document.getElementById('richTextEditor').textContent += emoji;

...
//UTM Tracker code
if(typeof window.rvtsUTMTrackerAdded === 'undefined' || window.rvtsUTMTrackerAdded === rvtsSWCode) {
    (function() {
    ...
    window.rvtsUTMTrackerAdded = rvtsSWCode;
}

//Order Tracker code
if(typeof window.rvtsOrderTrackerAdded === 'undefined' || window.rvtsOrderTrackerAdded === rvtsSWCode) {
    (function() {
        var _rTag = document.getElementsByTagName('script')[0];
        var _rcTag = document.createElement('script');
        _rcTag.type = 'text/javascript';
    ...
    window.rvtsOrderTrackerAdded = rvtsSWCode;
}

//Activity Tracker code
if(typeof window.rvtsActivityTrackerAdded === 'undefined' || window.rvtsActivityTrackerAdded === rvtsSWCode) {
    (function() {
        var _rTag = document.getElementsByTagName('script')[0];
        var _rcTag = document.createElement('script');
        _rcTag.type = 'text/javascript';
    ...
    window.rvtsActivityTrackerAdded = rvtsSWCode;
}
            ...
            init.then(function() {
                ...
                setTimeout(async function(){
                    ...
                    if(!isPreview) {
                        ...
                        var iframeEvalString = "var rvtsUserId='"+rvtsUserId+"'; document.querySelectorAll('#push-smart-widget-activity').forEach(function(smartWidgetCallToActionButton) { if(smartWidgetCallToActionButton) { var activityType = smartWidgetCallToActionButton.getAttribute('activity_type'); if(activityType=='click')activityType='1'; else if(activityType=='submit')activityType='2'; smartWidgetCallToActionButton.addEventListener('click', function(){ var fetchParams = ''; fetchParams+= 'cust_id="+custId+"'; fetchParams+='&popup_id="+popupId+"'; fetchParams+='&form_id="+formId+"';  fetchParams+='&user_agent='+navigator.userAgent; fetchParams+='&activity_type='+activityType; fetchParams+='&session_id="+rvtsSessionId+"'; if(rvtsUserId)fetchParams += '&user_id="+rvtsUserId+"'; fetchParams+='&url="+window.location.href.split('&').join(encodeURIComponent('&'))+"'; fetch('https://f.revotas.com/frm/smartwidgets/save_smartwidget_activity.jsp?' + fetchParams);  }); } });"
                        if(iframe) {
                            var messageObject = {
                                swExecJSCode: true,
                                popupId: popupId,
...
function rvtsStoryContainer(storyList,querySelector,position,isLivePreview,popupId) {
    var css = '.rvts-ig-story-frame{overflow: hidden;position: relative;width: 95%;height: 140px;display: flex;align-items: center;margin: auto;margin-bottom: 10px}.rvts-ig-story-list{position: absolute;left: 0;transition: left .5s ease 0s}.rvts-ig-story__container{max-width: 100%;height: 90px;display: flex;align-items: center}.rvts-ig-story{border: 1px solid #000;border-radius: 50%;height: 65px;width: 65px;margin-left: 20px;position: relative;display: flex;align-items: center;justify-content: center;overflow: hidden}.rvts-ig-story__image{width: 100%}.rvts-ig-story-overlay{z-index: '+(maxInt-1)+';position: fixed;left: 0;top: 0;width: 100vw;height: 100vh;background-color: #151515;display: flex;justify-content: center;align-items: center}.rvts-ig-story-viewer{border: 1px solid #000;width: 300px;height: 80%}.rvts-ig-story-viewer__bar{width: 100%;height: 20px;display: flex;align-items: center;justify-content: space-around}.rvts-ig-story-viewer__bar>div{height: 2px;width: 100%;background-color: gray;margin: 0 1px;border-radius: 5px;position: relative}.rvts-ig-story-viewer__bar>div>div{position: absolute;transition: width .1s;transition-timing-function: linear;left: 0;background-color: #fff;top: 0;height: 100%;width: 0}.rvts-ig-story-viewer__container>img,.rvts-ig-story-viewer__container>video{width: 100%;height: 100%;position: absolute}.rvts-ig-story-viewer__container>div:nth-child(1){top: 50%;left: -15px;position: absolute;color: #fff;cursor: pointer}.rvts-ig-story-viewer__container>div:nth-child(2){top: 50%;right: -15px;position: absolute;color: #fff;cursor: pointer}.rvts-ig-story-viewer__container>div:nth-child(4){position: absolute;bottom: 20px;width: 100%;display: flex;flex-direction: column;justify-content: center;align-items: center;z-index: 2;color: #fff;font-size: 40px;cursor: pointer;animation: rvtsMoveUpDown 1s linear infinite}@keyframes rvtsMoveUpDown{0%,100%{bottom: 3%}50%{bottom: 6%}}.rvts-ig-story-viewer__bar>div.active{background-color: #fff}.rvts-ig-story-viewer__container{width: 100%;height: calc(100% - 20px);background-color: #fff;position: relative}.rvts-close-button{position: absolute;right: 3%;top: 2%;width: 20px;height: 20px;background-color: #ffffffab;border-radius: 3px;z-index: 2;cursor: pointer}.rvts-close-button:after,.rvts-close-button:before{position: absolute;left: 9px;content: " ";height: 15px;width: 2px;top: 3px;background-color: #333}.rvts-close-button:before{transform: rotate(45deg)}.rvts-close-button:after{transform: rotate(-45deg)}.rvts-up-arrow{border: solid #fff;border-width: 0 5px 5px 0;display: inline-block;padding: 10px;transform: rotate(-135deg);-webkit-transform: rotate(-135deg)}.rvts-up-arrow-container{background-color: #02020280;display: flex;justify-content: center;border-radius: 20px;align-items: center;width: 47px;height: 34px;padding-top: 12px}.rvts-cta-text-container{background-color: #02020280;display: flex;justify-content: center;border-radius: 10px;align-items: center;width: auto;height: auto;padding: 3px 10px}.rvts-arrow{border: solid #fff;border-width: 0 4px 4px 0;display: inline-block;padding: 7px;transform: rotate(135deg);-webkit-transform: rotate(135deg)}.rvts-arrow.left{transform: rotate(135deg);-webkit-transform: rotate(135deg)}.rvts-arrow.right{transform: rotate(-45deg);-webkit-transform: rotate(-45deg)}.rvts-ig-story__button{border-color: #fff;border-width: 0 2px 2px 0}.rvts-ig-story__button.left{left: 5px}.rvts-ig-story__button.right{right: 5px}.rvts-ig-story__button_container{background-color: #02020280;display: flex;justify-content: center;border-radius: 14px;align-items: center;width: 24px;height: 34px;position: absolute!important;cursor: pointer;z-index: 1}.rvts-ig-story__button_container.left{padding-left: 8px;left: 5px}.rvts-ig-story__button_container.right{padding-right: 8px;right: 5px}.media-files{margin: 20px 0;border: 1px solid #ced4da;border-radius: 5px;padding: 10px}.media-list{display: flex;height: 120px;overflow-x: auto;overflow-y: hidden;align-items: center}.media-div{background-color: white;cursor: pointer;border-radius: 50%;height: 75px;width: 75px;margin-left: 15px;display: flex;align-items: center;justify-content: center;overflow: hidden;padding: 4px;z-index: 1}.media-div>img{width: 100%!important}.rvts-story-gradient{width: 83px;height: 83px;position: absolute;background: linear-gradient(180deg, #e29c2d, #fff0d8);top: -4px;left: 11px;border-radius: 50%}';
    ...
    var circleList = storyList.map((story,index) => {
        ...
        circle.addEventListener('click', function() {
            if(story.id) {
                rvtsStoryViewer(story,0,isLivePreview,popupId);
            } else {
                var tempStoryList = storyList.filter(story=>!story.id);
                var index = tempStoryList.findIndex(e=>e===story);
                rvtsStoryViewer(tempStoryList,index,isLivePreview,popupId);
            }
            if(!isLivePreview) {
...
function rvtsStoryViewer(storyList, index, isLivePreview, popupId) {
...
async function rvtsPopup(params, isPreview, custId, popupId, formId, rcpLink, isLivePreview) {
    ...
    if(params.type === 'sticky') {
        ...
        rvtsStoryContainer(igStorySettings.storyList,igStorySettings.querySelector,igStorySettings.insertPosition,isLivePreview,popupId);
    }
                ...
                await executeGroup(obj.conditionConfig, {
                  ...
                  orderPage: orderPage}, popupId).then(function(result) {
                      if(result) {
                        ...
                        if(obj.scriptCode)obj.scriptCode = decodeURIComponent(obj.scriptCode);
                        rvtsPopup(obj,false,cust_id,popupId,formId,rcpLink,false);
                        if(!['sticky','drawer','script','productAlert','socialProof','igStory'].includes(obj.type))breakFor = true;
                      }
                  });    
            }
        }

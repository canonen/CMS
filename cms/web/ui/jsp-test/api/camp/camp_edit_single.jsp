...
<%
    ...
    try {
        ...
        if (!camp.s_type_id.equals("5") && !isPrintCampaign) {
            ...
            if ((!isDone && !isSending && !isTesting && !isPending) || (sCalcCampID != null)) {
                ...
                if (sCalcCampID != null) {
                    ...
                    if (csds.size() != 0) {
                        jsonObject.put("viewCalculationDetails", "javascript:showCampDetails('" + sCalcCampID + "', 'stats')");
                    }
                }
            }
        } else {
        ...
        if (camp.s_type_id.equals("2")) {
            jsonObject.put("queueStartDate", camp_send_param.s_queue_date);
            jsonObject.put("whenSending", (schedule.s_start_daily_time));
            if (!isPrintCampaign) {

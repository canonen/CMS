...
<%
    ...
    if (MODE.equals("send_pv_receipt")) {
        ...
        pvhist.s_pv_test_type_id = request.getParameter("pvhist_pv_test_type_id");
        pvhist.s_origin_camp_id = camp.s_camp_id;
        pvhist.s_pv_iq = request.getParameter("pvhist_pviq");
        pvhist.s_cont_id = request.getParameter("cont_id");
        ...
        String sPvTestListIds = request.getParameter("pv_test_list_ids");

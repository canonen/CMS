...
<%
	...
	if (contType.equals("1")) {
        ...
        if(report.equals("")) {
            ...
            object.put("scoreDetail",report);
            object.put("scoreDetail",report);
            object.put("html",previewHtml);
            object.put("totalScore",sf.hits());
            object.put("isSafe",str);
            object.put("minScore",sf.required());
            object.put("isSpam",(sf.isSpam())?"Yes":"No");
            object.put("message",previewText);
            object.put("from",URLDecoder.decode(from, "UTF-8"));
            object.put("subject",subj_text);
            array.put(object);
        } else {
			object.put("scoreDetail",report);
            object.put("scoreDetail",report);

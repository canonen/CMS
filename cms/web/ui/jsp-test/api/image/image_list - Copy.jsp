...
<%
    ...
    try {
        ...
        data.put("global_imgSize", globalImgSize);
        data.put("global_imgCount", globalImgCount);
        data.put("global_folderId", globalFolderId);
        data.put("global_folderName", globalFolderName);
        data.put("global_last_modDate", globalLastModDate);
        ...
        data.put("root_imgSize", rootImgSize);
        data.put("root_imgCount", rootImgCount);
        data.put("root_folderId", rootFolderId);
        data.put("root_folderName", rootFolderName);
        data.put("root_last_modDate", rootLastModDate);
        ...
        while (rootSubFolders.hasNext()) {
            ...
            data.put("rootSubFolder_id", subFolder.s_folder_id);
            data.put("rootSubFolder_name", subFolder.s_folder_name);
            data.put("rootSubFolder_imgCount", subFolder.getImgCount(cust.s_cust_id));
            data.put("rootSubFolder_imgSize", subFolder.getImgSize(cust.s_cust_id));
            data.put("rootSubFolder_lastModDate", subFolder.s_last_mod_date);
            array.put(data);
        }
        ...
        while (globalSubFolders.hasNext()) {
            ...
            data.put("globalSubFolder_id", subFolder.s_folder_id);
            data.put("globalSubFolder_id_name", subFolder.s_folder_name);
            data.put("globalSubFolder_imgCount", subFolder.getImgCount(cust.s_cust_id));
            data.put("globalSubFolder_imgSize", subFolder.getImgSize(cust.s_cust_id));
            data.put("globalSubFolder_lastModDate", subFolder.s_last_mod_date);
            array.put(data);
        }
        ...
        while (itImages.hasNext()) {
            ...
            data.put("image_lastModDate", image.s_last_mod_date);
            array.put(data);

...
else
{
	...
	if(sDayCount==null) sDayCount = "30";
								...
								try
								{
									...
									byte[] b = null;
												...
												while (rs.next())
												{
													...
													data.put("filterType", FilterType.BRITETRACK_DID_ACTION_WITH_PARAM);
							...
							try
							{
								...
								byte[] b = null;
									...
									while (rs.next())
									{
										...
										data.put("sfilterName", sFilterName);
										data.put("filterType", FilterType.BRITETRACK_DID_ACTION_WITH_PARAM);
										if (sId.equals(sActionParam)) data.put("isSelected", "selected");
										else data.put("isSelected", "");
										data.put("TargetName", sTargetGroupDisplay);
										array.put(data);
									}
									jsonObject.put("values_2", array);
									rs.close();
                    ...
                    if("=".equals(sActionParamCompareOperation)){
						jsonObject.put("sActionParamCompareOperation", "=");
					}
					if(">".equals(sActionParamCompareOperation)){
						jsonObject.put("sActionParamCompareOperation", ">");
					}

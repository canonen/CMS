	...
	try
	{
		...
		jsonObject.put("sTypeName",sTypeName);
			...
			if("=".equals(sCompareOperation)){
				jsonObject.put("sCompareOperation","=");
			}
            if(">".equals(sCompareOperation)){
				jsonObject.put("sCompareOperation",">");
			}
            ...
            if("between".equals(sCompareOperation)){
				jsonObject.put("sCompareOperation","between");
			}
			if("like".equals(sCompareOperation)){
				jsonObject.put("sCompareOperation","like");
			}

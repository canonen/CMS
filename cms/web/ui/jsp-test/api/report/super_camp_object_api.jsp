...
while (rs.next())
{
    ...
    iCount++;
	data.put("sCurCampID",rs.getString (1));
	data.put("sCurCampName",new String (rs.getBytes(2), "UTF-8"));
	data.put("sCurCampType",new String (rs.getBytes(3), "UTF-8"));
...
int nLinks = 0;
	...
	while (rs.next())
	{
				...
				data.put("sLinkID",sLinkID);
				data.put("sLinkName",sLinkName);
                array.put(data);
				nLinks++;

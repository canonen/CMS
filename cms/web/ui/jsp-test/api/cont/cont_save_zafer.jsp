...
<%
	...
	while ((configParam = in.readLine()) != null ){
		jsonObj = new JSONObject(configParam);
	}
	...
	String trackUrl = jsonObj.getString("TrackURLs");
...
{
	Links links = null;
	System.out.println("strTrackValuesStr"+strTrackValuesStr);
	String[] strTrackValues = strTrackValuesStr.split(" ");

	System.out.println("strTrackValues"+strTrackValues);
	...
	for (int i=0; i<strTrackValues.length; i++)
	{
		...
		System.out.println("item"+strTrackValues[i]);

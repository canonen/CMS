...
<%
	...
	int iCount=0;
	JsonArray reportProductList = new JsonArray();
	try
	{
...
//		}
		if(nodeList !=null) {
			for (int i = 0; i < nodeList.getLength(); i++) {
				...
				data.put("productName",report.product_name);
				...
				data.put("productSalesPrice",report.product_sales_price);


				reportProductList.put(data);
		...
		out.print(reportProductList.toString());
	}
	catch (Exception e){

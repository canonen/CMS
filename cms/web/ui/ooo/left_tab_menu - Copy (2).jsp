    ...
    <%
        ...
        //Left Test
        bFeat = ui.getFeatureAccess(770);
        if (!bFeat) showLeftTest = 0;
        ...
        //PERFORMANCE CENTER
        //--------------
      /*  wFeat = ui.getFeatureAccess(Feature.WEB_PUSH);
    ...
    <fmt:bundle basename="app">
        ...
        <%
            ...
            try {
                ...
                url_smartwidgetreport = new URL("http://" + service.getURL().getHost() + "/rrcp/imc/rpt/report_smartwidget_activity.jsp?cust_id=" + cid);
            ...
            <ul id="sliding-navigation">
                <li class="sliding-element">
                    ...
                    <ul style="display:none;" class="subItems">
                        <li class="sliding-element"><a target="detail" href="/cms/ui/jsp/camp/camp_list.jsp?locale=${loc}">Email</a>
                        </li>
                ...
                <%
                    /*
                     ...
                     cust.s_cust_id.equals("722") ||
                     cust.s_cust_id.equals("748") ||
                                     cust.s_cust_id.equals("566") ||
                                     cust.s_cust_id.equals("721") ||
                                     cust.s_cust_id.equals("734") ||
                                     cust.s_cust_id.equals("650") ||
                                     cust.s_cust_id.equals("653") ||
                                     cust.s_cust_id.equals("644") ||
                                     cust.s_cust_id.equals("626") ||
                                     cust.s_cust_id.equals("691") ||
                                     cust.s_cust_id.equals("744") ||
                                     cust.s_cust_id.equals("625") ||
                                     cust.s_cust_id.equals("542") ||
                                     cust.s_cust_id.equals("695") ||
                                     cust.s_cust_id.equals("696") ||
                                     cust.s_cust_id.equals("746") ||
                                     cust.s_cust_id.equals("700") ||
                                     cust.s_cust_id.equals("641") ||
                                     cust.s_cust_id.equals("707") ||
                                     cust.s_cust_id.equals("708") ||
                                     cust.s_cust_id.equals("710") ||
                                     cust.s_cust_id.equals("745") ||
                                     cust.s_cust_id.equals("775") ||
                     cust.s_cust_id.equals("709") ||
                                     cust.s_cust_id.equals("701") ||
                                     cust.s_cust_id.equals("729") ||
                                     cust.s_cust_id.equals("753") ||
                                     cust.s_cust_id.equals("774") ||
                                     cust.s_cust_id.equals("761") ||
                                     cust.s_cust_id.equals("762") ||
                                     cust.s_cust_id.equals("763") ||
                                     cust.s_cust_id.equals("569") ||
                                     cust.s_cust_id.equals("757") ||
                                     cust.s_cust_id.equals("777") ||
                                     cust.s_cust_id.equals("780") ||
                                     cust.s_cust_id.equals("767") ||
                                     cust.s_cust_id.equals("783") ||
                                     cust.s_cust_id.equals("786") ||
                                     cust.s_cust_id.equals("817") ||
                                     cust.s_cust_id.equals("844") ||
                                     cust.s_cust_id.equals("846") ||
                                     cust.s_cust_id.equals("790") ||
                                     cust.s_cust_id.equals("866") ||
                                     cust.s_cust_id.equals("878") ||
                ...
                <% if (cust.s_cust_id.equals("723") ||
                        cust.s_cust_id.equals("832") ||
                        cust.s_cust_id.equals("537") ||
                        cust.s_cust_id.equals("846") ||
                        cust.s_cust_id.equals("614") ||
                        cust.s_cust_id.equals("526") ||
                        cust.s_cust_id.equals("799") ||
                        cust.s_cust_id.equals("646") ||
                        cust.s_cust_id.equals("673") ||
                        cust.s_cust_id.equals("700") ||
                        cust.s_cust_id.equals("824") ||
                        cust.s_cust_id.equals("613") ||
                        cust.s_cust_id.equals("420") ||
                        cust.s_cust_id.equals("617") ||
                        cust.s_cust_id.equals("670") ||
                        cust.s_cust_id.equals("787") ||
                        cust.s_cust_id.equals("775") ||
                        cust.s_cust_id.equals("790") ||
                        cust.s_cust_id.equals("702") ||
                        cust.s_cust_id.equals("727") ||
                        cust.s_cust_id.equals("650") ||
                        cust.s_cust_id.equals("803") ||
                        cust.s_cust_id.equals("564") ||
                        cust.s_cust_id.equals("843") ||
                        cust.s_cust_id.equals("705") ||
                        cust.s_cust_id.equals("626") ||
                        cust.s_cust_id.equals("837") ||
                        cust.s_cust_id.equals("641") ||
                        cust.s_cust_id.equals("753") ||
                        cust.s_cust_id.equals("671")) { %>

                <li class="sliding-element">
                    <a href="javascript:void(null);" class="heading contents">CRM Ads</a>
                    <ul style="display:none;" class="subItems">
                        <%String rtr = "integrations.jsp?cust_id=" + cid + "&revotas_user=" + user.s_user_id;%>
                        <%
                            String rtr_export_type = "https://rcp3.revotas.com/rrcp/ui/retargeting/retargeting_export_type.jsp?cust_id=" + cid + "&revotas_user=" + user.s_user_id;%>
                ...
                <%--<%/* if (cust.s_cust_id.equals("420") ||
                        cust.s_cust_id.equals("795") ||
                        cust.s_cust_id.equals("791") ||
                        cust.s_cust_id.equals("789") ||
                        cust.s_cust_id.equals("846") ||
                        cust.s_cust_id.equals("843") ||
                        cust.s_cust_id.equals("526") ||
                        cust.s_cust_id.equals("844") ||
                        ...
                        cust.s_cust_id.equals("824") ||
                        cust.s_cust_id.equals("790") ||
                        cust.s_cust_id.equals("856") ||
                        cust.s_cust_id.equals("838") ||
                        cust.s_cust_id.equals("673") ||
                        cust.s_cust_id.equals("788") ||
                        cust.s_cust_id.equals("869") ||
                        cust.s_cust_id.equals("671") ||
                        cust.s_cust_id.equals("615") ||
                        cust.s_cust_id.equals("874") ||
                        cust.s_cust_id.equals("769") ||
                        cust.s_cust_id.equals("626") ||
                        cust.s_cust_id.equals("878") ||
                        cust.s_cust_id.equals("880") ||
                        cust.s_cust_id.equals("881") ||
                        cust.s_cust_id.equals("886") ||
                        cust.s_cust_id.equals("837") ||
                        cust.s_cust_id.equals("641") ||
                        cust.s_cust_id.equals("866") ||
                        cust.s_cust_id.equals("896") ||
                        cust.s_cust_id.equals("753") ||
                        cust.s_cust_id.equals("836") ||
                        cust.s_cust_id.equals("650")) { */%>--%>

                <li <%= (showSmartWidget == 0) ? " style=\"display:none;\"" : "" %> class="sliding-element">
                    <a href="javascript:void(null);" class="heading contents">Smart Widget</a>
                    <ul style="display:none;" class="subItems">
                ...
                <li  <%= (showRecommendation == 0) ? " style=\"display:none;\"" : "" %> class="sliding-element">
                    <a href="javascript:void(null);" class="heading contents">Recommendation</a>
                    <ul style="display:none;" class="subItems">
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/recommendation/main.jsp?cust_id=<%=420%>">Configurations</a>
                        </li>
                ...
                <li <%= (showPersonalSearch == 0) ? " style=\"display:none;\"" : "" %> class="sliding-element">
                    <a href="javascript:void(null);" class="heading personelsearchs">Personal Search</a>
                    <ul style="display:none;" class="subItems">
                        <li class="sliding-element"><a target="detail" href="/cms/ui/perssearch/ui/main.jsp">Configurations</a></li>
                ...
                <li class="sliding-element">
                    ...
                    <ul style="display:none;" class="subItems">
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/email_list/list_list.jsp?typeID=2&amount=999999&locale=${loc}"><fmt:message
                                key="testing_lists"/></a></li>
                        <%
                            if (!STANDARD_UI && !isPrintCampaign) {
                        %>
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/email_list/list_list.jsp?typeID=3&amount=999999&locale=${loc}"><fmt:message
                                key="exclusion_lists"/></a></li>
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/email_list/list_list.jsp?typeID=4&amount=999999&locale=${loc}"><fmt:message
                        ...
                        %>
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/import/import_list.jsp?amount=999999&locale=${loc}"><fmt:message
                                key="import_lists"/></a></li>
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/filter/filter_list.jsp?amount=999999&locale=${loc}"><fmt:message
                        ...
                        %>
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/export/export_list.jsp?amount=999999&locale=${loc}"><fmt:message
                                key="data_export"/></a></li>
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/edit/recip_search.jsp?locale=${loc}"><fmt:message
                ...
                <li class="sliding-element">
                    ...
                    <ul style="display:none;" class="subItems">
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/cont/cont_list.jsp?amount=999999&locale=${loc}"><fmt:message
                                key="content"/></a></li>
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/ctm/index.jsp?locale=${loc}"><fmt:message
                                key="templates"/></a></li>
                        <%
                            if (!STANDARD_UI && !isPrintCampaign) {
                        %>
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/cont/logic_block_list.jsp?locale=${loc}"><fmt:message
                                key="dynamic"/></a></li>
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/cont/link_renaming_list.jsp?locale=${loc}"><fmt:message
                                key="auto_link"/></a></li>
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/image/image_list.jsp?locale=${loc}"><fmt:message
                ...
                <li class="sliding-element">
                    ...
                    <ul style="display:none;" class="subItems">
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/report/report_list.jsp?amount=999999&locale=${loc}"><fmt:message
                                key="my_reports"/></a></li>
                        <%
                            if (!STANDARD_UI && !isPrintCampaign) {
                                ...
                                if (cust.s_cust_id.equals("171") ||
                                        ...
                                        cust.s_cust_id.equals("748") ||
                                        cust.s_cust_id.equals("775") ||
                                        cust.s_cust_id.equals("772") ||
                                        cust.s_cust_id.equals("773") ||
                                        cust.s_cust_id.equals("780") ||
                                        cust.s_cust_id.equals("790") ||
                                        cust.s_cust_id.equals("792") ||
                                        cust.s_cust_id.equals("796") ||
                                        cust.s_cust_id.equals("776") ||
                                        cust.s_cust_id.equals("803") ||
                                        cust.s_cust_id.equals("805") ||
                                        cust.s_cust_id.equals("830") ||
                                        cust.s_cust_id.equals("769")
                        ...
                        <% } %>
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/report/super_camp_report_list.jsp?locale=${loc}"><fmt:message
                                key="super_reports"/></a></li>
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/report/report_settings_edit.jsp?locale=${loc}"><fmt:message
                                key="customize_reports"/></a></li>
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/report/cust_report_list_frame.jsp?locale=${loc}"><fmt:message
                                key="global_reports"/></a></li>
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/report/filter_list.jsp?locale=${loc}"><fmt:message
                    ...
                    if (!STANDARD_UI && !isPrintCampaign) {
                        ...
                        if (
                                cust.s_cust_id.equals("194") ||
                                        ...
                                        cust.s_cust_id.equals("856") ||
                                        cust.s_cust_id.equals("866") ||
                                        cust.s_cust_id.equals("872") ||
                                        cust.s_cust_id.equals("615") ||
                                        cust.s_cust_id.equals("859") ||
                                        cust.s_cust_id.equals("878") ||
                                        cust.s_cust_id.equals("880") ||
                                        cust.s_cust_id.equals("881") ||
                                        cust.s_cust_id.equals("870")
                    ...
                    if (!STANDARD_UI && !isPrintCampaign) {
                        ...
                        if (
                                cust.s_cust_id.equals("146") ||
                                        ...
                                        cust.s_cust_id.equals("727") ||
                                        cust.s_cust_id.equals("748") ||
                                        cust.s_cust_id.equals("750") ||
                                        cust.s_cust_id.equals("754") ||
                                        cust.s_cust_id.equals("755") ||
                                        cust.s_cust_id.equals("775") ||
                                        cust.s_cust_id.equals("772") ||
                                        cust.s_cust_id.equals("773") ||
                                        cust.s_cust_id.equals("753") ||
                                        ...
                                        cust.s_cust_id.equals("720") ||
                                        cust.s_cust_id.equals("744") ||
                                        cust.s_cust_id.equals("771") ||
                                        cust.s_cust_id.equals("774") ||
                                        cust.s_cust_id.equals("783") ||
                                        cust.s_cust_id.equals("784") ||
                                        cust.s_cust_id.equals("786") ||
                                        cust.s_cust_id.equals("194") ||
                                        cust.s_cust_id.equals("791") ||
                                        cust.s_cust_id.equals("793") ||
                                        cust.s_cust_id.equals("795") ||
                                        cust.s_cust_id.equals("725") ||
                                        cust.s_cust_id.equals("800") ||
                                        cust.s_cust_id.equals("721") ||
                                        cust.s_cust_id.equals("770") ||
                                        cust.s_cust_id.equals("757") ||
                                        cust.s_cust_id.equals("777") ||
                                        cust.s_cust_id.equals("787") ||
                                        cust.s_cust_id.equals("788") ||
                                        ...
                                        cust.s_cust_id.equals("803") ||
                                        cust.s_cust_id.equals("805") ||
                                        cust.s_cust_id.equals("807") ||
                                        cust.s_cust_id.equals("810") ||
                                        cust.s_cust_id.equals("812") ||
                                        cust.s_cust_id.equals("814") ||
                                        cust.s_cust_id.equals("819") ||
                                        cust.s_cust_id.equals("823") ||
                                        cust.s_cust_id.equals("824") ||
                                        cust.s_cust_id.equals("832") ||
                                        cust.s_cust_id.equals("836") ||
                                        cust.s_cust_id.equals("837") ||
                                        cust.s_cust_id.equals("834") ||
                                        cust.s_cust_id.equals("838") ||
                                        cust.s_cust_id.equals("626") ||
                                        cust.s_cust_id.equals("700") ||
                                        cust.s_cust_id.equals("844") ||
                                        ...
                                        cust.s_cust_id.equals("843") ||
                                        cust.s_cust_id.equals("830") ||
                                        cust.s_cust_id.equals("849") ||
                                        cust.s_cust_id.equals("856") ||
                                        cust.s_cust_id.equals("859") ||
                                        cust.s_cust_id.equals("861") ||
                                        cust.s_cust_id.equals("869") ||
                                        cust.s_cust_id.equals("867") ||
                                        cust.s_cust_id.equals("866") ||
                                        cust.s_cust_id.equals("870") ||
                                        cust.s_cust_id.equals("874") ||
                                        cust.s_cust_id.equals("872") ||
                                        cust.s_cust_id.equals("845") ||
                                        cust.s_cust_id.equals("878") ||
                                        cust.s_cust_id.equals("881") ||
                                        cust.s_cust_id.equals("880") ||
                                        cust.s_cust_id.equals("896") ||
    ...
    //}
                ...
                <li class="sliding-element">
                    ...
                    <ul style="display:none;" class="subItems">
                        ...
                        <li <%= (showAdmn2 == 0) ? " style=\"display:none;\"" : "" %> class="sliding-element"><a
                                target="detail"
                                href="/cms/ui/jsp/form/form_list.jsp?amount=999999&locale=${loc}"><fmt:message
                        ...
                        <li <%= (showAdmn1 == 0) ? " style=\"display:none;\"" : "" %> class="sliding-element"><a
                                target="detail"
                                href="/cms/ui/jsp/setup/from_addresses/from_address_list.jsp?amount=999999&locale=${loc}"><fmt:message
                                key="from_address"/></a></li>
                        <li <%= (showAdmn3 == 0) ? " style=\"display:none;\"" : "" %> class="sliding-element"><a
                                target="detail"
                                href="/cms/ui/jsp/setup/cust_attrs/cust_attr_list.jsp?amount=999999&locale=${loc}"><fmt:message
                                key="custom_fields"/></a></li>
                        <li <%= (showAdmn4 == 0) ? " style=\"display:none;\"" : "" %> class="sliding-element"><a
                                target="detail"
                                href="/cms/ui/jsp/setup/categories/category_list.jsp?amount=999999&locale=${loc}"><fmt:message
                                key="categories"/></a></li>
                        <li <%= (showAdmn5 == 0) ? " style=\"display:none;\"" : "" %> class="sliding-element"><a
                                target="detail"
                                href="/cms/ui/jsp/setup/bbacks/bback_settings_edit.jsp?locale=${loc}"><fmt:message
                                key="bounceback_settings"/></a></li>
                        <li <%= (showAdmn6 == 0) ? " style=\"display:none;\"" : "" %> class="sliding-element"><a
                                target="detail"
                                href="/cms/ui/jsp/setup/cont_attrs/cont_attr_list.jsp?locale=${loc}"><fmt:message
                                key="content_settings"/></a></li>
                        <li <%= (showAdmn7 == 0) ? " style=\"display:none;\"" : "" %> class="sliding-element"><a
                                target="detail"
                                href="/cms/ui/jsp/setup/webview_msgs/webview_msg_list.jsp?locale=${loc}"><fmt:message
                                key="web_view"/></a></li>
                ...
                <li class="sliding-element">
                    ...
                    <ul style="display:none;" class="subItems">
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/setup/users/user_list.jsp?amount=999999&locale=${loc}"><fmt:message
                                key="users"/></a></li>
                    </ul>
                </li>
                ...
                <li class="sliding-element">
                    ...
                    <ul style="display:none;" class="subItems">
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/som/dofilter?redirect_url=index.jsp&locale=${loc}"><fmt:message
                                key="social_home"/></a></li>
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/som/dofilter?redirect_url=campaigns.jsp&locale=${loc}"><fmt:message
                                key="social_campaigns"/></a></li>
                        <li class="sliding-element"><a target="detail" class="loader"
                                                       href="/cms/ui/jsp/som/dofilter?redirect_url=reporting.jsp&locale=${loc}"><fmt:message
                                key="social_reporting"/></a></li>
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/jsp/som/dofilter?redirect_url=accounts.jsp&locale=${loc}"><fmt:message
                ...
                <li  <%= (showLeftTest == 0) ? " style=\"display:none;\"" : "" %> class="sliding-element">
                    <a href="javascript:void(null);" class="heading contents">Left Test</a>
                    <ul style="display:none;" class="subItems">
                        <li class="sliding-element"><a target="detail"
                                                       href="/cms/ui/recommendation/main.jsp?cust_id=<%=420%>">Configurations</a>
                        </li>

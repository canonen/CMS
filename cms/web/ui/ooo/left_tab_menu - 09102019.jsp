...
<%
	...
	//==================
		...
		//PERFORMANCE CENTER
		//--------------
			wFeat = ui.getFeatureAccess(Feature.MS_CRM);
		...
		<div id="navigation-block">
            <ul id="sliding-navigation">				
				<li class="sliding-element">
					<a href="javascript:void(null);" class="heading camps" <%= (showCamp == 0)?" style=\"display:none;\"":"" %>><fmt:message key="campaigns"/></a>
				 ...
				 */
				 %>
			    		 			...
			    		 			<li class="sliding-element">
					<a href="javascript:void(null);" class="heading webpush" <%= (showWebPush == 0)?" style=\"display:none;\"":"" %>>WebPush Campaigns</a>
					<ul style="display:none;" class="subItems">
					
						<li class="sliding-element"><a target="detail" href="<%= url_webpush_dash %>">Dashboard</a></li>
						<li class="sliding-element"><a target="detail" href="<%= url_webpush_campaigns2 %>">Send Notifications</a></li>
				...
				<% if(cust.s_cust_id.equals("723") || cust.s_cust_id.equals("420") || cust.s_cust_id.equals("617")) { %>
				  ...
				  <li class="sliding-element">
					<a href="javascript:void(null);" class="heading contents">CRM Ads</a>
					   <ul style="display:none;" class="subItems">
						...
						<%String rtr_export_type="https://dev.revotas.com/cms/ui/retargeting/retargeting_export_type.jsp?cust_id="+cid+"&revotas_user="+user.s_user_id;%>
					...
					<a href="javascript:void(null);" class="heading contents">Smart Widget</a>
					   <ul style="display:none;" class="subItems">
					    <li class="sliding-element"><a target="detail" href="/cms/ui/jsp/smartwidgets/popuplist.jsp">Popup Configurations</a></li>
				...
				<li class="sliding-element">
					<a href="javascript:void(null);" class="heading database"<%= (showData == 0)?" style=\"display:none;\"":"" %>><fmt:message key="database"/></a>
					<ul style="display:none;" class="subItems">
...
%>	
				...
				<li class="sliding-element">
					<a href="javascript:void(null);" class="heading contents"<%= (showCont == 0)?" style=\"display:none;\"":"" %>><fmt:message key="contents"/></a>
					<ul style="display:none;" class="subItems">
...
%>
				...
				<li class="sliding-element">
					<a href="javascript:void(null);" class="heading reports"<%= (showRept == 0)?" style=\"display:none;\"":"" %>><fmt:message key="reports"/></a>
					<ul style="display:none;" class="subItems">
...
%>
				...
				<li class="sliding-element">
					<a href="javascript:void(null);" class="heading settings"<%= (showAdmn == 0)?" style=\"display:none;\"":"" %>><fmt:message key="settings"/></a>
					<ul style="display:none;" class="subItems">
...
%>				
				<li class="sliding-element">
					<a href="javascript:void(null);" class="heading users"<%= (showAdmn == 0)?" style=\"display:none;\"":"" %>><fmt:message key="users"/></a>
					<ul style="display:none;" class="subItems">

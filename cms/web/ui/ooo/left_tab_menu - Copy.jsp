        ...
        <ul id="sliding-navigation">
            ...
            <li class="sliding-element">
                ...
                <ul style="display:none;" class="subItems">
                    ...
                    <li class="sliding-element"><a target="detail" href="/cms/ui/jsp/edit/recip_search.jsp"><fmt:message key="contact_search"/></a></li>
            ...
            <li class="sliding-element">
                ...
                <ul style="display:none;" class="subItems">
                    ...
                    <li class="sliding-element"><a target="detail" href="/cms/ui/jsp/ctm/index.jsp"><fmt:message key="templates"/></a></li>
                    <%
                        if (!STANDARD_UI && !isPrintCampaign) {
                    %>
                    <li class="sliding-element"><a target="detail" href="/cms/ui/jsp/cont/logic_block_list.jsp"><fmt:message key="dynamic"/></a></li>
                    <li class="sliding-element"><a target="detail" href="/cms/ui/jsp/cont/link_renaming_list.jsp"><fmt:message key="auto_link"/></a></li>
                    <li class="sliding-element"><a target="detail" href="/cms/ui/jsp/image/image_list.jsp"><fmt:message key="image_library"/></a></li>
                    <%
                        }
                    %>
                </ul>
            ...
            <li class="sliding-element">
                ...
                <ul style="display:none;" class="subItems">
                    <%String rtr="https://dev.revotas.com/cms/ui/retargeting/facebook_login.jsp?cust_id="+cid;%>
                    <li class="sliding-element"><a target="detail" href=<%=rtr%>>Facebook Login</a></li>
            ...
            <li class="sliding-element">
                ...
                <ul style="display:none;" class="subItems">
                    ...
                    <% } %>
                    <li class="sliding-element"><a target="detail" href="/cms/ui/jsp/report/super_camp_report_list.jsp"><fmt:message key="super_reports"/></a></li>
                    <li class="sliding-element"><a target="detail" href="/cms/ui/jsp/report/report_settings_edit.jsp"><fmt:message key="customize_reports"/></a></li>
                    <li class="sliding-element"><a target="detail" href="/cms/ui/jsp/report/cust_report_list_frame.jsp"><fmt:message key="global_reports"/></a></li>
                    <li class="sliding-element"><a target="detail" href="/cms/ui/jsp/report/filter_list.jsp"><fmt:message key="report_filters"/></a></li>
            ...
            <li class="sliding-element">
                ...
                <ul style="display:none;" class="subItems">
                    <li class="sliding-element"><a target="detail" href="<%= url_cj_dash %>">Dashboard</a></li>
            ...
            <li class="sliding-element">
                ...
                <ul style="display:none;" class="subItems">
                    ...
                    <li <%= (showAdmn5 == 0)?" style=\"display:none;\"":"" %> class="sliding-element"><a target="detail" href="/cms/ui/jsp/setup/bbacks/bback_settings_edit.jsp"><fmt:message key="bounceback_settings"/></a></li>
                    <li <%= (showAdmn6 == 0)?" style=\"display:none;\"":"" %> class="sliding-element"><a target="detail" href="/cms/ui/jsp/setup/cont_attrs/cont_attr_list.jsp"><fmt:message key="content_settings"/></a></li>
                    <li <%= (showAdmn7 == 0)?" style=\"display:none;\"":"" %> class="sliding-element"><a target="detail" href="/cms/ui/jsp/setup/webview_msgs/webview_msg_list.jsp"><fmt:message key="web_view"/></a></li>
                    <!--<li <%= (showAdmn8 == 0)?" style=\"display:none;\"":"" %> class="sliding-element"><a target="detail" href="/cms/ui/jsp/setup/webview_msgs/webview_msg_list.jsp"><fmt:message key="web_view"/></a></li>-->
                    <%
                        }
                    %>
                </ul>

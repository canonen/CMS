...
<fmt:bundle basename="app">
	...
	<frameset rows="80,*" border="0">
		<frame src="newtopnav.jsp?locale=<c:out value="${loc}"/>" name="topnav" scrolling="no" marginwidth="0" marginheight="0" noresize>
		<frameset cols="190,*" border="0">
			<frame src="left_tab_menu.jsp?locale=<c:out value="${loc}"/>" name="leftnav" scrolling="no" border="0"marginwidth="0" marginheight="0" noresize>

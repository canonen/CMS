...
<frameset cols="150,*"  BORDERCOLOR="C0C0C0" style="height:100%;">
	...
	<frameset rows="40,*" border=0 frameborder="0">
		...
		<frame name="detail" SRC="frame_zaf.jsp?url=<%= URLEncoder.encode("/cms/ui/jsp/" + sMainUrl,"UTF-8") %>" marginheight="0" marginwidth="5" leftmargin="5" topmargin="0" scrolling=auto>
	</frameset>
</frameset>

...
<input type="hidden" name="locale" value="${loc}"/>	
		...
		<div id="navigation-block">
            <ul id="sliding-navigation">				
				...
				<% if(cust.s_cust_id.equals("723") || cust.s_cust_id.equals("420")) { %>
				
				  <li class="sliding-element">
					<a href="javascript:void(null);" class="heading contents">Retargeting</a>
					   <ul style="display:none;" class="subItems">
                        ...
                        <li class="sliding-element"><a target="detail" href="https://dev.revotas.com/cms/ui/retargeting/facebookLoginCheck.jsp?amount=999999&locale=${loc}">Retargeting Export</a></li>
                       </ul>
				    </li>

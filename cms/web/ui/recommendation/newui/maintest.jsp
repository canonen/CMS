        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="tab-pane <%if(tarih_aralik != null){%>active<%}%>" id="campaign_report">
                    <div class="row">
                        <div class="col-12">
                            <form method="post" action="maintest.jsp?cust_id=<%=cust_id%>&camp_id=<%=camp_id%>">
...
<%
    if(camp_id!=null) {
        try {
            ...
            String sql = "select camp_name, camp_title, camp_type, template_id, status, products_num_block, container_size, rcp_link, currency_config, camp_add_to_cart, add_to_cart_script, filter_id, append_utm, exclude_recently_viewed, exclude_recently_purchased from "
            ...
            if(rs.next()) {
                ...
                filter_id = rs.getString(12);
                append_utm = rs.getString(13);
                exclude_recently_viewed = rs.getString(14);
                exclude_recently_purchased = rs.getString(15);
%>

    ...
    <div class="card">
        <div class="card-header p-2">
            <ul class="nav nav-pills">
                ...
                <li class="nav-item"><a class="nav-link" href="#campaign_content" data-toggle="tab">Content</a></li>
                <li class="nav-item"><a class="nav-link" href="#campaign_type" data-toggle="tab">Type</a></li>
                <li class="nav-item"><a class="nav-link" href="#campaign_add_to_cart" data-toggle="tab">Cart</a></li>
                <li class="nav-item"><a class="nav-link" href="#campaign_product_script" data-toggle="tab">Product</a></li>
                <li class="nav-item"><a class="nav-link" href="#campaign_template" data-toggle="tab">Template</a></li>
                <li class="nav-item"><a class="nav-link" href="#campaign_product_filter" data-toggle="tab">Product Filtering</a></li>
                ...
                <%}%>
                <button style="margin-left:auto;" id="saveCampaign" type="button" class="btn btn-primary" disabled>
                    Save
                </button>
        ...
        <div class="card-body">
            <div class="tab-content">
                ...
                <div class="tab-pane" id="campaign_type">
                    <div class="form-group col-md-6 row">
                        ...
                        <select id="campaignType" class="form-control select2" style="width: 100%;">
                            ...
                            <option value="150">Bought Together</option>
                        </select>
                    </div>
                    <div class="form-group col-md-6 row">
                        <label>Select Fallback Campaign Type</label>
                        <select id="fallbackCampaignType" class="form-control select2" style="width: 100%;">
                ...
                <!-- /.tab-pane -->
                <div class="tab-pane" id="campaign_add_to_cart">
                    <div class="form-group col-md-6 row">
                        <label>Show Add To Cart Button</label>
                        <select id="campaignAddToCart" class="form-control select2" style="width: 100%;">
                            <option value="1">Enabled</option>
                            <option value="0" selected>Disabled</option>
                        </select>
                    </div>
                    <div class="form-group col-md-12">
                        <label for="inputDescription">Add To Cart Script (JS Variables: productId)</label>
                        <textarea id="addToCartScript" class="form-control" rows="4"></textarea>
                    </div>
                </div>
                <div class="tab-pane" id="campaign_product_script">
                    <div class="form-group col-md-12">
                        <label for="inputDescription">Product JS (JS Variables: productDiv,selector)(Script will be executed for each product div)</label>
                        <textarea id="productScript" class="form-control" rows="4"></textarea>
                    </div>
                </div>
                ...
                <div class="tab-pane" id="campaign_product_filter">
                    <div class="form-group row">
                    ...
                    <div class="input-group condition-configs">
                        <div class="condition-panel">
                            <button style="margin-left:5px;display:none;" class="product-filtering-button btn btn-primary" onclick="groupConditions(this)" id="group-conditions">Group Conditions</button>
                            <button style="margin-left:5px;display:none;" class="product-filtering-button btn btn-primary" onclick="removeGroup(this)" id="remove-group">Remove Group</button>
                            <button style="margin-left:5px;display:none;" class="product-filtering-button btn btn-primary" onclick="ungroupConditions(this)" id="ungroup-conditions">Ungroup conditions</button>
                    ...
                    <button id="apply-conditions-all" class="btn btn-primary" disabled>Apply All</button>
                        ...
                        <div class="col-12 col-sm-6 col-md-4">
                            <div class="info-box">
                                ...
                                <div class="info-box-content">
                                    ...
                                    <span class="info-box-number" id="impression">
                  <small>%</small>
                </span>
                                </div>
                                <!-- /.info-box-content -->
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body row">
                ...
                <div class="form-group col-md-12">
                    <label>CSS Indexes</label>
                    <select id="cssIndexes" class="form-control select2" style="width: 100%;"></select>
                </div>
                <div class="form-group col-md-12">
...
<%
    if(camp_id!=null) {
        try {
            ...
            String fallback_camp_type=null;
            ...
            String camp_add_to_cart = null;
            String add_to_cart_script = null;
            String product_script = null;
            String filter_id = null;
            String append_utm = null;
            String exclude_recently_viewed = null;
            String exclude_recently_purchased = null;
            if(rs.next()) {
...
<%
    ...
    jsonObj.append("\"fallback_camp_type\":\""+fallback_camp_type+"\",");
    jsonObj.append("\"template_id\":\""+template_id+"\",");
    jsonObj.append("\"filter_id\":\""+filter_id+"\",");
    jsonObj.append("\"append_utm\":\""+append_utm+"\",");
    jsonObj.append("\"exclude_recently_viewed\":\""+exclude_recently_viewed+"\",");
    jsonObj.append("\"exclude_recently_purchased\":\""+exclude_recently_purchased+"\",");
    ...
    jsonObj.append("\"camp_add_to_cart\":\""+camp_add_to_cart+"\",");
    jsonObj.append("\"add_to_cart_script\":\""+add_to_cart_script+"\",");
    jsonObj.append("\"product_script\":\""+product_script+"\",");
...
<script>
    ...
    var fetchPromise = fetch('https://'+ rcpLink + '/rrcp/imc/recommendation/get_recommendation_data.jsp?cust_id=' + custId + '&camp_id=' + campaignId + (tarihAralik != 'null' ? '&tarih_aralik=' + tarihAralik : ''))
        ...
        .then(function(resp) {
            ...
            if(totalImpression == 0)document.getElementById('click-rate').innerHTML = '0.00<small>%</small>';

            document.getElementById('impression').innerHTML = totalImpression;
            ...
            //if(totalActivity == 0)document.getElementById('conversion-rate').innerHTML = '0.00<small>%</small>';

            if(totalOrder)document.getElementById('purchases').innerHTML = (totalOrder);
            if(totalRevenue && totalOrder){
                currencyFetched.then(()=>{
                    document.getElementById('avg-order-value').innerHTML = formatCurrency((totalRevenue/totalOrder).toFixed(2),currencyConfig);
                })
            }
            if(totalOrder == 0){
                document.getElementById('avg-order-value').innerHTML = formatCurrency('0.00',currencyConfig);;
            }


            if(totalRevenue) {
                currencyFetched.then(()=>{
                    document.getElementById('revenue').innerHTML = formatCurrency(totalRevenue,currencyConfig);
                })
            }
            if(totalContribution) {
                currencyFetched.then(()=>{
                    document.getElementById('contribution').innerHTML = formatCurrency(totalContribution,currencyConfig);
                })
            }
            if(isNaN(parseInt(totalContribution))){
                currencyFetched.then(()=>{
                    document.getElementById('contribution').innerHTML = formatCurrency('0.00',currencyConfig);
                })
            }
...
<script>
    ...
    var currencyFetched = fetch('https://'+rcpLink+'/rrcp/imc/currency/get_currency_config.jsp?cust_id=<%=cust_id%>')
        ...
        .then(resp => {
            ...
            currencyConfig = currencyConfigs.filter(config=>config.active==1)[0];

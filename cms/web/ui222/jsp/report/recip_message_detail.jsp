	...
	<tr>
		<td>
			...
			<table id="Tabs_Table1" cellspacing="0" cellpadding="0" border="0" class="layout" style="width:100%; height:100%;">
				...
				<col>
				<tr height="20">
					<td class="EditTabOn" id="tab1_Step1" onclick="switchSteps('Tabs_Table1', 'tab1_Step1', 'block1_Step1');" valign="center" nowrap align="middle">Campaign Details</td>
					<td class="EditTabOff" id="tab1_Step2" onclick="switchSteps('Tabs_Table1', 'tab1_Step2', 'block1_Step2');" valign="center" nowrap align="middle">Activities</td>
				...
				<tr>
					<td class="fillTab" valign="top" align="left" colspan="3">
						<table class="main layout" cellspacing="1" cellpadding="3" border="0" style="width:100%;height:100%;">
							<col width="150">
							<col>
							<col width="110">
							<col width="130">
					...
					for (int n=0; n < nCount; n++)
					{
						...
						%>
										<tr>
											...
											<td class="listItem_Title<%= sClassAppend %>" align="left" valign="middle"><nobr><%= sEventDateTxt %></nobr></td>
										</tr>
						<%
					}
				}

	...
	<tr>
		<td>
			<table id="Tabs_Table1" cellspacing="0" cellpadding="0" border="0" class="layout" style="width:100%; height:100%;">
				...
				<col>
				<tr height="20">
					<td class="EditTabOff" id="tab1_Step1" onclick="location.href='../edit/recip_edit.jsp?recip_id=<%= sRecipID %>';" valign="center" nowrap align="middle">Recipient Edit</td>
					<td class="EditTabOn" id="tab1_Step2" valign="center" nowrap align="middle">Campaign History</td>
				...
				<tr height="100">
					<td class="fillTabbuffer" valign="top" align="left" colspan="3" style="padding:8px;">
								...
								<td valign="top" align="center" style="padding:0px;">
									...
									if (eRoot != null && !eRoot.getTagName().toUpperCase().equals("ERROR"))
									{
										...
										<tr id="row_<%= sMsgID %>" style="display:none;">
											...
											<td class="listItem_Data<%= sClassAppend %>" align="left" valign="middle" colspan="6" style="padding:0px;">

...
<table cellpadding="3" cellspacing="0" border="0" width="95%">
	<tr>
		<td vAlign="middle" align="left" nowrap>
			<a class="newbutton" href="../filter/filter_edit.jsp?usage_type_id=<%=FilterUsageType.REPORT%>">New Report Filter</a>&nbsp;&nbsp;&nbsp;
		</td>
			...
			try
			{
				...
				<tr>
					...
					if (filterCount == 0)
					{
						%>
				<tr>
					<td class="listItem_Title" colspan="6" align="left" valign="middle">There are currently no Report Filters</td>
				</tr>
						<%
					}
				}

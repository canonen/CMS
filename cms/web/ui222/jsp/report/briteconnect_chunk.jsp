...
//	System.out.println(sListXML);
	...
	for (int n=0; n < xelChunks.getLength(); n++) {
		...
		out.println("	<tr>");
		out.println("		<td class=\"listItem_Title" + sClassAppend + "\"><a href=\"briteconnect_item.jsp?sync_id="+sSyncId+"&chunk_id="+sChunkId+"&direction="+sDirection+"&sync_date="+sSyncDate+"\">"+sChunkId+"</a></td>");

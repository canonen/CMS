...
<table width="100%" class=main cellspacing=0 cellpadding=0>
	<tr>
		<td class=sectionheader>&nbsp;<b class=sectionheader>Step <%=(nStep++)%>:</b> Choose super campaign link name</td>
	</tr>
</table>
<br>
...
<table class=main cellspacing=0 cellpadding=0 width="100%">
	<tr>
		<td class=sectionheader>&nbsp;<b class=sectionheader>Step <%=(nStep++)%>:</b> Select links for super campaign link</td>
	</tr>
</table>
<br>

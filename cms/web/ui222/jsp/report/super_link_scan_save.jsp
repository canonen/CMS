...
try	{
	...
	String sNumLinks = request.getParameter("num_links");
	int nLinks = Integer.parseInt(sNumLinks);

	String sSelectedCategoryId = request.getParameter("category_id");

	String[] superLinkIDs = request.getParameterValues("super_link_id");
	for (int i=0; i < superLinkIDs.length; i++) {
	//New Super Link
//		out.print(superLinkIDs[i]+", ");	

		String superLinkID = superLinkIDs[i];
		...
		String superLinkName = request.getParameter("sl"+superLinkIDs[i]+"_super_link_name");
		...
		String[] linkIDs = request.getParameterValues("sl"+superLinkIDs[i]+"_link_id");
...
<table width=650 class=main cellspacing=0 cellpadding=0>
	<tr>
		<td class=sectionheader>&nbsp;<b class=sectionheader>Report:</b> Scheduled</td>
	</tr>
</table>
<br>
<!---- Step 1 Info----->
			...
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle" style="padding:10px;">
						<b>The super campaign links saved.</b>

				...
				<td width="450">
					<xsl:element name="table">
						...
						<tr> 
							...
							<td class="reportmarkers" valign="middle" width="10%" align="left">0%</td>
							<td class="reportmarkers" valign="middle" width="10%" align="right"><img height="15" width="1" src="/ccps/ui/images/blank.gif" /></td>
						</tr>  
					</xsl:element>
				</td>
			</tr>
			<tr>
				...
				<td width="450">
					<xsl:element name="table">
						...
						<tr> 
							<td valign="middle" class="html" align="center"><img height="15" width="1" src="/ccps/ui/images/blank.gif" /></td> 
						</tr> 
					</xsl:element>
				</td>
			</tr>
				...
				<td width="450">
					<xsl:element name="table">
						...
						<xsl:element name="td">
							...
							<img height="15" width="1" src="/ccps/ui/images/blank.gif" />
						</xsl:element>

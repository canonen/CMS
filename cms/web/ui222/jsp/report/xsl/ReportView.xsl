	...
	<tr>
		...
		<xsl:if test="1 = /CampaignList/ReportCache">
			<table class="listTable" cellspacing="0" cellpadding="2" width="100%">
				...
				<tr>
					<td align="right" class="listItem_Data" nowrap="true">Start Date:</td>
					<td class="listItem_Data" width="100%"><nobr>&#160;<xsl:value-of select="/CampaignList/Campaigns/Row/Cache/StartDate"/></nobr></td>
				</tr>
				</xsl:if>
				<xsl:if test="/CampaignList/Campaigns/Row/Cache/EndDate!=''">
				<tr>
					<td align="right" class="listItem_Data_Alt" nowrap="true">End Date:</td>
					<td class="listItem_Data_Alt" width="100%"><nobr>&#160;<xsl:value-of select="/CampaignList/Campaigns/Row/Cache/EndDate"/></nobr></td>
				</tr>
				</xsl:if>
				<xsl:if test="/CampaignList/Campaigns/Row/Cache/AttrName!=''">
				<tr>
					<td align="right" class="listItem_Data" nowrap="true">Attribute:</td>
				...
				<tr>
					<td align="right" class="listItem_Data" nowrap="true">Only Recips Owned By User?</td>
					<td class="listItem_Data" width="100%">
						<xsl:choose>
...
<!-- First Report Grid -->
		...
		<xsl:if test="1 = /CampaignList/GeneralSecFlag">
			<table class="listTable" cellspacing="0" cellpadding="2" width="100%">
				...
				<tr>
					<td width="150" align="left" class="listItem_Data" nowrap="true">Messages Sent :</td>
					...
					<td class="listItem_Data" width="100%">
						<xsl:element name="table">
							...
							<tr> 
								...
								<td valign="middle" width="10%" align="left">0%</td>
								<td valign="middle" width="10%" align="right"><img height="10" width="1" src="/ccps/ui/images/blank.gif" /></td>
							</tr>
				...
				<tr>
					<td width="150" align="right" class="listItem_Data_Alt" nowrap="true">Total Bounceback :</td>
					...
					<td class="listItem_Data_Alt" width="100%">
						<xsl:element name="table">
							...
							<xsl:attribute name="cellspacing">0</xsl:attribute>
							<tr> 
								<td valign="middle" class="html" align="center"><img height="10" width="1" src="/ccps/ui/images/blank.gif" /></td> 
							</tr> 
						</xsl:element>
					</td>
				</tr>
				<tr>
					<td width="150" align="right" class="listItem_Data" nowrap="true">Total Reaching :</td>
					<td class="listItem_Data" nowrap="true">&#160;
						<xsl:element name="a">
...
<!-- Bounce Back Categories -->
		...
		<xsl:if test="1 = /CampaignList/BBackSecFlag">
			<table class="listTable" cellspacing="0" cellpadding="2" width="100%">
				...
				<tr>
					<td width="150" align="right" class="listItem_Data" nowrap="true">Total Bounceback :</td>
					<td class="listItem_Data" nowrap="true">&#160;
						<xsl:element name="a">
							<xsl:attribute name="href">javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=bbk&#38;Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>&#38;Z=<xsl:value-of select="CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="CampaignList/Campaigns/Row/CacheId"/>');</xsl:attribute>
							<xsl:value-of select="CampaignList/Campaigns/Row/BBacks"/>
...
<!--Recipient Actions -->
		...
		<xsl:if test="1 = /CampaignList/ActionSecFlag">
			<table class="listTable" cellspacing="0" cellpadding="2" width="100%">
				<tr>
					<th colspan="3">&#160;Recipient Actionss</th>
				</tr>
				<tr>
					<td width="150" align="right" class="listItem_Data" nowrap="true">Total Reaching :</td>
					<td class="listItem_Data" nowrap="true">&#160;
				...
				<tr>
					<td width="150" align="right" class="listItem_Data_Alt" nowrap="true">Total Open HTML :</td>
					<td class="listItem_Data_Alt" nowrap="true">&#160;
						<xsl:element name="a">
				...
				<tr>
					<td width="150" align="right" class="listItem_Data" nowrap="true">Total Click Throughs :</td>
					<td class="listItem_Data" nowrap="true">&#160;
						<xsl:element name="a">
							<xsl:attribute name="href">javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=click&#38;Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>&#38;Z=<xsl:value-of select="CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="CampaignList/Campaigns/Row/CacheId"/>');</xsl:attribute>
							<xsl:value-of select="CampaignList/Campaigns/Row/DistinctClicks"/>
				...
				<tr>
					<td width="150" align="right" class="listItem_Data_Alt" nowrap="true">Total Unsubscribes :</td>
					<td class="listItem_Data_Alt" nowrap="true">&#160;
						<xsl:element name="a">
							<xsl:attribute name="href">javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=unsub&#38;Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>&#38;Z=<xsl:value-of select="CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="CampaignList/Campaigns/Row/CacheId"/>');</xsl:attribute>
							<xsl:value-of select="CampaignList/Campaigns/Row/Unsubs"/>
		...
		<xsl:if test="1 = /CampaignList/BBackSecFlag">
			<table class="listTable" cellspacing="0" cellpadding="2" width="100%">
				...
				<tr>
					<td width="150" align="right" class="listItem_Data" nowrap="true">Total Unsubscribes :</td>
					<td class="listItem_Data" nowrap="true">&#160;
						<xsl:element name="a">
							<xsl:attribute name="href">javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=unsub&#38;Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>&#38;Z=<xsl:value-of select="CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="CampaignList/Campaigns/Row/CacheId"/>');</xsl:attribute>
							<xsl:value-of select="CampaignList/Campaigns/Row/Unsubs"/>
...
<!-- Detailed Clicks-->
		...
		<xsl:if test="1 = /CampaignList/DistClickSecFlag">
			<table class="listTable" cellspacing="0" cellpadding="2" width="100%">
				...
				<tr>
					<td width="150" align="right" class="listItem_Data" nowrap="true">Total Clicks :</td>
					<td class="listItem_Data" nowrap="true">&#160;
						<xsl:element name="a">
							<xsl:attribute name="href">javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=click&#38;Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>&#38;Z=<xsl:value-of select="CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="CampaignList/Campaigns/Row/CacheId"/>');</xsl:attribute>
							<xsl:value-of select="CampaignList/Campaigns/Row/DistinctClicks"/>
					...
					<td class="listItem_Data" width="100%">
						<xsl:element name="table">
							...
							<tr> 
								...
								<td class="reportmarkers" valign="middle" width="10%" align="left">0%</td>
								<td class="reportmarkers" valign="middle" width="10%" align="right"><img height="10" width="1" src="/ccps/ui/images/blank.gif" /></td>
							</tr>  
						</xsl:element>
					</td>
				</tr>
			<xsl:for-each select="CampaignList/Campaigns/Row/Links">
							...
							<xsl:element name="table">
								...
								<tr> 
									<xsl:element name="td">
										...
										<img height="10" width="1" src="/ccps/ui/images/blank.gif" />
									</xsl:element>
				...
				<tr>
					<td colspan="2" align="right" class="listItem_Data" nowrap="true">&#160;</td>
					<td class="listItem_Data" width="100%">
						<table cellspacing="0" cellpadding="3" border="0">
							<tr>
								<td align="left" valign="middle">Clickthrough Legend:</td>
								<td align="left" valign="middle">&#160;</td>
								<td class="text" align="left" valign="middle" style="border:1px solid #000000;"><img height="10" width="10" src="/ccps/ui/images/blank.gif" /></td>
								<td align="left" valign="middle">Text Click</td>
								<td align="left" valign="middle">&#160;</td>
								<td class="html" align="left" valign="middle" style="border:1px solid #000000;"><img height="10" width="10" src="/ccps/ui/images/blank.gif" /></td>
								<td align="left" valign="middle">HTML Click</td>
								<!--<td align="left" valign="middle">&#160;</td>
								<td class="aol" align="left" valign="middle" style="border:1px solid #000000;"><img height="10" width="10" src="/ccps/ui/images/blank.gif" /></td>
...
<!-- Form Submits -->
		...
		<xsl:if test="1 = /CampaignList/FormSecFlag">
			...
			<xsl:if test="1 = /CampaignList/TotReadFlag">
				<tr>
					<td align="right" class="listItem_Data" nowrap="true">Total HTML Email views</td>
					<td class="listItem_Data" width="100%">&#160; 
						<xsl:element name="a">
							<xsl:attribute name="href">javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=read&#38;Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>&#38;Z=<xsl:value-of select="CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="CampaignList/Campaigns/Row/CacheId"/>');</xsl:attribute>
			...
			<xsl:if test="1 = /CampaignList/MultiReadFlag">
				<tr>
					<td align="right" class="listItem_Data" nowrap="true">Opened HTML Email more than once</td>
					<td class="listItem_Data" width="100%">&#160; 
						<xsl:element name="a">
			...
			<xsl:if test="1 = /CampaignList/TotClickFlag">
				<tr>
					<td align="right" class="listItem_Data" nowrap="true">Aggregate Clickthroughs</td>
					<td class="listItem_Data" width="100%">&#160;
						<xsl:element name="a">
							<xsl:attribute name="href">javascript:pop_up_win('<xsl:value-of select="/CampaignList/DetailView"/>?Action=click&#38;Q=<xsl:value-of select="CampaignList/Campaigns/Row/Id"/>&#38;Z=<xsl:value-of select="CampaignList/ReportCache"/>&#38;C=<xsl:value-of select="CampaignList/Campaigns/Row/CacheId"/>');</xsl:attribute>
							<xsl:value-of select="CampaignList/Campaigns/Row/TotalClicks"/>
			...
			<xsl:if test="1 = /CampaignList/MultiLinkClickFlag">
				<tr>
					<td align="right" class="listItem_Data" nowrap="true">Clicked on more than one link</td>
					<td class="listItem_Data" width="100%">&#160;
						<xsl:element name="a">
			...
			<xsl:if test="1 = /CampaignList/LinkMultiClickFlag">
				<tr>
					<td align="right" class="listItem_Data" nowrap="true">Clicked on one link multiple times</td>
					<td class="listItem_Data" width="100%">&#160;
						<xsl:element name="a">

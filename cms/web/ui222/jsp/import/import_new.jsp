...
<table id="Tabs_Table1" cellspacing=0 cellpadding=0 width=650 border=0>
	...
	<tr>
		...
		<td class=EditTabOff id=tab1_Step2 width=150 onclick="switchSteps('Tabs_Table1', 'tab1_Step2', 'block1_Step2');" valign=center nowrap align=middle>Processing Details</td>

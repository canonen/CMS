...
%>
		<td align="left" valign="middle">
			<a class="deletebutton" href="#" onClick="if(a()) location.href='import_action.jsp?import_id=<%=sImportID%>&mode=rollback<%=(sSelectedCategoryId!=null)?"&category_id="+sSelectedCategoryId:""%>'">RollBack</a>&nbsp;
		</td>
<%
	}
...
%>
	<td align="left" valign="middle">
		<a class="deletebutton" href="#" onClick="if(a()) location.href='import_action.jsp?import_id=<%=sImportID%>&mode=delete<%=(sSelectedCategoryId!=null)?"&category_id="+sSelectedCategoryId:""%>'">Delete</a>
		...
		<td class=fillTab valign=top align=center width=650 colspan=3>
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					...
					<td width="475"><%= HtmlUtil.escape(imp.s_import_name) %></td>
				</tr>
				<tr>
					<td width="150">Batch</td>
					<td width="475"><%= HtmlUtil.escape(batch.s_batch_name) %></td>
				</tr>
				<tr>
					<td width="150">Data begins on</td>
					<td width="475"><%= (imp.s_first_row.equals("1"))?"1st":"2nd" %> row</td>
				</tr>
				<tr>
...
<%	if ((imp.s_multi_value_field_separator != null) && (imp.s_multi_value_field_separator.length() > 0)){ %>			
				<tr>
					<td width="150">Multi-Value Field Delimiter</td>
					<td width="475">
...
<%	if (!bStandardUI) { %>
				<tr>
					<td width="150">Import Rule</td>
					<td width="475"><%= sUpdRuleId %></td>
				</tr>
				<tr>
					<td width="150">Full Name Processing</td>
					<td width="475">Recipient full name was <%=(nFullNameFlag == 0)?"not":""%> calculated.</td>
				</tr>
<%	} %>
				<!--<tr><td width="150">Email Type Processing</td><td width="425">Recipient email type and confidence was <%=(nEmailTypeFlag==0)?"not":""%> calculated for duplicates.</td></tr>-->
<%	if (sNewsletters.length() > 0) { %>
				<tr>
					<td width="150">Newsletters</td>
					<td width="475"><%= sNewsletters %></td>
				</tr>
<%	} %>
			</table>
			<br>
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td width="150">Total records in import file</td>
					<td width="475"><%=(imp_stats.s_tot_rows!=null)?imp_stats.s_tot_rows:"N/A"%></td>
				</tr>
				<tr>
					<td width="150">Bad Rows in Import File</td>
					<td width="475"><FONT COLOR="RED"><%=(imp_stats.s_bad_rows!=null)?imp_stats.s_bad_rows:"N/A"%></FONT></td>
				</tr>
				<tr>
					<td width="150">Records that generated a warning in processing</td>
					<td width="475">
						<table BORDER=0>
							<tr>
...
<%	} %>
			...
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td width="150">Unrecoverable Fingerprint Records</td>
					<td width="475">
						<table BORDER=0>
							<tr>
...
<%	} %>
				...
				<tr>
					<td width="150">Unrecoverable Email Records</td>
					<td width="475">
						<table BORDER=0>
							<tr>
...
<%	} %>
				...
				<tr>
					<td width="150">Duplicates in the import file</td>
					<td width="475">
						<table BORDER=0>
							<tr>
...
<%	} %>
			...
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					...
					<td width="475"><%=(imp_stats.s_tot_recips!=null)?imp_stats.s_tot_recips:"N/A"%> recipients</td>
				</tr>
				<tr>
					<td width="150">Duplicates in the DB</td>
					<td width="475">
						<table BORDER=0>
							<tr>
...
<%	} %>
				...
				<tr>
					<td width="150">Committed</td>
					<td width="475"><%=(imp_stats.s_num_committed!=null)?imp_stats.s_num_committed:"N/A"%> recipients</td>
				</tr>
				<tr>
					<td width="150">Left to commit</td>
					<td width="475"><%=(imp_stats.s_left_to_commit!=null)?imp_stats.s_left_to_commit:"N/A"%> recipients</td>
				</tr>
<%	if (imp_stats.s_error_message != null) { %>
				<tr>
					<td width="150"><FONT COLOR="RED">Error</FONT></td>
					<td width="475"><%=imp_stats.s_error_message%></td>
				</tr>
<% } %>
			</table>
		</td>

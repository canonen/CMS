...
//          System.out.println(sSampleCampName + "Type/status/appflag/isSample/isPending:  " + nTypeId + "/" +  nStatusId + "/" + nAprovalFlag + "/" + nIsSample + "/" + isPending);
	...
	{
		sShowSampleStatus += "<table class=main cellspacing=1 cellpadding=2 width=100% border=0>\n";
		sShowSampleStatus += "	<tr>\n";
...
{
	sShowSampleStatus = "<table class=main cellspacing=1 cellpadding=2 width='100%'>\n";
	sShowSampleStatus += "	<tr>\n";

	...
	<table border="0" cellpadding="2" cellspacing="0" class="layout" style="width:100%; height:100%;">
		...
		<tr>
			<td class="sessionInfo" align="right" valign="middle">
				Welcome: <b><%= user.s_user_name %>&nbsp;<%= (user.s_last_name!=null)?user.s_last_name:"" %></b>,<br>  
				You are currently logged into<% if (hasChildren) { %> <a href="#" onclick="switch_cust();">[Switch]</a><% } %>:
				<br><b><%=cSuper.s_cust_name%></b>
		<%
		if (hasChildren)
		{
			if(cSuper != cActive)

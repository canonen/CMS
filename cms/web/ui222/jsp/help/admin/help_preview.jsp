...
<br>
	...
	<br><br>
		...
		try
		{
			...
			sSql = "select help_doc_id, display_heading from chlp_help_doc with(nolock) where approved_flag = 1 and type_id = 103 and (parent_help_doc_id = '" + sHelpDocID + "' or parent_help_doc_id = '" + sParentHelpDocID + "') order by help_order";
			pstmt = conn.prepareStatement(sSql);
			rs = pstmt.executeQuery();
			while (rs.next())
			{

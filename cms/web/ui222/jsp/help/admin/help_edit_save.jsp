...
<%
	...
	sHelpDocSaveSql = " EXECUTE usp_chlp_help_doc_save" +
...
<head>
	...
	<script language="javascript">
		...
		{
			window.opener.location.href = "help_list.jsp?help_doc_id=<%=s_help_doc_id%>";
		}
			...
			<table class=main cellspacing=1 cellpadding=2 width="625">
				<tr>
					<td align="left" valign="middle" style="padding:10px;">
						...
						<a href="help_preview.jsp?help_doc_id=<%=s_help_doc_id%>">Back to Preview</a><br><br>

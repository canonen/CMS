...
sRequest = new String("<request><action>helpsearch</action><criteria><![CDATA[" + searchCriteria + "]]></criteria></request>");
	...
	{		
		...
		if (nCount > 0)
		{
			for (int n=0; n < nCount; n++)
			{
				...
				<tr>
					<td colspan="2" align="left" valign="middle" style="padding:4px;"><a target="_parent" href="help_frame.jsp?topic=vl<%= sVolumeID %>-ch<%= sChapterID %>-pg<%= sPageID %>&help_doc_id=<%= sPageID %>&findCriteria=<%= findCriteria %>"><img src="imgs/16_helpDoc.gif" border="0" align="left"><%= sPageHeading %></a></td>
				</tr>
				<tr>
					<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td align="left" valign="middle" style="color:#676767;"><i><%= sVolumeHeading %> > <%= sChapterHeading %></i></td>
				</tr>
				<tr>

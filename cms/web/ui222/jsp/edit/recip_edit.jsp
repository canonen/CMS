	...
	<tr>
		<td>
			<table id="Tabs_Table1" cellspacing="0" cellpadding="0" border="0" class="layout" style="width:100%; height:100%;">
				...
				<col>
				<tr height="20">
					<td class="EditTabOn" id="tab1_Step1" valign="center" nowrap align="middle">Recipient Edit</td>
					<td class="EditTabOff" id="tab1_Step2" onclick="location.href='../report/recip_camp_history.jsp?recip_id=<%= sRecipID %>';" valign="center" nowrap align="middle">Campaign History</td>
				...
				<tr height="50">
					<td class="fillTabbuffer" valign="top" align="center" colspan="3" style="padding:8px;">

		...
		<td class="listHeading" valign="center" nowrap align="left">
			...
			<table class=listTable cellspacing=0 cellpadding=2 width="100%">
				<tr>
					...
					<td align="left" valign="middle" nowrap><a class="subactionbutton" href="#" onClick="try_submit(FT.email.value, '');" <%=(!bCanRead)?"disabled":""%>>Search</a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
					<td align="left" valign="middle" width="100%" rowspan="3" style="padding:10px;">
						Enter the email address or last name of a recipient to find a recipient's record in the database. 
						You must type in the last name or email address exactly as it is stored in the database, no wildcards are allowed.
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td align="left" valign="middle" nowrap><a class="subactionbutton" href="#" onClick="try_submit('', FT.lastname.value);" <%=(!bCanRead)?"disabled":""%>>Search</a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
				</tr>
			</table>
		</td>
	</tr>

...
<table cellspacing="0" cellpadding="0" width="95%" border="0">
	<tr>
		...
		<td class="SpecialTabOn" width="34%" onclick="location.href = 'cont_block_list.jsp';" valign="center" nowrap align="middle">Content Elements</td>
		<td class="SpecialTabOff" width="33%" onclick="location.href = 'filter_list.jsp';" valign="center" nowrap align="middle">Logic Elements</td>
	</tr>
</table>
<br>
<table cellpadding="3" cellspacing="0" border="0" width="95%">
	<tr>
		<td vAlign="middle" align="left" nowrap>
			<% if (can.bWrite) { %>
			<a class="newbutton" href="cont_block_edit.jsp<%=(sSelectedCategoryId!=null)?"?category_id="+sSelectedCategoryId:""%>">New Content Element</a>&nbsp;&nbsp;&nbsp;
			<a class="newbutton" href="cont_element_load_manual.jsp">Import Elements</a>&nbsp;&nbsp;&nbsp;
                        <a class="newbutton" href="cont_element_load_zip.jsp">Import Zip File</a>&nbsp;&nbsp;&nbsp;
			<% } %>	
		</td>

...
<table cellspacing="0" cellpadding="0" width="95%" border="0">
	<tr>
		<td class="SpecialTabOn" width="34%" onclick="location.href = 'logic_block_list.jsp';" valign="center" nowrap align="middle">Logic Blocks</td>
...
<table cellpadding="3" cellspacing="0" border="0" width="95%">
	<tr>
		<td vAlign="middle" align="left" nowrap>
			<% if (can.bWrite) { %>
			<a class="newbutton" href="logic_block_edit.jsp<%=(sSelectedCategoryId!=null)?"?category_id="+sSelectedCategoryId:""%>">New Logic Block</a>&nbsp;&nbsp;&nbsp;
			<% } %>
		</td>

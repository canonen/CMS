...
<%
	...
	try
	{
		...
		if (contID!=null)
		{
			...
			{
				htmlTracking += "<tr>\n";
				htmlTracking += (bShowButton?"<td align=\"right\" valign=\"middle\" nowrap><a class=\"subactionbutton\" href=\"#EditLink\" onclick=\"EditLinkTable()\">edit</a></td>\n":"");
				b = rs.getBytes(1);
				...
				htmlTracking += (bShowButton?"<td align=\"right\" valign=\"middle\" nowrap><a class=\"resourcebutton\" href=\"#EditLink\" onclick=\"CloneLinkTable()\">clone</a></td>\n":"");
				htmlTracking += (bShowButton?"<td align=\"right\" valign=\"middle\" nowrap><a class=\"resourcebutton\" href=\"javascript:void(0);\" onclick=\"DeleteLinkTable()\">delete</a></td>\n":"");
				htmlTracking += "</tr>\n";
			}
			rs.close();
		}
...
function AddLinkTable()
{
	...
	newCell.noWrap = true;
	newCell.innerHTML = "<a class=\"subactionbutton\" href=\"#EditLink\" onclick=\"EditLinkTable()\">edit</a>";
	...
	newCell.vAlign = "middle";
	newCell.noWrap = true;
	newCell.innerHTML = "<a class=\"resourcebutton\" href=\"#EditLink\" onclick=\"CloneLinkTable()\">clone</a>";
	
	newCell = newRow.insertCell();
	newCell.align = "right";
	newCell.vAlign = "middle";
	newCell.noWrap = true;
	newCell.innerHTML = "<a class=\"resourcebutton\" href=\"javascript:void(0);\" onclick=\"DeleteLinkTable()\">delete</a>";

	FT.EditLinkName.value = "";
	FT.EditLinkURL.value = "";
}

function CloneLinkTable()
{
	var LinkName;
	var LinkURL;
	...
	LinkName = oElem.cells(1).innerText;
	LinkURL = oElem.cells(2).innerText;
	
	FT.EditLinkName.value = LinkName;
	FT.EditLinkURL.value = LinkURL;
}

function EditLinkTable()
{
	var LinkName;
	var LinkURL;
	var rIndex;
...
function SubmitPrepare(Act)
{
	...
	for (i=0; i < oTable.rows.length; i++)
	{
		...
		{
			var oOption = document.createElement("OPTION");
			oOption.text = oTable.rows(i).cells(2).innerText;
			oOption.value = oTable.rows(i).cells(1).innerText;
			oOption.value += "\n" + oOption.text;
	...
	<tr>
		<td valign="top">
			...
			<table id="Tabs_Table3" cellspacing=0 cellpadding=0 width="100%" border=0>
				<tr>
					<td class=EditTabOn id=tab3_Step1 width=150 onclick="switchSteps('Tabs_Table3', 'tab3_Step1', 'block3_Step1');" valign=center nowrap align=middle>Text</td>
					<td class=EditTabOff id=tab3_Step2 width=150 onclick="switchSteps('Tabs_Table3', 'tab3_Step2', 'block3_Step2');" valign=center nowrap align=middle>HTML</td>
	...
	<tr height="375">
		<td valign="top">
			...
			<table id="Tabs_Table4" cellspacing=0 cellpadding=0 border=0 class="layout" style="width:100%; height:100%;">
				...
				<col>
				<tr height="22">
					<td class=EditTabOn id=tab4_Step1 onclick="switchSteps('Tabs_Table4', 'tab4_Step1', 'block4_Step1');" valign=center nowrap align=middle>Link Scanning</td>
					<td class=EditTabOff id=tab4_Step2 onclick="switchSteps('Tabs_Table4', 'tab4_Step2', 'block4_Step2');" valign=center nowrap align=middle>Advanced Options</td>
			...
			<%		} %>
										...
										<tr height="25">
											<td colspan="2" align="left">
												<a class="subactionbutton" href="javascript:void(0);" onclick="AddLinkTable()">add</a>								
											</td>
										</tr>
									</table>
								</td>

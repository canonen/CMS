...
if (MODE.equals("send_test")) {
	String sRedirectUrl = "/cms/ui/jsp/camp/camp_send.jsp?wizard_mode=true&camp_id=" + camp.s_camp_id + "&mode=test";
	response.sendRedirect(sRedirectUrl);
}
else if (MODE.equals("send_camp"))
{
	String sRedirectUrl = "/cms/ui/jsp/camp/camp_send_confirm.jsp?camp_id=" + camp.s_camp_id;
...
{
	String sRedirectUrl = "wizard_list.jsp";
	response.sendRedirect(sRedirectUrl);
}
...
<BODY onload="location.href = 'wizard.jsp?step=<%= CUR_STEP %>&camp_id=<%= camp.s_camp_id %><%=(CATEGORY_ID!=null)?"&category_id="+CATEGORY_ID:""%>';">
</BODY>
</HTML>

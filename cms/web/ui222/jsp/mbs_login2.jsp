...
<form method="POST" action="mbs_login2.jsp" name="login_form">
...
<td bgcolor=#ffffff width=250>
				...
				<% } else { %>
					...
					<tr>
						<td align="center" valign="bottom" colspan="2">&nbsp;<IMG border="0" src="../nav/mbs_insight/logo.gif"></TD>
					</tr>
					<tr>
...
{
	ErrLog.put(this, ex, "Error in mbs_login2.jsp", out, 1);
}
finally
{
}

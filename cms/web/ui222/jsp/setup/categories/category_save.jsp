...
category.s_category_descrip = BriteRequest.getParameter(request,"category_descrip");
...
<table width=650 class=main cellspacing=0 cellpadding=0>
	<tr>
		<td class=sectionheader>&nbsp;<b class=sectionheader>Category:</b> Saved</td>
	</tr>
</table>
<br>
<!---- Step 1 Info----->
			...
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle" style="padding:10px;">
						...
						<BR><BR>
						<A href="category_edit.jsp?category_id=<%=category.s_category_id%>">Back to edit</A>
					</td>
				</tr>
			</table>
		</td>

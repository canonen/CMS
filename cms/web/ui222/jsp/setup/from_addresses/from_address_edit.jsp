...
<br>
<TABLE cellpadding="0" cellspacing="0" class="main" width="400">
	<TR>
		<% if (sFromAddressId != null){	%>
		<TD class="sectionheader"><B class="sectionheader">Step 1:</B> Edit from address</TD>
		<% }else{ %>
		<TD class="sectionheader"><B class="sectionheader">Step 1:</B> Enter New from address</TD>
		<% }%>
	</TR>
</TABLE>
<br>
<table cellspacing=0 cellpadding=0 width=400 border=0>
	<tr>
		<td class=EmptyTab valign=center nowrap align=middle width=400><img height=2 src="../../images/blank.gif" width=1></td>
	</tr>
	<tr>
		<td class=fillTabbuffer valign=top align=left width=400 colspan=2><img height=2 src="../../images/blank.gif" width=1></td>
	</tr>
	<tr>
		<td class=fillTab>
			<TABLE class=main border="0" cellspacing="1" cellpadding="2">
				<TR>

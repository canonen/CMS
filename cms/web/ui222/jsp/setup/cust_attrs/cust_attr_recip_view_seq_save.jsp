...
<table width=650 class=main cellspacing=0 cellpadding=0>
	<tr>
		<td class=sectionheader>&nbsp;<b class=sectionheader>Custom Fields:</b> Recipient View Sequence Saved</td>
	</tr>
</table>
<br>
<!---- Step 1 Info----->
			...
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle" style="padding:10px;">
						<b>The recipient attribute view sequence was saved.</b>
						<BR><BR>
						<A href="cust_attr_list.jsp">Back to list</A>
						<BR><BR>
						<A href="cust_attr_recip_view_seq.jsp">Back to edit</A>
					</td>
				</tr>
			</table>
		</td>

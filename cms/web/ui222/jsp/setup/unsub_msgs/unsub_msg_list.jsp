...
<%
	...
	try
	{
		...
		while(rs.next())
		{
			...
			htmlContentRow += "<tr><td class=\"listItem_Title" + sClassAppend + "\"><a href=\"unsub_msg_edit.jsp?msg_id=" + sMsgId + "\">" + sMsgName + "</a>&nbsp;</td></tr>";
...
<html>
<head>
<title>Unsubscribe Message List</title>
...
<script language="javascript">
	...
	{
		var sURL = "";		
		sURL = "unsub_msg_edit.jsp?msg_id=" + msg_id;
		location.href = sURL;
	}
...
<table cellpadding="3" cellspacing="0" border="0" width="95%">
	<tr>
		...
		<td vAlign="middle" align="left" nowrap>
			<a class="newbutton" href="unsub_msg_edit.jsp">New Unsubscribe Message</a>&nbsp;&nbsp;&nbsp;
		</td>
		<% } %>
...
<div id="filterBox" style="display:none;">
	<FORM  METHOD="GET" NAME="FT" ID="FT" ACTION="unsub_msg_list.jsp" style="display:inline;">
	<INPUT TYPE="hidden" NAME="pageCount" VALUE="">
	<INPUT TYPE="hidden" NAME="curPage" VALUE="<%= curPage %>">
	<table class="listTable" cellspacing="0" cellpadding="2" border="0">
		<tr>
			<th valign="middle" align="left" colspan="2">Filter the Unsubscribe Messages</th>
	...
	<tr>
		<td class="listHeading" valign="center" nowrap align="left">
			...
			<table class="listTable" width="100%" cellpadding="2" cellspacing="0">
				...
				<!-- List of the unsubscribe messages -->
				<%= htmlContent %>
				</tbody>
			</table>
		</td>

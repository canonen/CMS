...
function showHideSections(item)
{
...
%>
	<tr>
		...
		<td align="left" valign="middle" class="listItem_Data" style="padding-left:10px;" width="100%">
			<form name="filter_7" method="post" action="../edit/save.jsp?usage_type_id=<%= sUsageTypeId %>" style="display:inline;">
...
//-->
	<tr>
		...
		<td align="left" valign="middle" class="listItem_Data_Alt" style="padding-left:10px;" width="100%">
			<form name="filter_3" method="post" action="../edit/save.jsp?usage_type_id=<%= sUsageTypeId %>" style="display:inline;">
...
%>
	<tr>
		...
		<td align="left" valign="middle" class="listItem_Data" style="padding-left:10px;" width="100%">
			<form name="filter_1" method="post" action="../edit/save.jsp?usage_type_id=<%= sUsageTypeId %>" style="display:inline;">
...
%>
	<tr>
		...
		<td align="left" valign="middle" class="listItem_Data_Alt" style="padding-left:10px;" width="100%">
			<form name="filter_14" method="post" action="../edit/save.jsp?usage_type_id=<%= sUsageTypeId %>" style="display:inline;">
...
//-->
	<tr>
		...
		<td align="left" valign="middle" class="listItem_Data_Alt" style="padding-left:10px;" width="100%">
			<form name="filter_24" method="post" action="../edit/save.jsp?usage_type_id=<%= sUsageTypeId %>" style="display:inline;">
...
//-->
	<tr>
		...
		<td align="left" valign="middle" class="listItem_Data_Alt" style="padding-left:10px;" width="100%">
			<form name="filter_8" method="post" action="../edit/save.jsp?usage_type_id=<%= sUsageTypeId %>" style="display:inline;">
...
<table class="listTable" width="100%" cellpadding="2" cellspacing="0" id="filterTable">
	...
	%>
	<tr>
		<td align="center" valign="middle" class="listItem_Data" nowrap style="padding:5px;"><a class="subactionbutton" href="javascript:void(0);" onclick="showHideSections('select_10');">[+]</a></td>
			...
			<table class="main" width="100%" cellpadding="2" cellspacing="0">
				<tr>
					...
					<td align="left" valign="middle" class="listItem_Data_Alt" width="100%" nowrap>
						<form name="filter_1_1" method="post" action="../edit/save.jsp?usage_type_id=<%= sUsageTypeId %>" style="display:inline;">
							<input type="hidden" name="filter_name" value="">
							<input type="hidden" name="param_name" value="camp_id">
							<input type="hidden" name="string_value" value="">
							<input type="hidden" name="date_value" value="">
				...
				<tr>
					...
					<td align="left" valign="middle" class="listItem_Data" width="100%" nowrap>
						<form name="filter_5" method="post" action="../edit/save.jsp?usage_type_id=<%= sUsageTypeId %>" style="display:inline;">
	...
	<% } %>
	<tr>
		<td align="center" valign="middle" class="listItem_Data_Alt" nowrap style="padding:5px;"><a class="subactionbutton" href="javascript:void(0);" onclick="showHideSections('select_20');">[+]</a></td>
		...
		<td align="left" valign="middle" class="listItem_Data_Alt" colspan="2" nowrap style="padding:0px;">
			<table class="main" width="100%" cellpadding="2" cellspacing="0">
				...
				<tr>
					...
					<td align="left" valign="middle" class="listItem_Data" width="100%" nowrap>
						<form name="filter_7_1" method="post" action="../edit/save.jsp?usage_type_id=<%= sUsageTypeId %>" style="display:inline;">
							<input type="hidden" name="type_id" value="<%=FilterType.IMPORT%>">
							<input type="hidden" name="filter_name" value="">
							<input type="hidden" name="param_name" value="import_id">
							<input type="hidden" name="string_value" value="">
				...
				<tr>
					...
					<td align="left" valign="middle" class="listItem_Data_Alt" width="100%" nowrap>
						<form name="filter_3_1" method="post" action="../edit/save.jsp?usage_type_id=<%= sUsageTypeId %>" style="display:inline;">
							<input type="hidden" name="type_id" value="<%=FilterType.BATCH%>">
							<input type="hidden" name="filter_name" value="">
							<input type="hidden" name="param_name" value="batch_id">
							<input type="hidden" name="string_value" value="">
				...
				<tr>
					...
					<td align="left" valign="middle" class="listItem_Data" width="100%" nowrap>
						<form name="filter_24_1" method="post" action="../edit/save.jsp?usage_type_id=<%= sUsageTypeId %>" style="display:inline;">
							<input type="hidden" name="type_id" value="<%=FilterType.NEWSLETTER%>">
							<input type="hidden" name="filter_name" value="">
							<input type="hidden" name="param_name" value="attr_id">
							<input type="hidden" name="string_value" value="">
	...
	%>
	<tr>
		<td align="center" valign="middle" class="listItem_Data" nowrap style="padding:5px;"><a class="subactionbutton" href="javascript:void(0);" onclick="showHideSections('select_30');">[+]</a></td>
		...
		<td align="left" valign="middle" class="listItemData" colspan="2" nowrap style="padding:0px;">
			<table class="main" width="100%" cellpadding="2" cellspacing="0">
				<tr>
					...
					<td align="left" valign="middle" class="listItem_Data_Alt" width="100%" nowrap>
						<form name="filter_14_1" method="post" action="../edit/save.jsp?usage_type_id=<%= sUsageTypeId %>" style="display:inline;">
							<input type="hidden" name="type_id" value="<%=FilterType.FORM_SUBMIT%>">
							<input type="hidden" name="filter_name" value="">
							<input type="hidden" name="param_name" value="form_id">
							<input type="hidden" name="string_value" value="">
	...
	//-->
	<tr>
		<td align="center" valign="middle" class="listItem_Data" nowrap style="padding:5px;"><a class="subactionbutton" href="javascript:void(0);" onclick="showHideSections('select_40');">[+]</a></td>
...
<tr>
		<td align="center" valign="middle" class="listItem_Data" nowrap style="padding:5px;"><a class="subactionbutton" href="javascript:void(0);" onclick="showHideSections('select_50');">[+]</a></td>
		<td align="left" valign="middle" class="listItem_Data" width="100%" nowrap colspan="2">BriteTrack Information</td>
	</tr>

...
%>
			<td vAlign="middle" align="left">
				<a class="savebutton" href="#" onClick="filter_save(); return false;">Save</a>
			</td>
     <% } 
		if ( (!bWorkflow
				|| (bWorkflow && can.bApprove) 
     ...
     %>
			<td vAlign="middle" align="left">
				<a class="savebutton" href="#" onClick="filter_save_and_update(); return false;">Save & Update</a>
			</td>
	<%	} 
...
%>
               <td vAlign="middle" align="left">
                    <a class="deletebutton" href="#" onClick="filter_delete(); return false;">Delete</a>
               </td>
<%
     }
%>
...
<table cellpadding="0" cellspacing="0" class="main" width="100%">
	<tr>
		<td class="sectionheader"><B class="sectionheader">Step 1:</B> Name your <%= sTargetGroupDisplay %></td>
	</tr>
</table>
<br>
...
<table cellpadding="0" cellspacing="0" class="main" width="100%">
	<tr>
		<td class="sectionheader"><B class="sectionheader">Step 2:</B> Build <%= sTargetGroupDisplay %></td>
	</tr>
</table>
<br>
...
<table cellpadding="0" cellspacing="0" class="main" width="100%">
	<tr>
		<td class="sectionheader"><B class="sectionheader">Step 3:</B> Add fields to Preview</td>
	</tr>
</table>
<br>
	...
	<tr>
		<td class=fillTab valign=top align=center width=100%>
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="left" valign="middle">
						<%@ include file="filter_preview_attrs.inc"%>
					</td>
				</tr>
			</table>
		</td>
...
<table cellpadding="0" cellspacing="0" class="main" width="100%">
	<tr>
		<td class="sectionheader"><B class="sectionheader">Update History</B></td>
	</tr>
</table>
<BR>
...
<%@ include file="filter_functions.inc"%>

...
<HEAD>
	<TITLE><%= sTargetGroupDisplay %>: Recipients who opened an HTML email for a specific Campaign</TITLE>
	...
	<SCRIPT>
		...
		function setFilterName(obj)
		{
			...
			filter_form.filter_name.value = '(OPEN HTML) ' + ops[si].text;
			display_name.innerText = "(OPEN HTML) " + ops[si].text;
...
%>
<INPUT type=hidden name=type_id value="<%=FilterType.LINK_READ%>">
		...
		%>
				<tr>
					<td align="center" valign="middle" style="padding:10px;">
						Recipients who opened an HTML email for a specific Campaign<br>

...
<table id="Tabs_Table1" cellspacing=0 cellpadding=0 width=100% border=0>
	...
	<tr>
		<td class=fillTab valign=top align=center width=100%>
			...
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle">Start by selecting an Action the recipient performed
							<%
	...
	<!-- =============================================================================== -->
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle">Next, select a second Action the recipient performed during the same transaction
							<%
							sSql  = " SELECT actiontype, actionname FROM cjtk_action_type WHERE cust_id = " + cust.s_cust_id + " ORDER BY actionname";
			...
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle" width="100%" colspan="2">Next, calculate the dates in which the recipient performed the Actions</td>
				</tr>
				<tr>

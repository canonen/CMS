...
<HEAD>
	...
	<SCRIPT>
		function do_submit()
		{
			...
			{
				alert("Zero is not a valid number for the Campaign Count. Only recipients who received a campaign can be used in calculations.")
		...
		function setCalcInfo()
		{
			...
			countSpan = document.all.item("camp_count");
			countCamps = filter_form.main_count.value;
			
			countSpan.innerText = countCamps;
		}
...
%>
<INPUT type=hidden name=type_id value="<%=FilterType.MSG_COUNT_WITHIN_TIME_INTERVAL%>">
...
<table id="Tabs_Table1" cellspacing=0 cellpadding=0 width=100% border=0>
	...
	<tr>
		<td class=fillTab valign=top align=center width=100%>
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle" style="padding:5px;">
						<b>Campaign Calculations</b><br>
						Select recipients who received a specified number of campaigns during a specified time period.<br>
			...
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle">Start by selecting the number of campaigns a recipient received</td>
				</tr>
				<tr>
			...
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle" width="100%" colspan="2">Next, calculate the dates in which the recipient received those <span id="camp_count"><%= HtmlUtil.escape(sMainCount) %></span> campaign(s)</td>
				</tr>
				<tr>
					...
					<td align="center" valign="top" width="50%">
						<table cellspacing="0" cellpadding="2" border="0" width="100%">
							...
							<tr>
								<td align="center" valign="middle" colspan="2">
									The campaigns were received where the Campaign send date is 
								</td>
							</tr>
							<tr>

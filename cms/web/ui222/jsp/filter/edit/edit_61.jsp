...
<table id="Tabs_Table1" cellspacing=0 cellpadding=0 width=100% border=0>
	...
	<tr>
		<td class=fillTab valign=top align=center width=100%>
			...
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle">Start by selecting the percentage of campaigns a recipient submitted Forms from</td>
				</tr>
				<tr>
			...
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle" width="100%" colspan="2">Next, calculate the dates in which the recipient submitted those <span id="link_count"><%= HtmlUtil.escape(sMainCount) %></span> forms(s)</td>
				</tr>
				<tr>

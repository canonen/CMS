...
<%
	...
	String sActionType = BriteRequest.getParameter(request, "action_type");
	String sActionParam = BriteRequest.getParameter(request, "action_param");
	String sActionParamCompareOperation = BriteRequest.getParameter(request, "action_param_compare_operation");
	String sActionParamCompareValue = BriteRequest.getParameter(request, "action_param_compare_value");
	
	String sActionType2 = BriteRequest.getParameter(request, "action_type_2");
	String sActionParam2 = BriteRequest.getParameter(request, "action_param_2");
	String sActionParamCompareOperation2 = BriteRequest.getParameter(request, "action_param_compare_operation_2");
	String sActionParamCompareValue2 = BriteRequest.getParameter(request, "action_param_compare_value_2");
	...
	if(sActionType != null)
	{
		...
		fp.s_param_name = "action_type";
		fp.s_string_value = sActionType;
		fp.s_integer_value = sActionType;
		fps.add(fp);
	}
	...
	if(sActionParam != null)
	{
		fp = new FilterParam();
		fp.s_param_id = String.valueOf(++nParamId);
		fp.s_param_name = "action_param";
		fp.s_string_value = sActionParam;
		fp.s_integer_value = sActionParam;
		fps.add(fp);
		
		String stype = getParamType(sActionParam);
		fp = new FilterParam();
		fp.s_param_id = String.valueOf(++nParamId);
		fp.s_param_name = "action_param_type";
		fp.s_string_value = stype;
		fp.s_integer_value = stype;
		fps.add(fp);
	}
	
	if(sActionParamCompareOperation != null)
	{
		fp = new FilterParam();
		fp.s_param_id = String.valueOf(++nParamId);
		fp.s_param_name = "action_param_compare_operation";
		fp.s_string_value = sActionParamCompareOperation;
		fps.add(fp);
	}
	
	if(sActionParamCompareValue != null)
	{
		fp = new FilterParam();
		fp.s_param_id = String.valueOf(++nParamId);
		fp.s_param_name = "action_param_compare_value";
		fp.s_string_value = sActionParamCompareValue;
		fps.add(fp);
	}
	
	if(sActionType2 != null)
	{
		fp = new FilterParam();
		fp.s_param_id = String.valueOf(++nParamId);
		fp.s_param_name = "action_type_2";
		fp.s_string_value = sActionType2;
		fp.s_integer_value = sActionType2;
		fps.add(fp);
	}
	
	if(sActionParam2 != null)
	{
		fp = new FilterParam();
		fp.s_param_id = String.valueOf(++nParamId);
		fp.s_param_name = "action_param_2";
		fp.s_string_value = sActionParam2;
		fp.s_integer_value = sActionParam2;
		fps.add(fp);
		
		String stype = getParamType(sActionParam2);
		fp = new FilterParam();
		fp.s_param_id = String.valueOf(++nParamId);
		fp.s_param_name = "action_param_type_2";
		fp.s_string_value = stype;
		fp.s_integer_value = stype;
		fps.add(fp);
	}
	
	if(sActionParamCompareOperation2 != null)
	{
		fp = new FilterParam();
		fp.s_param_id = String.valueOf(++nParamId);
		fp.s_param_name = "action_param_compare_operation_2";
		fp.s_string_value = sActionParamCompareOperation2;
		fps.add(fp);
	}
	
	if(sActionParamCompareValue2 != null)
	{
		fp = new FilterParam();
		fp.s_param_id = String.valueOf(++nParamId);
		fp.s_param_name = "action_param_compare_value_2";
		fp.s_string_value = sActionParamCompareValue2;
		fps.add(fp);
	}
...
<%!
private static String getParamType(String param) throws Exception
{
	String stype = null;
	...
	try
	{
		...
		conn = cp.getConnection("save_britetrack_calc.jsp");
		
		try
		{
			String sSql = "SELECT type_id FROM cjtk_action_parameter_type WHERE parametertype = ?";
			...
			{
				throw new Exception("ERROR: getParamType Unable to determine type of parameter: " + param);
			}

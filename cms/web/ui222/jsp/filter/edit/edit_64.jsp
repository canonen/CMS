...
<HEAD>
	<TITLE><%= sTargetGroupDisplay %>: Action Performed</TITLE>
...
%>
<INPUT type=hidden name=type_id value="<%=FilterType.BRITETRACK_DID_ACTION%>">
...
<table id="Tabs_Table1" cellspacing=0 cellpadding=0 width=100% border=0>
	...
	<tr>
		<td class=fillTab valign=top align=center width=100%>
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle" style="padding:5px;">
						<b>Recipient Action Calculation</b><br>
						Select recipients who performed a specified Action.<br>
			...
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle">Start by selecting the action the recipient performed</td>
				</tr>
				<tr>
			...
			<table class=main cellspacing=1 cellpadding=2 width="100%">
				<tr>
					<td align="center" valign="middle" width="100%" colspan="2">Next, calculate the dates in which the recipient performed the Action</td>
				</tr>
				<tr>

...
<HEAD>
	<TITLE><%= sTargetGroupDisplay %>: Recipients who were sent a specific Content Block</TITLE>
	...
	<SCRIPT>
		...
		function setFilterName(obj)
		{
			...
			filter_form.filter_name.value = "(CONTENT BLOCK) " + ops[si].text;
			display_name.innerText = "(CONTENT BLOCK) " + ops[si].text;
			...
			%>
				<tr>
					<td align="center" valign="middle" style="padding:10px;">
						Recipients who received a Content Block<br>
						Select a Content Block:<br>
						...
						while (rs.next())
						{
							...
							%>
								<option value="<%=sId%>"<%=((sId.equals(sContId))?" selected":"")%>><%= HtmlUtil.escape(sName) %></option>
							<%
						}
						rs.close();
						%>

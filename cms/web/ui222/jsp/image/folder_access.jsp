...
try	{
	...
	conn = cp.getConnection("folder_access.jsp");
...
<%   }    %>
<FORM  METHOD="POST" NAME="FT" ACTION="folder_access_save.jsp" TARGET="_self">
<INPUT TYPE="hidden" NAME="categorytemp" VALUE="">
<INPUT type="hidden" name="folder_id" value="<%=sFolderId%>">
...
<%
	...
	if ((nChildCount > 0) && (folder.s_type_id.equals(String.valueOf(ImageFolderType.GLOBAL)))){
%>
<!--- Step 1 Header----->
<table width="650" class="main" cellspacing="0" cellpadding="0">
	<tr>
		<td class="sectionheader">&nbsp;<b class="sectionheader">Step 1:</b> Set Access Rights for Folder <%=folder.s_folder_name%></td>
	</tr>
</table>
<br>
<!---- Step 1 Info----->

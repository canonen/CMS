...
<title>Image Library URL Generator</title>
...
else
{
	...
	String sPath = folder.getPrettyPathUrl();
	%>
				...
				<div style="overflow:auto; height:100%; width:100%; padding:10px;">
						...
						if (folder.m_Images != null && folder.m_Images.size() > 0 )
						{
							...
							while (itImages.hasNext())
							{
								...
								%>
								<td align="center" valign="middle" class="image_item" title="<%= image.s_image_name %>" onmouseover="on(this);" onmouseout="off(this);" onclick="takeAction('url', '<%= image.s_url_path %>');">

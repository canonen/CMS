...
insDoc(fldrsystem_server_settings_menu, gLnk('bodyFrame', 'My Campaigns', '../jsp/index.jsp?tab=Camp&sec=1'))
insDoc(fldrsystem_server_settings_menu, gLnk('bodyFrame', 'Test Lists', 'body.jsp'))
insDoc(fldrsystem_server_settings_menu, gLnk('bodyFrame', 'Exclusion Lists', 'body.jsp'))
insDoc(fldrsystem_server_settings_menu, gLnk('bodyFrame', 'Notification Lists', 'body.jsp'))
<% } %>
fldrsystem_components_menu = insFld(foldersTree, gFld('Database', '#', '_self'))
insDoc(fldrsystem_components_menu, gLnk('bodyFrame', 'Imports', 'body.jsp'))
insDoc(fldrsystem_components_menu, gLnk('bodyFrame', 'Target Groups', 'body.jsp'))
insDoc(fldrsystem_components_menu, gLnk('bodyFrame', 'Exports', 'body.jsp'))
insDoc(fldrsystem_components_menu, gLnk('bodyFrame', 'Contact Search', 'body.jsp'))

fldrsystem_components_menu3 = insFld(foldersTree, gFld('Content Creation', '#', '_self'))
insDoc(fldrsystem_components_menu3, gLnk('bodyFrame', 'My Content', 'body.jsp'))
insDoc(fldrsystem_components_menu3, gLnk('bodyFrame', 'Dynamic Elements', 'body.jsp'))

fldrsystem_components_menu4 = insFld(foldersTree, gFld('Administration', '#', '_self'))
insDoc(fldrsystem_components_menu4, gLnk('bodyFrame', 'Account Setup', 'body.jsp'))
insDoc(fldrsystem_components_menu4, gLnk('bodyFrame', 'From Address', 'body.jsp'))
insDoc(fldrsystem_components_menu4, gLnk('bodyFrame', 'Subscription Form', 'body.jsp'))
insDoc(fldrsystem_components_menu4, gLnk('bodyFrame', 'Custom Fields', 'body.jsp'))
insDoc(fldrsystem_components_menu4, gLnk('bodyFrame', 'Categories', 'body.jsp'))

fldrsystem_components_menu5 = insFld(foldersTree, gFld('Report', '#', '_self'))
insDoc(fldrsystem_components_menu5, gLnk('bodyFrame', 'My Reports', 'body.jsp'))
insDoc(fldrsystem_components_menu5, gLnk('bodyFrame', 'Super Reports', 'body.jsp'))
insDoc(fldrsystem_components_menu5, gLnk('bodyFrame', 'Customize Reports', 'body.jsp'))

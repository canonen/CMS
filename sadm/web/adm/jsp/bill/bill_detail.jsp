		...
		if ( CUSTOMER.length() == 0 ) {
			...
			if ( PARTNER.equals("0") ) {
				sql =
					...
					"  FROM sadm_cust_partner cp, sadm_customer c" +
...
%>
  <br>
    <center><b>Campaign Summary&nbsp;&nbsp;(from <%=sDateFrom%> to <%=sDateTo%>)</b></center>
  <br>
    ...
    <tr>
      <td align="left" valign="top" style="padding:0px;">
        <table class="listTable" cellpadding="0" cellspacing="0" border="0" width="100%">
	      <tr>
		    <th align="left"  valign="middle" width=20% nowrap>Partner Name</th>
            ...
            <th align="right" valign="middle" width=10% nowrap>Email Sent</th>
            <th align="right" valign="middle" width=10% nowrap>Email Client Subtotal</th>
            <th align="right" valign="middle" width=10% nowrap>Email Subtotal</th>
            <th align="right" valign="middle" width=10% nowrap>Print Sent</th>
            <th align="right" valign="middle" width=10% nowrap>Print Client Subtotal</th>
            <th align="right" valign="middle" width=10% nowrap>Print Subtotal</th>
          </tr>
<%		
...
%>
	      <tr>
		    <td class="listItem_Data" align="left"  valign="middle" width=20% nowrap>&nbsp;&nbsp;<%=sPartnerName%></a></td>
		    ...
		    <td class="listItem_Data" align="right" valign="middle" width=10% nowrap>&nbsp;&nbsp;--&nbsp;&nbsp;</td>
		    <td class="listItem_Data" align="right" valign="middle" width=10% nowrap>&nbsp;&nbsp;<%=subtotal%>&nbsp;&nbsp;</td>
   		    <td class="listItem_Data" align="right" valign="middle" width=10% nowrap>&nbsp;&nbsp;--&nbsp;&nbsp;</td>
		    <td class="listItem_Data" align="right" valign="middle" width=10% nowrap>&nbsp;&nbsp;--&nbsp;&nbsp;</td>
		    <td class="listItem_Data" align="right" valign="middle" width=10% nowrap>&nbsp;&nbsp;<%=printSubtotal%>&nbsp;&nbsp;</td>
	      </tr>
<%
				if (doExport) {
...
%>
	      <tr>
		    ...
		    <td class="listItem_Data" align="right" valign="middle" width=10% nowrap>&nbsp;&nbsp;0&nbsp;&nbsp;</td>
		    <td class="listItem_Data" align="right" valign="middle" width=10% nowrap>&nbsp;&nbsp;0&nbsp;&nbsp;</td>
		    <td class="listItem_Data" align="right" valign="middle" width=10% nowrap>&nbsp;&nbsp;<%=subtotal%>&nbsp;&nbsp;</td>
   		    <td class="listItem_Data" align="right" valign="middle" width=10% nowrap>&nbsp;&nbsp;0&nbsp;&nbsp;</td>
		    <td class="listItem_Data" align="right" valign="middle" width=10% nowrap>&nbsp;&nbsp;0&nbsp;&nbsp;</td>
...
%>
	      <tr>
		    <td class="listItem_Data" align="left"  valign="middle" width=20% nowrap>&nbsp;&nbsp;<%=sPartnerName%></a></td>
		    <td class="listItem_Data" align="left"  valign="middle" width=20% nowrap>&nbsp;&nbsp;<%=sCustName%></td>
		    <td class="listItem_Data" align="left"  valign="middle" width=10% nowrap>&nbsp;&nbsp;<%=sCampDate%>&nbsp;&nbsp;</td>
		    <td class="listItem_Data" align="left"  valign="middle" width=10% nowrap>&nbsp;&nbsp;<%=sCampName%>&nbsp;&nbsp;</td>
		    <td class="listItem_Data" align="left"  valign="middle" width=10%>&nbsp;&nbsp;<%=sCampType%>&nbsp;&nbsp;</td>
		    <td class="listItem_Data" align="right" valign="middle" width=10% nowrap>&nbsp;&nbsp;<%=sSent%>&nbsp;&nbsp;</td>
		    <td class="listItem_Data" align="right" valign="middle" width=10% nowrap>&nbsp;&nbsp;<%=clientSubtotal%>&nbsp;&nbsp;</td>
		    <td class="listItem_Data" align="right" valign="middle" width=10% nowrap>&nbsp;&nbsp;<%=subtotal%>&nbsp;&nbsp;</td>
		    		    <td class="listItem_Data" align="right" valign="middle" width=10% nowrap>&nbsp;&nbsp;<%=sPrintSent%>&nbsp;&nbsp;</td>
		    <td class="listItem_Data" align="right" valign="middle" width=10% nowrap>&nbsp;&nbsp;<%=printClientSubtotal%>&nbsp;&nbsp;</td>
		    <td class="listItem_Data" align="right" valign="middle" width=10% nowrap>&nbsp;&nbsp;<%=printSubtotal%>&nbsp;&nbsp;</td>
	      </tr>
<%
		  }

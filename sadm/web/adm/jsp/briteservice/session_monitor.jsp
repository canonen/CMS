...
<script language="javascript">
	...
	function refreshList()
	{
		...
		var sURL = "session_monitor.jsp?machine_id="+ machine + "&order_by="+ orderBy;		
		location.href = sURL;
	}
	...
	function loadData(cust_id)
	{
		if ((cust_id != "0") && (cust_id != ""))
		{
			...
			var login_period = document.getElementById("login_period").value;
			var idle_time = document.getElementById("idle_time").value;
			httpData.onreadystatechange = httpDataChange;
			httpData.open("GET", "xml_get_sessions_for_cust.jsp?cust_id=" + cust_id + "&login_period=" + login_period + "&idle_time=" + idle_time, false);
			httpData.send();          
		}
	}
					...
					<td align="left" valign="top" width="100%">
						<table cellpadding="0" cellspacing="0" border="0" class="layout">
							...
							<tr>
								...
								<td align="left" valign="middle">
									&nbsp;&nbsp;login within &nbsp; <input type="text" name="login_period" size="3" value="24" maxlength=3>&nbsp; hours 
									and idled less than &nbsp;<input type="text" name="idle_time" size="5" value="1800" maxlength=5>&nbsp; seconds 
								</td>
	...
	<tr id="dataArea" style="display:none;">
		<td valign="top" align="left">
			<table id="Tabs_Table1" class="layout" style="width:100%; height:100%;" cellspacing="0" cellpadding="0" border="0">
				...
				<col>
				<tr height="22">
					<td class="EditTabOn" valign="center" nowrap align="middle">Active Sessions</td>

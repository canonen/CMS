...
<table cellpadding="4" cellspacing="0" border="0">
	<tr>
		<td vAlign="middle" align="left" nowrap>
			<a class="newbutton" href="user_edit_frame.jsp?cust_id=<%= cust.s_cust_id %>">New User</a>&nbsp;&nbsp;&nbsp;
		</td>
	</tr>
</table>
<br>
...
try
{
	...
	sSQL =
		" SELECT user_id, user_name + ' ' + isnull(last_name, ' ') as 'fullName'" +
		" FROM scps_user" +
		" WHERE cust_id=" + cust.s_cust_id + " AND status_id < " + UserStatus.DELETED +  
		" ORDER BY user_name";
...
%>
	<tr>
		<td class="listItem_Data<%= sClassAppend %>">
			<a href="user_edit_frame.jsp?user_id=<%= sUserId %>">
...
%>
	<tr>
		<td class="listItem_Data<%= sClassAppend %>">There are currently no users</td>
	</tr>
<%
	}
}

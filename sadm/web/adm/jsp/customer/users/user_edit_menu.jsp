...
<BODY>
<a class="resourcebutton" href="user_list.jsp?<%= (sUserId==null)?"cust_id=" + sCustId:"cust_id=" + user.s_cust_id %>" target="main_01"><< Return to Users</a>
<br><br>
	...
	<tr>
		<td class=fillTab>
			<table width=100% class=main border="0" cellspacing="1" cellpadding="2">
				<tr>
					<td align="left" valign="middle" class="pageheader"><%=(sUserId==null)?"New":user.s_user_name + " " + user.s_last_name + " (" + user.s_user_id + ")"%></td>
				</tr>
				<tr>
					<td align="left" valign="middle" style="padding:10px;">
						<table border="0" cellspacing="0" cellpadding="2">
							<tr>
								<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
								<td>1</td>
								<td><a target="main_02" href="user_edit.jsp?<%= (sUserId==null)?"cust_id=" + sCustId:"user_id=" + sUserId %>">General Info</a></td>
							</tr>
						<% if (sUserId != null) { %>
							<tr>
								<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
								<td>2</td>
								<td><a target="main_02" href="access_masks.jsp?user_id=<%= sUserId %>">Access Rights</a></td>
							</tr>
						<% } %>
						</table>
					</td>

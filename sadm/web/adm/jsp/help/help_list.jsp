			...
			<table cellpadding="4" cellspacing="0" border="0">
				<tr>
					<td vAlign="middle" align="left" nowrap>
						<a class="newbutton" href="help_edit.jsp" target="main_01">New Help Document Entry</a>&nbsp;&nbsp;&nbsp;
					</td>
				</tr>
			</table>
			<br>
						...
						while (rs.next())
						{
							...
							else
							{
								...
								<tr>
									...
									<td class="listItem_Title<%= svolClassAppend %>"><a href="help_edit.jsp?help_doc_id=<%= sVolumeID %>" target="main_01"><%= sVolumeHeading %></a>&nbsp;</td>
							...
							if (sChapterHeading != null)
							{
								if (newChapterID.compareToIgnoreCase(oldChapterID) == 0)
								{
									...
									if (sPageHeading != null)
									{
										...
										<tr>
											...
											<td class="listItemChild_Title<%= spageClassAppend %>"><a href="help_edit.jsp?help_doc_id=<%= sPageID %>" target="main_01"><%= sPageHeading %></a>&nbsp;</td>
								...
								else
								{
									...
									<tr>
										...
										<td class="listGroupChild_Title"><a href="help_edit.jsp?help_doc_id=<%= sChapterID %>" target="main_01"><%= sChapterHeading %></a>&nbsp;</td>

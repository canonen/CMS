...
public class ModInstServices extends BriteList
{
	//log4j implementation
	private static Logger logger = Logger.getLogger(ModInstServices.class.getName());
	// === Constructors ===
	public ModInstServices()
	{
	}

	public ModInstServices(Element e) throws Exception
	{
		fromXml(e);
	}
	...
	// init sql variables
	{
		...
		m_sFromClause = " FROM sadm_mod_inst_service ";
		m_sWhereClause = null;
		m_sOrderByClause = " ORDER BY  mod_inst_id, service_type_id ";
	}
	...
	public String buildWhereClause()
	{
		...
		if(s_mod_inst_id != null) { sWhereSql += " (mod_inst_id IN (?)) "; bAddAnd = true; }
	...
	public void fixIds()
	{
		ModInstService modinstservice = null;
		for (Enumeration e = v.elements() ; e.hasMoreElements() ;)
		{
			modinstservice = (ModInstService)e.nextElement();
			if(s_mod_inst_id != null) modinstservice.s_mod_inst_id = s_mod_inst_id;
			if(s_service_type_id != null) modinstservice.s_service_type_id = s_service_type_id;
		}
	}
	...
	public int getListFromResultSet(ResultSet rs) throws Exception
	{
		...
		while (rs.next())
		{
			modinstservice = new ModInstService();
			modinstservice.getPropsFromResultSetRow(rs);
			add(modinstservice);
			nReturnCode++;
		}
		return nReturnCode;
	...
	public String m_sMainElementName = "mod_inst_services";
	public String getMainElementName() { return m_sMainElementName; }
		
	public String m_sSubElementName = "mod_inst_service";
	...
	public int getPartsFromXml(NodeList nl) throws Exception
	{
		...
		{
			modinstservice = new ModInstService ((Element)nl.item(i));
			v.add(modinstservice);
		}
		return iLength;
	}

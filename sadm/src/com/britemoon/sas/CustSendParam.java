...
public class CustSendParam extends BriteObject
{
	...
	public String m_sSaveSql =
		" EXECUTE usp_sadm_cust_send_param_save" +
		"	@cust_id=?," +
		"	@error_to_address=?," +
		"	@sender_address=?";
	...
	public int saveProps(PreparedStatement pstmt) throws Exception
	{
		...
		pstmt.setString(1, s_cust_id);
		if(s_error_to_address == null) pstmt.setString(2, s_error_to_address);
		else pstmt.setBytes(2, s_error_to_address.getBytes("UTF-8"));
		if(s_sender_address == null) pstmt.setString(3, s_sender_address);
		else pstmt.setBytes(3, s_sender_address.getBytes("UTF-8"));
	...
	public String m_sDeleteSql =
		" DELETE FROM sadm_cust_send_param" +
		" WHERE" +
		"	(cust_id=?)";
